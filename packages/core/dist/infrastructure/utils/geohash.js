 ...
 */
export function getNeighbors(lat, lng, radiusKm) {
    ...
    if (safeRadius > 2500)
        precision = 1;
    else if (safeRadius > 600)
        precision = 2;
    else if (safeRadius > 80)
        precision = 3;
    else if (safeRadius > 20)
        precision = 4;
    ...
    const centers = [
        [lat, lng],
        [lat + latDiff, lng], [lat - latDiff, lng],
        [lat, lng + lngDiff], [lat, lng - lngDiff],
