...
export const IndexConfig = {
  [SearchIndexes.EVENTS]: {
    ...
    sortableAttributes: ['startDate', 'priceMin', 'createdAt', 'attendeeCount'],
    rankingRules: [
      'words',
      'typo',
      'proximity',
  ...
  [SearchIndexes.VENUES]: {
    primaryKey: 'id',
    searchableAttributes: ['name', 'description', 'city', 'neighborhood', 'venueType', 'tags'],
    filterableAttributes: ['city', 'venueType', 'capacity', 'isVerified', 'hasUpcomingEvents'],
    sortableAttributes: ['name', 'capacity', 'eventCount'],
  },
  [SearchIndexes.HOSTS]: {
    primaryKey: 'id',
    searchableAttributes: ['brandName', 'description', 'genres', 'city'],
    filterableAttributes: ['city', 'isVerified', 'genres'],
    sortableAttributes: ['eventCount', 'followerCount'],
  },
};
