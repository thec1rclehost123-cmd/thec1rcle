...
export class MatchingService {
    ...
    async getMatchFeed(userId: string, options: {
        lat?: number,
        lng?: number,
        limit?: number,
        type?: 'user' | 'event'
    ...
    async precomputeMatchFeed(userId: string, options: {
        lat?: number,
        lng?: number,
        limit?: number,
        type?: 'user' | 'event'
    ...
    private calculateInterestScore(user: any, target: any, adaptiveBoosts: Record<string, number> = {}): number {
