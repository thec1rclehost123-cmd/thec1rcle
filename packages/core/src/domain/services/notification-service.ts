...
export class NotificationService {
    ...
    async getVenueDashboard(venueId: string): Promise<{ notifications: Notification[], unreadCount: number, total: number }> {
    ...
    async markAsRead(venueId: string, notificationId: string, type: string, markAllRead?: boolean): Promise<void> {
        if (markAllRead) {
    ...
    async sendPushToFollowers(venueId: string, title: string, message: string, data: any): Promise<{ sentCount: number, userCount: number }> {
