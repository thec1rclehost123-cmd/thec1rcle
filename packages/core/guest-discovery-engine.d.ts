...
export function buildEventCardReadModel(
  rawEvent?: {},
  {
    readModelVersion,
  }?: {
...
export function projectHostDetail(
  rawHost?: {},
  summary?: {},
): {
  id: any;
...
export function projectVenueDetail(
  rawVenue?: {},
  summary?: {},
  menuDoc?: null,
): {
...
export function filterGuestEventCards(
  rawItems?: any[],
  query?: {},
): {
  items: any[];
...
export function filterGuestHostSummaries(
  rawItems?: any[],
  query?: {},
): {
  items: any[];
...
export function filterGuestVenueSummaries(
  rawItems?: any[],
  query?: {},
): {
  items: any[];
...
export function normalizeEventSort(
  value: any,
): 'startAt' | 'heatScore' | 'publishedAt' | 'priceMin';
