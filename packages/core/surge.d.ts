 ...
 */
export function joinQueue(db: any, eventId: any, userId: any, deviceId: any, options?: {}): Promise<any>;
/**
 ...
 */
export function admitUsers(db: any, eventId: any, totalCount?: number, source?: string): Promise<number>;
/**
 * Standardized Analytics Definitions
 */
export function getSurgeAnalytics(db: any, eventId: any): Promise<{
    total_demand: number;
    velocity: number;
    conversion_stats: {
        admitted: number;
