                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {ticket.gender === 'female' && (
                          <span className="rounded-full bg-pink-500/20 border border-pink-500/40 px-2 py-0.5 text-[8px] font-black uppercase tracking-widest text-pink-400">
                            Women Only
                          </span>
                        )}
                        {ticket.gender === 'male' && (
                          <span className="rounded-full bg-blue-500/20 border border-blue-500/40 px-2 py-0.5 text-[8px] font-black uppercase tracking-widest text-blue-400">
                            Men Only
                          </span>
                        )}
                        ...
                        {ticket.remaining > 0 && ticket.remaining < 10 && (
                          <span className="rounded-full bg-red-500/20 border border-red-500/40 px-2 py-0.5 text-[8px] font-black uppercase tracking-widest text-red-400">
                            Low Stock
                          </span>
                        )}
                        {ticket.remaining === 0 && (
                          <span className="rounded-full bg-white/10 border border-white/20 px-2 py-0.5 text-[8px] font-black uppercase tracking-widest text-white/40">
                            Sold Out
                          </span>
                        )}
                        {ticket.description && (
                    ...
                    <div className="flex items-center rounded-full border border-white/10 bg-black/40 p-1">
                      ...
                      <button
                        ...
                        disabled={
                          isPreview ||
                          (quantities[ticket.id] || 0) >=
                            (ticket.remaining ?? (ticket.quantity || 999)) ||
              ...
              <div className="flex flex-col gap-1 px-2 mb-4">
                ...
                {isBelowMin && (
                  <p className="text-[10px] text-orange font-bold mt-1">
                    Minimum {minTicketsPerOrder} tickets required.
                  </p>
                )}
              </div>
              <button
