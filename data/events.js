const baseEvents = [
  ...
  },
  {
    ...
    host: "@recordclub",
    category: "Trending",
    image: "/events/nirvana.svg",
    description: "Classic rock recitals with zine pop-up.",
...
const metadataById = {
  ...
  "nirvana-night": {
    ...
    venue: "High Spirits",
    eventType: "concerts",
    tags: ["Concerts", "Classic rock", "Tribute night", "Live band"],
    startDateTime: "2024-12-18T20:00:00+05:30",
    endDateTime: "2024-12-18T23:30:00+05:30",
    timezone: "Asia/Kolkata",
    visibility: "public",
    startingPrice: 799,
    stats: { heatScore: 70, rsvpsLast48h: 118, views: 1500, saves: 210, shares: 62, createdAt: "2024-10-28T12:00:00+05:30" },
    tickets: [
      {
        id: "nirvana-floor",
        name: "Floor Pass",
