...
export const adminStore = {
  ...
  async getPlatformSnapshot() {
    ...
    const stats = statsDoc.exists
      ? statsDoc.data()
      : { users_total: 0, events_total: 0, revenue: { total: 0 }, tickets_sold_total: 0 };
    const [
      pendingReviewsCount,
    ...
    return {
      stats,
      pendingReviewsCount: pendingReviewsCount.data().count,
      activeIncidentsCount: activeIncidentsCount.data().count,
      liveEvents: liveEvents.data().count,
      liveUsers: liveUsers.data().count,
      liveHosts: liveHosts.data().count,
      liveVenues: liveVenues.data().count,
      recentLogs,
    };
  },
