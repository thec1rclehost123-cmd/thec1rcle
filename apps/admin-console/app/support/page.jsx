                ...
                filtered.map((t) => (
                  ...
                  >
                    <td className="px-8 py-6">
                      <p className="text-sm font-semibold text-white tracking-tight uppercase">
                        {t.subject || "Support Message"}
                      </p>
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-widest truncate max-w-[200px]">
                    ...
                    <td className="px-8 py-6">
                      <div
                        className={`inline-flex items-center px-2 py-0.5 rounded border ${t.priority === "high" ? "bg-iris/10 text-iris border-iris/20" : "bg-white/5 text-zinc-600 border-white/5"}`}
                      >
                    ...
                    <td className="px-8 py-6 text-right">
                      <div
                        className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded border ${t.status === "open" ? "bg-amber-500/10 border-amber-500/20 text-amber-500" : "bg-emerald-500/10 border-emerald-500/20 text-emerald-500"}`}
                      >
                        <div
                          className={`h-1 w-1 rounded-full ${t.status === "open" ? "bg-amber-500" : "bg-emerald-500"}`}
                        />
                        <span className="text-[9px] font-bold uppercase tracking-widest">
