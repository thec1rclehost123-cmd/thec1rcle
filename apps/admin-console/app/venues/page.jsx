                  ...
                  {loading ? (
                    ...
                    filtered.map((v) => (
                      ...
                      >
                        ...
                        <td className="px-8 py-6">
                          <div
                            className={`inline-flex items-center px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-widest border ${v.tier === "premium" ? "bg-emerald-500/10 text-emerald-500 border-emerald-500/20" : "bg-white/5 text-zinc-500 border-white/5"}`}
                          >
                            {v.tier || "Standard"}
                          </div>
                        </td>
                        <td className="px-8 py-6 text-right">
                          <div className="flex items-center justify-end gap-2.5">
                            <div
                              className={`h-1.5 w-1.5 rounded-full ${v.status === "active" ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]" : v.status === "pending" ? "bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.4)]" : "bg-iris shadow-[0_0_8px_rgba(244,74,34,0.4)]"}`}
                            ></div>
            ...
            <div className="sticky top-28 space-y-4 animate-in fade-in slide-in-from-right-4 duration-500">
              <div className="bg-obsidian-surface border border-[#ffffff08] rounded-xl p-8 space-y-8 shadow-2xl relative">
                ...
                <div className="flex items-center gap-4 pt-2">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-2xl font-semibold tracking-tight text-white mb-0.5 truncate uppercase uppercase">
                      {selectedVenue.name}
                    </h3>
                        ...
                        onClick={() =>
                          setModalConfig({
                            action: selectedVenue.isVerified
                              ? "VERIFICATION_REVOKE"
                              : "VERIFICATION_ISSUE",
                            title: selectedVenue.isVerified
                              ? "Revoke Verification"
                              : "Verify Partner",
                      ...
                      <button
                        onClick={() =>
                          setModalConfig({
                            ...
                            message:
                              "Send a formal compliance notice to the partner. This action is logged.",
                            label: "Send Notice",
                      ...
                      <button
                        onClick={() =>
                          setModalConfig({
                            ...
                            message:
                              "Change how prominently this partner appears in discovery feeds.",
                        ...
                        <button
                          onClick={() =>
                            setModalConfig({
                              ...
                              message:
                                "Allow the partner to resume hosting and sales. High priority update.",
