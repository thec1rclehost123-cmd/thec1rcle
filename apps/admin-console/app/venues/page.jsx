...
import { Building2, ShieldCheck, TrendingUp, BadgeCheck, Lock, Unlock, ShieldAlert, Percent, ChevronRight, AlertCircle, X, MapPin } from "lucide-react";
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0">
                        <div className="flex items-center gap-1.5">
                            <p className="text-sm font-semibold text-white truncate uppercase tracking-tight">{val}</p>
        ...
        { 
            ...
            render: (val, row) => (
                <div className="min-w-[120px]">
                    <p className="text-[11px] font-bold text-zinc-400 uppercase tracking-tight">{val || 'Global'}</p>
                    <p className="text-[10px] text-zinc-600 uppercase tracking-widest mt-0.5 font-bold">{row.area || 'General'}</p>
                </div>
            )
        },
        { 
            ...
            sortable: true,
            render: (val) => (
                <div className={`inline-flex items-center px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-widest border ${val === 'premium' ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20' : 'bg-white/5 text-zinc-500 border-white/5'}`}>
                    {val || 'Standard'}
                </div>
            )
        },
        { 
            ...
            render: (val) => (
                <div className="flex items-center justify-end gap-2.5">
                    <div className={`h-1.5 w-1.5 rounded-full ${val === 'active' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]' : val === 'pending' ? 'bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.4)]' : 'bg-iris shadow-[0_0_8px_rgba(244,74,34,0.4)]'}`}></div>
                    <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-600">{val}</span>
                </div>
            )
        }
    ];
                ...
                <div className="space-y-8">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5">
                            <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-600 mb-1">Network Status</p>
                        ...
                        <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5">
                            <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-600 mb-1">Account Tier</p>
                            <p className="text-xl font-light text-white uppercase">{selectedVenue?.tier || 'Standard'}</p>
                        </div>
                    </div>
