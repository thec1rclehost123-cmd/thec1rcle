                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-semibold text-white tracking-tight truncate uppercase tracking-tight">
                        {host.name || "Anonymous Organizer"}
                      </h3>
                      {host.isVerified && (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] text-zinc-700 font-bold tracking-widest uppercase font-mono-numbers">
                  ...
                  <div className="text-right flex flex-col items-end gap-2">
                    <div
                      className={`px-2.5 py-1 rounded text-[9px] font-bold uppercase tracking-widest border ${host.status === "active" ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-500" : host.status === "suspended" ? "bg-iris/10 border-iris/20 text-iris" : "bg-amber-500/10 border-amber-500/20 text-amber-500"}`}
                    >
                      <span
                        className={`inline-block mr-1.5 h-1 w-1 rounded-full ${host.status === "active" ? "bg-emerald-500" : host.status === "suspended" ? "bg-iris" : "bg-amber-500"}`}
                      ></span>
                      {host.status === "active"
                        ? "Active"
                    ...
                    <p className="text-[9px] text-zinc-700 font-bold uppercase tracking-widest truncate max-w-[100px]">
                      OWNER: {host.ownerUid?.slice(0, 8)}
                    </p>
                  </div>
                </div>
              ))
            ...
            <div className="sticky top-28 space-y-4 animate-in fade-in slide-in-from-right-4 duration-500">
              <div className="bg-obsidian-surface border border-[#ffffff08] rounded-xl p-8 space-y-8 shadow-2xl relative">
                ...
                <div className="flex flex-col items-center text-center pt-2 space-y-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold tracking-tight text-white mb-1 uppercase tracking-tight">
                      {selectedHost.name}
                    </h3>
                  ...
                  <div className="p-5 rounded-xl bg-white/[0.02] border border-[#ffffff05] space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <span className="text-[8px] font-bold text-zinc-700 block uppercase tracking-tight mb-0.5">
                          Profile Reference
                        </span>
                        <span className="text-[10px] font-bold text-zinc-400 break-all leading-tight tracking-tight uppercase">
                      ...
                      <button
                        onClick={() =>
                          setModalConfig({
                            ...
                            message:
                              "Restore standard payment processing for this organizer profile.",
