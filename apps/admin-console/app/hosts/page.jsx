...
import { Users, ShieldCheck, TrendingUp, BadgeCheck, Ban, RotateCcw, ChevronRight, User, X, AlertCircle } from "lucide-react";
        ...
        { 
            ...
            render: (val) => (
                <div className="flex items-center justify-end gap-2.5">
                    <div className={`h-1.5 w-1.5 rounded-full ${val === 'active' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]' : val === 'suspended' ? 'bg-iris shadow-[0_0_8px_rgba(244,74,34,0.4)]' : 'bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.4)]'}`}></div>
                ...
                <div className="space-y-8">
                    <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 space-y-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="min-w-0">
                                <span className="text-[9px] font-bold text-zinc-700 block uppercase tracking-tight mb-0.5">Profile Reference</span>
                                <span className="text-sm font-medium text-zinc-300 break-all leading-tight">{selectedHost?.ownerUid}</span>
                            </div>
                        </div>
                    </div>
