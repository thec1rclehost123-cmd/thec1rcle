      ...
      {loading ? (
        <div className="space-y-4">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="h-28 bg-white/[0.02] animate-pulse rounded-xl border border-white/5"
            />
          ))}
        </div>
        ...
        <div className="py-24 text-center rounded-xl border border-[#ffffff08] bg-obsidian-surface/50">
          ...
          <p className="text-[10px] text-zinc-600 mt-2 font-bold uppercase tracking-widest">
            No pending refund requests require attention.
          </p>
        </div>
      ) : (
        <div className="space-y-4">
                  ...
                  <div className="p-7 flex items-center gap-8">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1.5">
                        ...
                        <div
                          className={`px-2.5 py-1 rounded text-[9px] font-bold uppercase tracking-widest border ${getStatusStyle(request.status)}`}
                        >
                          {request.status}
                        </div>
                      ...
                      <div className="flex items-center gap-3 bg-white/[0.02] border border-white/5 p-2 rounded-xl">
                        <div className="flex -space-x-2">
                          {[...Array(request.approversRequired)].map((_, i) => (
                            <div
                              key={i}
                              className={`w-8 h-8 rounded-full border-2 border-obsidian-surface flex items-center justify-center transition-colors ${
                        ...
                        <div className="p-8 grid grid-cols-3 gap-12">
                          ...
                          <div className="space-y-4">
                            ...
                            {request.approvers.length === 0 ? (
                              <p className="text-[10px] text-zinc-700 font-bold uppercase tracking-widest italic pt-2">
                              ...
                              <div className="space-y-3">
                                {request.approvers.map((approver, i) => (
                                  <div key={i} className="flex flex-col">
                                    ...
                                    <span className="text-[9px] text-zinc-600 font-bold uppercase tracking-widest ml-5">
