              ...
              <tbody className="divide-y divide-[#ffffff05]">
                {loading ? (
                    ...
                    >
                      <td className="px-6 py-5">
                        <p className="text-sm font-semibold text-white truncate">
                          {new Date(
                            txn.createdAt?._seconds * 1000 || txn.createdAt,
                          ).toLocaleDateString()}
                        </p>
                      ...
                      <td className="px-6 py-5 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <div
                            className={`h-1.5 w-1.5 rounded-full ${txn.status === "captured" || txn.status === "paid" ? "bg-emerald-500" : txn.status === "refunded" ? "bg-iris" : "bg-amber-500"}`}
                          />
                          <span
                            className={`text-[10px] font-bold uppercase tracking-widest ${txn.status === "captured" || txn.status === "paid" ? "text-emerald-500" : txn.status === "refunded" ? "text-iris" : "text-amber-500"}`}
                          >
                            {txn.status || "pending"}
                          </span>
                        </div>
                  ...
                  <tr>
                    <td
                      colSpan={5}
                      className="px-6 py-20 text-center text-[10px] font-bold uppercase tracking-widest text-zinc-700 italic"
                    >
              ...
              <div className="bg-obsidian-surface border border-[#ffffff08] rounded-xl p-8 space-y-8 shadow-2xl relative">
                  ...
                  <div className="grid grid-cols-1 gap-4 pt-4">
                    ...
                    <div className="p-4 rounded-xl bg-white/[0.02] border border-[#ffffff05] space-y-1">
                      ...
                      <p className="text-sm font-semibold text-white">
                        {new Date(
                          selectedTxn.createdAt?._seconds * 1000 || selectedTxn.createdAt,
                        ).toLocaleString()}
                      </p>
                    </div>
                  </div>
                ...
                <div className="pt-2 text-center">
                  <p className="text-[9px] text-zinc-600 font-bold uppercase tracking-widest italic opacity-50">
                    Monitoring immutable cash trails.
                  </p>
                </div>
              </div>
            </div>
