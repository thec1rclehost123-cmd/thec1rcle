              ...
              <tbody className="divide-y divide-[#ffffff05]">
                {loading ? (
                  ...
                  <tr>
                    ...
                    >
                      Queue clear. No pending requests detected.
                    </td>
                  </tr>
                ) : (
                  filtered.map((r) => (
                              ...
                              <select
                                ...
                                onChange={(e) => {
                                  const newReqs = requests.map((r) =>
                                    r.id === selectedReq.id
                                      ? { ...r, data: { ...r.data, plan: e.target.value } }
                                      : r,
                                  );
                                  setRequests(newReqs);
                                  setSelectedReq({
                                    ...selectedReq,
                                    data: { ...selectedReq.data, plan: e.target.value },
                                  });
                                }}
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <button
                                onClick={() => {
                                  const newReqs = requests.map((r) =>
                                    r.id === selectedReq.id
                                      ? {
                                          ...r,
                                          data: { ...r.data, isVerified: !r.data?.isVerified },
                                        }
                                      : r,
                                  );
                                  setRequests(newReqs);
                                ...
                                className={`px-3 py-1 rounded-md text-[8px] font-black uppercase tracking-widest border transition-all ${
                                  selectedReq.data?.isVerified !== false
