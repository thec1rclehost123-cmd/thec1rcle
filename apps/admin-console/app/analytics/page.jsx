...
export default function AdminAnalytics() {
  ...
  const metrics = [
    ...
    {
      label: "Tickets Sold",
      value: stats?.tickets_sold_total || 0,
      trend: "-2.4%",
      isUp: false,
      icon: Ticket,
    },
    {
      label: "Active Venues",
      value: stats?.venues_total?.active || 0,
      trend: "+4.1%",
      isUp: true,
      icon: BarChart3,
    },
          ...
          >
            <div className="flex items-center justify-between mb-8">
              ...
              {loading ? (
                ...
                <div
                  className={`flex items-center gap-1 px-2 py-1 rounded text-[10px] font-bold tracking-widest uppercase ${m.isUp ? "bg-emerald-500/10 text-emerald-500" : "bg-iris/10 text-iris"}`}
                >
                  {m.isUp ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="p-10 rounded-xl bg-obsidian-surface border border-[#ffffff08] shadow-sm space-y-10">
          <div className="flex items-center justify-between px-2">
            ...
            <span className="text-[9px] font-bold uppercase tracking-widest text-zinc-700 bg-white/5 px-2 py-1 rounded">
              30 Day Feed
            </span>
          </div>
