...
function KycStatusBadge({ status }) {
  ...
  return (
    <span
      className={`px-2.5 py-1 rounded-md text-[9px] font-bold uppercase tracking-widest border ${meta.bg} ${meta.color}`}
    >
      {meta.label}
    </span>
  );
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-white/[0.02] border-b border-[#ffffff08]">
              ...
              <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500 hidden md:table-cell">
                Steps
              </th>
              <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500 hidden lg:table-cell">
                Updated
              </th>
          ...
          <tbody className="divide-y divide-[#ffffff05]">
            {loading ? (
              ...
              <tr>
                <td
                  colSpan={6}
                  className="px-6 py-20 text-center text-[10px] font-bold uppercase tracking-widest text-zinc-600 italic"
                >
                    ...
                    <td className="px-6 py-5 hidden md:table-cell">
                      <div className="flex items-center gap-1">
                        {stepSequence.map((s) => {
                          ...
                          if (st === 'approved')
                            return (
                              <CheckCircle2 key={s} className="h-3.5 w-3.5 text-emerald-500" />
                            );
                        ...
                        <span className="text-[10px] text-zinc-600 ml-1">
                          {approvedCount}/{stepSequence.length}
                        </span>
                      </div>
                    </td>
