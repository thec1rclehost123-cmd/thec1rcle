...
export default function AdminDashboard() {
  ...
  const stats = [
    ...
    {
      label: "Active Venues",
      value: snapshot.venues_total?.active || 0,
      icon: Building2,
      trend: "+2",
      trendUp: true,
      href: "/venues",
    ...
    {
      label: "Tickets Sold",
      value: snapshot.tickets_sold_total || 0,
      icon: Ticket,
      trend: "+142",
      trendUp: true,
      href: "/events",
    ...
    },
    {
      ...
      value: snapshot.events?.upcoming || 0,
      icon: Clock,
      trend: "+5",
      trendUp: true,
      href: "/events",
  ...
  const handleExport = () => {
    ...
    link.setAttribute(
      "download",
      `c1rcle_dashboard_report_${new Date().toISOString().split("T")[0]}.csv`,
    );
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {[
                ...
                { label: "Host Approvals", count: snapshot.queues?.hosts || 0, href: "/hosts" },
                {
                  ...
                  count: snapshot.queues?.refunds || 0,
                  href: "/payments",
                },
                {
                  label: "Support Tickets",
                  count: snapshot.queues?.incidents || 0,
                  href: "/support",
                },
                { label: "System Alerts", count: snapshot.queues?.webhooks || 0, href: "/logs" },
                {
                  label: "Payout Batches",
                  count: snapshot.queues?.payouts || 0,
                  href: "/payments",
                },
              ].map((q, i) => (
