                      ...
                      >
                        <td className="px-6 py-5">
                          <div className="flex flex-col gap-0.5">
                            ...
                            <span className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest leading-tight">
                              {new Date(log.ts || log.timestamp).toLocaleDateString([], {
                                month: "short",
                                day: "numeric",
                              })}
                            </span>
                        ...
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-xs font-semibold text-zinc-400 truncate max-w-[150px]">
                              {log.actorEmail}
                            </span>
                          </div>
                        </td>
                        <td className="px-6 py-5">
                          <div className="flex flex-col gap-0.5">
                            <span className="text-[10px] font-bold uppercase tracking-widest text-white">
                              {cleanJargon(log.actionType || log.action)}
                            </span>
                            <span className="text-[9px] font-bold text-zinc-500 tracking-widest uppercase">
                              Target: {log.targetId?.slice(0, 12)}
                            </span>
                          </div>
                        </td>
                        <td className="px-6 py-5">
                          <div
                            className={`inline-flex items-center gap-2 px-2.5 py-1 rounded border ${log.status === "failed" ? "bg-iris/10 border-iris/20 text-iris" : "bg-emerald-500/10 border-emerald-500/20 text-emerald-500"}`}
                          >
                            <div
                              className={`h-1.5 w-1.5 rounded-full ${log.status === "failed" ? "bg-iris" : "bg-emerald-500"}`}
                            />
                        ...
                        <td className="px-6 py-5 text-right">
                          <ChevronRight
                            className={`h-4 w-4 transition-all ${selectedLog?.id === log.id ? "text-white translate-x-1" : "text-zinc-700 group-hover:text-white group-hover:translate-x-1"}`}
                            strokeWidth={1.5}
                          />
                        </td>
                      </tr>
              ...
              <div className="bg-obsidian-surface border border-[#ffffff08] rounded-xl p-8 space-y-8 shadow-2xl relative">
                  ...
                  <div className="p-5 rounded-xl bg-white/[0.02] border border-[#ffffff05] space-y-6">
                      ...
                      <p className="text-sm font-medium text-zinc-400 italic leading-relaxed">
                        ...
                        {cleanJargon(
                          selectedLog.reason ||
                            ...
                            "Authenticated administrative action.",
                        )}
                        &quot;
                      </p>
                    </div>
                    ...
                    <div className="pt-4 border-t border-[#ffffff05] grid grid-cols-2 gap-6">
                      <div>
                        ...
                        <p className="text-[10px] font-bold text-zinc-400 truncate tracking-tight uppercase">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-tight">
                          {selectedLog.ipAddress || selectedLog.ip || "HIDDEN"}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center gap-3 p-4 rounded-xl bg-zinc-900 border border-white/5">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] font-bold text-white truncate">
                          {selectedLog.actorEmail || selectedLog.adminEmail}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-4 rounded-xl bg-zinc-900 border border-white/5">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] font-bold text-white uppercase tracking-widest">
                          {selectedLog.proposalId ? "Approved Proposal" : "Standard Access"}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="pt-2 text-center">
                  <p className="text-[9px] text-zinc-600 font-bold uppercase tracking-widest italic opacity-50">
                    Log entry verified for platform record.
                  </p>
                </div>
              </div>
            </div>
