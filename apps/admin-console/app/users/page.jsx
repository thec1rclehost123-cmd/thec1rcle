                      ...
                      >
                        ...
                        <td className="px-8 py-6 text-right">
                          <div className="flex items-center justify-end gap-2.5">
                            <div
                              className={`h-1.5 w-1.5 rounded-full ${u.isBanned ? "bg-iris shadow-[0_0_8px_rgba(244,74,34,0.4)]" : "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]"}`}
                            ></div>
                            <span
                              className={`text-[10px] font-bold uppercase tracking-widest ${u.isBanned ? "text-iris" : "text-zinc-600"}`}
                            >
            ...
            <div className="sticky top-28 space-y-4 animate-in fade-in slide-in-from-right-4 duration-500">
              <div className="bg-obsidian-surface border border-[#ffffff08] rounded-xl p-8 space-y-8 shadow-2xl relative">
                ...
                <div className="flex flex-col items-center text-center space-y-4 pt-2">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold tracking-tight text-white mb-1.5 uppercase">
