            ...
            <div className="bg-white rounded-[3.5rem] border border-slate-200 shadow-2xl w-full max-w-lg overflow-hidden flex flex-col animate-in zoom-in-95 duration-300">
                <div className="p-10 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-black tracking-tighter text-slate-900 leading-none">Provision Admin</h2>
                ...
                <form onSubmit={handleSubmit} className="p-12 space-y-8">
                    ...
                    <div className="space-y-3">
                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Authority Bracket (Role)</label>
                ...
                <div className="p-8 bg-slate-900 flex items-center gap-6">
                    ...
                    <p className="text-[9px] text-white/40 font-bold uppercase tracking-widest leading-relaxed">
                        Security Notice: Provisioning an administrative account grants high-level authorization. This event will be recorded in the immutable audit ledger.
                    </p>
                </div>
            </div>
        </div>
