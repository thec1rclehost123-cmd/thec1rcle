  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-sm transition-all duration-500">
      ...
      >
            ...
            <div className="space-y-1">
              ...
              {isTier3 && (
                <div className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-iris/10 border border-iris/20 w-fit">
                  ...
                  <span className="text-[9px] text-iris font-bold uppercase tracking-widest">
                    Critical Override
                  </span>
                </div>
              )}
        ...
        <div className="p-8 space-y-6">
          {isTier3 && (
            <div className="p-4 rounded-lg bg-iris/5 border border-iris/10 space-y-2">
              <p className="text-[10px] font-bold uppercase tracking-widest text-iris">
                Security Advisory
              </p>
              <p className="text-[11px] text-zinc-400 leading-relaxed font-medium">
                High-impact structural change detected. This action is immutable and will be
        ...
        <div
          className={`px-8 py-4 bg-black/20 border-t border-[#ffffff05] flex items-center justify-between`}
        >
