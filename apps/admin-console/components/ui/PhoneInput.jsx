    ...
    return (
        <div className="space-y-2">
            <div className="flex justify-between items-end mb-2">
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40 block">Mobile Access Code</label>
                <button
                    type="button"
            ...
            <div className="group relative">
                ...
                <div className="flex items-center gap-4 bg-transparent border-b border-white/10 py-4 transition-all focus-within:border-white/30">
                    ...
                    <input
                        ...
                        className="w-full bg-transparent text-sm font-bold tracking-[0.2em] text-white placeholder:text-white/10 focus:outline-none"
                    />
                </div>
            </div>
            {errorText && (
