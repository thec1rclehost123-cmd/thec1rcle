...
export function EmptyState({
  ...
  return (
    <Animated.View entering={FadeIn.delay(200)} style={styles.container}>
      <Animated.Text entering={FadeInDown.delay(250)} style={styles.emoji}>
        {emoji || content.emoji}
      </Animated.Text>
      ...
      <Animated.Text entering={FadeInDown.delay(350)} style={styles.message}>
      ...
      {(actionLabel || content.action) && onAction && (
        <Animated.View entering={FadeInDown.delay(400)}>
          <Pressable onPress={handleAction}>
            ...
            >
              <Text style={styles.primaryButtonText}>{actionLabel || content.action}</Text>
            </LinearGradient>
          </Pressable>
        </Animated.View>
      )}
      ...
      {secondaryActionLabel && onSecondaryAction && (
        <Animated.View entering={FadeInDown.delay(450)}>
          <Pressable onPress={handleSecondaryAction} style={styles.secondaryButton}>
...
export function NetworkError({ onRetry }: { onRetry?: () => void }) {
  return <EmptyState type="no-connection" actionLabel="Retry" onAction={onRetry} />;
}
