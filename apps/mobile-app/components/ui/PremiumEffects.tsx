...
export function LiquidGlass({
  ...
  return (
    <View style={[styles.liquidGlassContainer, { borderRadius }, style]}>
      ...
      <Animated.View
        style={[styles.glassBorder, { borderRadius, borderColor: glowColor }, glowStyle]}
      />
...
export function PulseRing({
  ...
  useEffect(() => {
    ...
    ring2Scale.value = withDelay(
      500,
      withRepeat(withTiming(1.8, { duration: 1500, easing: Easing.out(Easing.ease) }), -1, false),
    );
    ring2Opacity.value = withDelay(
      500,
      withRepeat(withTiming(0, { duration: 1500, easing: Easing.out(Easing.ease) }), -1, false),
    );
  }, []);
...
export function BentoCell({ children: childrenRaw, span = 1, style }: BentoCellProps) {
  ...
  return (
    <LiquidGlass style={cellStyle} borderRadius={20} intensity={30}>
      {children}
    </LiquidGlass>
  );
}
