    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.right}>
          {rightAction}
          {showNotifications && <NotificationBell count={notificationCount} variant="solid" />}
        </View>
      </View>
    </Animated.View>
  );
...
export function CompactHeader({
  ...
  const renderContent = () => (
    <View style={[styles.compactContent, { paddingTop: insets.top }]}>
      ...
      <View style={styles.compactRight}>{rightAction}</View>
    </View>
  );
  ...
  return <View style={[styles.compactContainer, styles.compactSolid]}>{renderContent()}</View>;
}
