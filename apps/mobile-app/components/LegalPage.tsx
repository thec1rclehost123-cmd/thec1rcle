...
> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        heading: '8. Contact Us',
        content: ['For privacy-related questions, contact us at privacy@thec1rcle.com.'],
      },
    ],
  },
  refunds: {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <Animated.View entering={FadeInDown.delay(100)} style={styles.lastUpdated}>
          <Text style={styles.lastUpdatedText}>Last updated: {content.lastUpdated}</Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeInDown.delay(500)} style={styles.footer}>
          <Text style={styles.footerText}>Questions? Contact us at legal@thec1rcle.com</Text>
        </Animated.View>
      </ScrollView>
    </View>
  );
