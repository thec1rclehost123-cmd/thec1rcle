...
export function CoverDeductionOverlay({
    ...
    const [successState, setSuccessState] = useState<{ charged: number; newBalance: number } | null>(null);
    ...
    }, [canProcess, selectedAmountPaise, selectedPreset, showCustom, wallet.id, sessionToken, deviceId, eventCodeId, operatorId, operatorName]);
                ...
                <View style={styles.sheet}>
                    {successState ? (
                        ...
                        <View style={styles.successContainer}>
                            ...
                            <Text style={styles.successCharged}>
                                Charged {formatPaise(successState.charged)}
                            </Text>
                            ...
                            <Pressable
                                ...
                                onPress={() => onSuccess(successState.newBalance)}
                            >
                                ...
                                <View
                                    style={[
                                        styles.progressFill,
                                        {
                                            ...
                                            backgroundColor: percent > 60 ? "#34d399" : percent > 25 ? "#a855f7" : "#71717a",
                                        },
                                    ]}
                                />
                            </View>
                            ...
                            {selectedAmountPaise > 0 && !isInsufficientBalance && (
                                <View style={styles.selectedSummary}>
                                    <Text style={styles.selectedSummaryText}>
                                        {showCustom ? "Custom" : selectedPreset?.name} — {formatPaise(selectedAmountPaise)}
                                    </Text>
                                </View>
                            )}
