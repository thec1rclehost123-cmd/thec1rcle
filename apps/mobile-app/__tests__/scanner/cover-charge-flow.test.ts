...
const MOCK_WALLET = {
    ...
    rules: {
        ...
        showBalanceToGuest: true, maxChargeAmountPaise: 0, minChargeAmountPaise: 0,
    },
};
...
describe('debit flow', () => {
        ...
        const result = await submitDebit(
            {
                ...
                idempotencyKey: 'key_1', operatorId: 'scanner_code',
                operatorName: 'Scanner', operatorRole: 'door_staff',
                deviceId: 'test_device', eventCodeId: 'code_1', isOnline: true,
            },
            SESSION_TOKEN,
        );
    ...
    it('DEBIT_ERROR retry: uses SAME idempotencyKey (not regenerated)', async () => {
        ...
        await submitDebit(
            { walletId: 'w1', presetItemId: 'i1', quantity: 1, idempotencyKey: key, operatorId: 'op', operatorName: 'S', operatorRole: 'staff', deviceId: 'd1', eventCodeId: 'c1', isOnline: true },
            SESSION_TOKEN,
        );
