    ...
    <SafeAreaView className="flex-1 bg-midnight">
      ...
      >
        ...
        >
          ...
          {/* Header */}
          <View className="mb-8">
            <Text className="text-gold font-satoshi-black text-3xl mb-2">Join the Circle</Text>
          ...
          <View className="mb-6">
            ...
            <Text className="text-gold-stone text-xs text-center mb-6">
              By signing up, you agree to our <Text className="text-iris">Terms of Service</Text>{" "}
              and <Text className="text-iris">Privacy Policy</Text>
            </Text>
