    ...
    <SafeAreaView className="flex-1 bg-midnight">
      ...
      >
        ...
        <View className="items-center mb-10">
          <Text className="text-iris font-satoshi-black text-4xl tracking-wider">THE.C1RCLE</Text>
        ...
        <View className="mb-6">
          ...
          <Pressable
            ...
            className={`py-4 rounded-pill items-center mb-4 ${
              loading || !email || !password ? "bg-iris/50" : "bg-iris"
            }`}
          >
            {loading ? (
          ...
          <View className="flex-row gap-4">
            {Platform.OS === "ios" && (
              <Pressable
                ...
                disabled={loading}
                className={`flex-1 bg-surface border border-white/10 py-4 rounded-bubble items-center ${
        ...
        <View className="mt-8">
          ...
          >
            ...
            >
              <Text className="text-lg mr-2">📱</Text>
              <Text className="text-iris font-semibold text-base">Scan Tickets</Text>
