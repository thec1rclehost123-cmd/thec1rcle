  ...
  return (
    <View className="mb-6">
      {editedContacts.map((contact, index) => (
        <View
          key={contact.id}
          className="bg-midnight-100 rounded-bubble border border-white/10 p-4 mb-3"
        >
...
export default function SafetyScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-midnight">
      ...
      >
        {/* SOS Button */}
        <Pressable onPress={handleSOS} className="bg-red-600 rounded-bubble p-6 mb-6 items-center">
        ...
        {/* Emergency Contacts */}
        <Text className="text-gold font-satoshi-bold text-lg mb-4">👥 Emergency Contacts</Text>
        ...
        <View className="bg-surface rounded-bubble border border-white/10 p-4">
          <Text className="text-gold font-semibold mb-3">💡 Safety Tips</Text>
          ...
          <Text className="text-gold-stone text-sm">• Book your ride home through the app</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
