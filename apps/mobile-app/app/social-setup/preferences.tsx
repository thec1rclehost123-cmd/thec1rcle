        ...
        <View style={chipStyles.container}>
            ...
            <View style={chipStyles.row}>
                {options.map(({ value, label: lbl }) => (
                    ...
                    >
                        <Text style={[chipStyles.chipText, selected.includes(value) && chipStyles.chipTextSelected]}>
                            {lbl}
                        </Text>
                    </Pressable>
                ))}
...
const chipStyles = StyleSheet.create({
    ...
    label: { color: "rgba(255,255,255,0.5)", fontSize: 12, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 10 },
...
}: { min: number; max: number; onChangeMin: (v: number) => void; onChangeMax: (v: number) => void }) {
    return (
            ...
            <View style={ageStyles.row}>
                <View style={ageStyles.control}>
                    ...
                    <View style={ageStyles.counter}>
                        <Pressable
                            ...
                            onPress={() => { Haptics.selectionAsync(); onChangeMin(Math.max(18, min - 1)); }}
                        >
                        ...
                        <Pressable
                            style={ageStyles.counterBtn}
                            onPress={() => { Haptics.selectionAsync(); onChangeMin(Math.min(max - 1, min + 1)); }}
                        >
                            <Text style={ageStyles.counterBtnText}>+</Text>
                        </Pressable>
                    </View>
                ...
                <View style={ageStyles.control}>
                    ...
                    <View style={ageStyles.counter}>
                        <Pressable
                            style={ageStyles.counterBtn}
                            onPress={() => { Haptics.selectionAsync(); onChangeMax(Math.max(min + 1, max - 1)); }}
                        >
                            <Text style={ageStyles.counterBtnText}>−</Text>
                        </Pressable>
                        ...
                        <Pressable
                            style={ageStyles.counterBtn}
                            onPress={() => { Haptics.selectionAsync(); onChangeMax(Math.min(60, max + 1)); }}
                        >
                            <Text style={ageStyles.counterBtnText}>+</Text>
                        </Pressable>
                    </View>
...
const ageStyles = StyleSheet.create({
    ...
    counter: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.1)", overflow: "hidden" },
    counterBtn: { paddingHorizontal: 18, paddingVertical: 12 },
    counterBtnText: { color: "rgba(255,255,255,0.7)", fontSize: 20, fontWeight: "300", lineHeight: 22 },
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                {/* City */}
                <Animated.View entering={FadeInDown.delay(140).springify().damping(18)} style={styles.fieldGroup}>
