...
export default function SocialSetupReview() {
    ...
    const interestedInLabel = (interestedIn as string[])
        .map((v: string) => v === "male" ? "Men" : v === "female" ? "Women" : v === "nonbinary" ? "Non-binary" : "Everyone")
        .join(", ");
                ...
                >
                    ...
                    <View style={styles.photoContainer}>
                        ...
                        <View style={styles.nameOverlay}>
                            ...
                            {params.city && (
                                <Text style={styles.cardCity}>{params.city}</Text>
                            )}
                        </View>
                    </View>
...
const infoStyles = StyleSheet.create({
    ...
    value: { color: "rgba(255,255,255,0.85)", fontSize: 13, fontWeight: "600", textTransform: "capitalize" },
});
