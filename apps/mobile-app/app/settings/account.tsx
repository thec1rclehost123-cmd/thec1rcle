...
export default function AccountSettingsScreen() {
    ...
    return (
        <DittoSettingsScreen title="Account Settings">
            ...
            <SettingsGroup>
                <SettingsRow title="Email" value={email} onPress={() => Alert.alert("Email", "Email changes will be available soon.")} />
                <Divider />
                <SettingsRow title="Phone Number" value="+1 602-349-2605" onPress={() => Alert.alert("Phone Number", "Phone number editing will be available soon.")} />
                <Divider />
            ...
            <SettingsGroup>
                <SettingsRow title="Passkeys" onPress={() => Alert.alert("Coming Soon", "Passkeys will be available soon.")} />
            </SettingsGroup>
