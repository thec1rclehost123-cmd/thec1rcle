    ...
    <DittoSettingsScreen title="Payment">
      <SettingsGroup>
        <SettingsRow
          icon={
            <TileIcon>
              <CreditCard size={17} color="#fff" strokeWidth={2.4} />
            </TileIcon>
          }
          title="Add Payment Method"
          onPress={() =>
            Alert.alert('Coming Soon', 'Saved payment methods will be available soon.')
          }
        />
      </SettingsGroup>
      ...
      <SettingsGroup>
        <SettingsRow
          icon={
            <TileIcon>
              <Clock size={17} color="#fff" strokeWidth={2.4} />
            </TileIcon>
          }
