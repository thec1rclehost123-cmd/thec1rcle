...
export default function PermissionsSettingsScreen() {
    ...
    return (
        <DittoSettingsScreen title="Permissions">
            <SettingsGroup>
                <SettingsSwitchRow title="Contacts Syncing" value={contactsSyncing} onValueChange={setContactsSyncing} />
            </SettingsGroup>
            <HelperText>
            ...
            <SettingsGroup>
                <SettingsSwitchRow title="Location Access" value={locationAccess} onValueChange={setLocationAccess} />
            </SettingsGroup>
            <HelperText>
            ...
            <SettingsGroup>
                <SettingsRow
                    icon={<TileIcon><Camera size={17} color="#fff" strokeWidth={2.4} /></TileIcon>}
                    title="Allow Camera Access"
                    onPress={() => Alert.alert("Camera Access", "Open system settings to update camera permissions.")}
                />
            </SettingsGroup>
            <HelperText>
                Check in guests or take photos for your events, avatar and chats.
            </HelperText>
            ...
            <HelperText>
                Control your profile visibility and privacy settings across the app.
            </HelperText>
            ...
            <HelperText>
                Blocked accounts can't chat with you or invite you to events.
            </HelperText>
        </DittoSettingsScreen>
    );
}
