...
import { getEventChat, sendEventMessage, subscribeToEventMessages, ChatMessage } from "@/lib/chat";
  ...
  return (
    <SafeAreaView className="flex-1 bg-midnight" edges={["top"]}>
      ...
      >
        ...
        {/* Error Banner */}
        {error && (
          <Pressable onPress={() => setError(null)} className="bg-red-500/20 px-4 py-2">
            ...
            <View className="flex-row items-end">
              ...
              <Pressable
                ...
                className={`w-12 h-12 rounded-full items-center justify-center ${
                  inputText.trim() && !sending ? "bg-iris" : "bg-iris/50"
                }`}
              >
                {sending ? (
