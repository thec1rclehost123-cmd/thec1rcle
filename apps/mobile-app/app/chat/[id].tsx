...
import { sendGroupMessage, subscribeToGroupChat } from '@/lib/social/groupChat';
        ...
        >
          {loading ? (
            ...
            <View className="items-center py-20">
              <Text className="text-gold font-semibold">Start the Conversation!</Text>
            </View>
          ) : (
            messages.map((m) => (
              <MessageBubble key={m.id} message={m} isOwnMessage={m.senderId === user?.uid} />
            ))
          )}
        </ScrollView>
