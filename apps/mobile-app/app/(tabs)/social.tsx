  ...
  return (
    <View style={styles.modalOverlay}>
      <View style={styles.matchModal}>
        ...
        <Text style={styles.matchSubtitle}>You and {match.displayName} both liked each other</Text>
        ...
        <Text style={styles.matchEventText}>Met at: {match.sharedEventTitle}</Text>
      ...
      {loading ? (
        ...
        <View style={styles.center}>
          ...
          <Text style={styles.emptyBody}>
            People attending the same upcoming events as you will appear here. Buy a ticket to meet
            others!
          </Text>
