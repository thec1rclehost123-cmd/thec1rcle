    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <Animated.View entering={FadeInDown.delay(100).springify()} style={styles.profileHeader}>
          ...
          {/* User Info */}
          <Text style={styles.userName}>{user?.displayName || "Party Enthusiast"}</Text>
        ...
        <View style={styles.menuContainer}>
          ...
          <View style={styles.menuSection}>
            ...
            <MenuItem
              ...
              onPress={() =>
                Alert.alert("Support", "Email: support@thec1rcle.com\nWhatsApp: +91 98765 43210")
              }
              delay={1000}
            />
            <View style={styles.menuDivider} />
            ...
            <MenuItem
              ...
              onPress={() =>
                Alert.alert("Privacy", "View our privacy policy at thec1rcle.com/privacy")
              }
              delay={1100}
            />
          </View>
          ...
          {/* App Version */}
          <Animated.View entering={FadeIn.delay(1250)} style={styles.footer}>
            <LinearGradient
              colors={gradients.primary as [string, string]}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
            ...
            <Text style={styles.footerText}>THE C1RCLE v1.0.0</Text>
            <Text style={styles.footerSubtext}>Made with ♡ in India</Text>
          </Animated.View>
        </View>
      </ScrollView>
    </View>
