...
function PremiumTabIcon({
  ...
  return (
    <View style={styles.tabIconContainer}>
      ...
      {focused && (
        <Animated.View style={styles.activeIndicator} entering={undefined}>
          <LinearGradient
...
function PremiumTabBarBackground() {
  ...
  useEffect(() => {
    ...
    auroraOpacity.value = withRepeat(
      withSequence(withTiming(0.7, { duration: 3000 }), withTiming(0.4, { duration: 3000 })),
      -1,
      true,
    );
  }, []);
  ...
  return (
    <View style={styles.tabBarBgContainer}>
      ...
      <LinearGradient
        colors={["rgba(255,255,255,0.02)", "rgba(244, 74, 34, 0.2)", "rgba(255,255,255,0.02)"]}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 0 }}
