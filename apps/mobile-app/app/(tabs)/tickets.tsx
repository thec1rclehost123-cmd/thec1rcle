    ...
    >
      <View style={styles.modalContainer}>
        <SafeAreaView style={styles.modalSafeArea}>
          {/* Header */}
          <Animated.View entering={FadeIn.delay(100)} style={styles.modalHeader}>
          ...
          >
            {/* QR Code Card */}
            <Animated.View entering={SlideInUp.delay(150).springify()} style={styles.qrCard}>
              <LinearGradient
              ...
              >
                <View style={styles.qrContainer}>
                  <QRCode value={qrData} size={200} color="#161616" backgroundColor="#ffffff" />
                </View>
              </LinearGradient>
              ...
              <View style={styles.qrCardContent}>
                ...
                <View style={styles.qrInfoRow}>
                  <Text style={styles.qrInfoIcon}>📍</Text>
                  <Text style={styles.qrInfoText}>{order.venueLocation || "Venue TBA"}</Text>
                </View>
                ...
                <Text style={styles.qrOrderId}>Order #{order.id.substring(0, 12)}</Text>
              </View>
            ...
            {/* Action Buttons */}
            <Animated.View entering={FadeInUp.delay(300)} style={styles.modalActions}>
              {walletAvailable && (
                <Pressable onPress={handleAddToWallet} style={styles.modalActionButton}>
                  <LinearGradient
                    colors={gradients.primary as [string, string]}
                    style={styles.modalActionGradient}
                  >
                    <Text style={styles.modalActionIcon}>📥</Text>
                    <Text style={styles.modalActionTextWhite}>Add to Wallet</Text>
                  </LinearGradient>
                </Pressable>
              )}
              ...
              <View style={styles.modalActionRow}>
                ...
                <Pressable onPress={handleTransfer} style={styles.modalSecondaryButton}>
    ...
    >
      ...
      <View style={styles.ticketQRSection}>
        <View style={styles.ticketQRContainer}>
          <QRCode value={order.id} size={120} color="#161616" backgroundColor="#ffffff" />
        </View>
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          {/* Receive ticket card */}
          <Pressable onPress={() => router.push("/transfer")} style={styles.receiveCard}>
            <LinearGradient
              colors={["rgba(244, 74, 34, 0.15)", "rgba(244, 74, 34, 0.05)"]}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
