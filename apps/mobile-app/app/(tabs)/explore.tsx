  ...
  return (
    ...
    >
      ...
      {event.coverImage ? (
        ...
        <LinearGradient colors={["#F44A22", "#8B2010"]} style={styles.heroImage} />
      )}
      ...
      <View style={styles.heroContent}>
        ...
        <View style={styles.heroFooter}>
          ...
          <View style={styles.heroPriceContainer}>
            ...
            <Text style={styles.heroPrice}>{lowestPrice === 0 ? "Free" : `₹${lowestPrice}`}</Text>
          </View>
        </View>
      </View>
  ...
  return (
    ...
    >
      ...
      {event.coverImage ? (
        ...
        <LinearGradient colors={["#292929", "#1F1F1F"]} style={styles.listImage}>
      ...
      <View style={styles.listContent}>
        ...
        <View style={styles.listFooter}>
          <Text style={styles.listPrice}>{lowestPrice === 0 ? "Free" : `₹${lowestPrice}`}</Text>
          {event.stats?.rsvps && event.stats.rsvps > 0 && (
            <Text style={styles.listAttendees}>{event.stats.rsvps}+ going</Text>
          )}
        </View>
      </View>
...
export default function ExploreScreen() {
  const { events, featuredEvents, loading, error, fetchEvents, fetchFeaturedEvents } =
    useEventsStore();
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        {error && !loading && events.length === 0 && cachedEvents.length === 0 && (
          <ErrorState message="Failed to load events. Please try again." onRetry={onRefresh} />
        )}
        ...
        {/* Empty State */}
        {showEmpty && !error && (
          <EmptyState type="no-events" actionLabel="Refresh" onAction={onRefresh} />
        )}
        ...
        {isOffline && lastSync && (
          <Text style={styles.syncText}>
            Last updated:{" "}
            {lastSync.toLocaleDateString("en-IN", {
              hour: "numeric",
              minute: "2-digit",
            })}
          </Text>
