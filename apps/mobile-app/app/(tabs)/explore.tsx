      ...
      >
        ...
        <View style={styles.largeCardImg}>
          ...
          <Animated.View
            style={[
              styles.likeBtn,
              useAnimatedStyle(() => ({ transform: [{ scale: heartScale.value }] })),
            ]}
          >
    ...
    >
      ...
      >
        <View style={styles.gridImgWrap}>
          ...
          {/* SOLD OUT overlay */}
          {isSoldOut && (
            <View style={styles.gridSoldOut}>
              <Text style={styles.gridSoldOutText}>SOLD OUT</Text>
            </View>
          )}
          {/* Like button */}
          <Animated.View
        ...
        <View style={styles.gridBody}>
          ...
          <View style={styles.gridFooter}>
            ...
            {price > 0 && !isSoldOut && (
              <Text style={styles.gridPrice}>₹{price.toLocaleString('en-IN')}</Text>
            )}
          </View>
        </View>
      </AnimatedPressable>
