    ...
    <SafeAreaView className="flex-1 bg-midnight">
      ...
      >
        ...
        <View className="bg-surface border border-white/10 rounded-bubble p-4 mb-6">
          <Text className="text-gold-stone text-sm">
            💾 Contacts you've saved from event chats. These connections persist even after the
            event chat expires.
          </Text>
        </View>
        ...
        {!loading && contacts.length === 0 && (
          <View className="items-center py-20">
            ...
            <Text className="text-gold-stone text-center px-6">
              When you connect with someone at an event, you can save them as a contact to stay in
              touch after the event chat ends.
            </Text>
          </View>
        )}
