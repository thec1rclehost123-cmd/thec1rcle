      ...
      >
        ...
        <View className="bg-surface border border-white/10 rounded-bubble p-4 mb-6">
          <Text className="text-gold-stone text-sm">
            Reports are reviewed by our safety team. We take all reports seriously and will take
            action if our guidelines are violated.
          </Text>
        </View>

        {/* Category Selection */}
        <Text className="text-gold font-semibold text-lg mb-4">What's the issue?</Text>
        ...
        {REPORT_CATEGORIES.map((cat) => (
          ...
          >
            ...
            {selectedCategory === cat.id && <Text className="text-iris">✓</Text>}
          </Pressable>
        ))}
        ...
        {selectedCategory === 'safety' && (
          <View className="bg-red-500/20 border border-red-500/50 rounded-bubble p-4 mb-6">
            ...
            <Text className="text-red-300 text-sm">
              If you're in immediate danger, please contact local emergency services. Venue security
              can also help if you're at an event.
            </Text>
          </View>
        )}
