...
export default function GuestListScreen() {
    ...
    useEffect(() => {
        if (!eventData?.valid) { router.replace("/scanner" as any); return; }
        loadGuests();
    }, []);
        ...
        >
            ...
            <View style={styles.guestInfo}>
                ...
                <View style={styles.guestMeta}>
                    ...
                    {item.quantity > 1 && (
                        <Text style={styles.guestQty}>×{item.quantity}</Text>
                    )}
                </View>
            </View>
            {item.enteredAt && (
...
const styles = StyleSheet.create({
    ...
    searchBar: { flexDirection: "row", alignItems: "center", backgroundColor: colors.surface, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12 },
    searchInput: { flex: 1, color: colors.gold, fontSize: 16, marginLeft: 10 },
    filterContainer: { paddingHorizontal: 16, paddingVertical: 10 },
    filterRow: { flexDirection: "row", backgroundColor: colors.surface, borderRadius: 14, padding: 4 },
    ...
    statusIcon: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center", marginRight: 14 },
    ...
    doorBadge: { backgroundColor: "rgba(244,74,34,0.15)", paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, marginLeft: 8 },
