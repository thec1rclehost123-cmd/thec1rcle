  ...
  if (!canWalkIn) {
    return (
      <SafeAreaView style={[styles.container, styles.center]}>
        ...
        <Text style={styles.restrictedText}>This event code does not allow walk-in logging.</Text>
            ...
            {recentWalkIns.map((entry) => (
              <View key={entry.id} style={styles.walkInRow}>
                <View style={styles.avatar}>
                  <Text style={styles.avatarText}>{entry.guestName.charAt(0).toUpperCase()}</Text>
                </View>
