...
export default function DoorEntryScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView bounces={false} overScrollMode="never" style={styles.formScroll} keyboardShouldPersistTaps="handled">
                {/* Guest Info */}
                ...
                <View style={styles.tiersRow}>
                    {tiers.map((tier) => (
                        ...
                        >
                            <Text style={[
                                styles.tierName,
                                selectedTier?.id === tier.id && styles.tierNameSelected,
                            ]}>
                                {tier.name}
                            </Text>
                            <Text style={[
                                styles.tierPrice,
                                selectedTier?.id === tier.id && styles.tierPriceSelected,
                            ]}>
                                ₹{tier.price}
                            </Text>
                            {!tier.available && (
                ...
                <View style={styles.quantityRow}>
                    <Pressable
                        onPress={() => {
                            if (quantity > 1) { setQuantity(quantity - 1); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); }
                        }}
                        disabled={quantity <= 1}
                    ...
                    <Pressable
                        onPress={() => { setQuantity(quantity + 1); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); }}
                        style={styles.qtyBtn}
                    >
                        <Text style={styles.qtyBtnText}>+</Text>
                    </Pressable>
...
const styles = StyleSheet.create({
    ...
    sectionLabel: { color: colors.goldMetallic, fontSize: 12, fontWeight: "700", letterSpacing: 1.5, marginBottom: 10, marginTop: 20 },
    ...
    tierPrice: { color: colors.gold, fontSize: 22, fontWeight: "800", marginTop: 4, textAlign: "center" },
    tierPriceSelected: { color: colors.irisGlow },
    tierSoldOut: { color: colors.goldMetallic, fontSize: 11, marginTop: 4 },
    quantityRow: { flexDirection: "row", alignItems: "center", backgroundColor: colors.surface, borderRadius: 16, padding: 16 },
    qtyBtn: { width: 52, height: 52, borderRadius: 14, backgroundColor: colors.iris, alignItems: "center", justifyContent: "center" },
    ...
    paymentCard: {
        ...
        borderWidth: 2, borderColor: "rgba(255,255,255,0.08)", backgroundColor: colors.surface,
    },
    ...
    bottomCta: {
        ...
        backgroundColor: colors.base[50], borderTopWidth: 1,
        borderTopColor: "rgba(255,255,255,0.06)", paddingHorizontal: 16,
    ...
    submitBtn: { backgroundColor: colors.success, paddingVertical: 18, borderRadius: 14, alignItems: "center" },
    ...
    successCard: { backgroundColor: "rgba(255,255,255,0.2)", borderRadius: 20, paddingHorizontal: 32, paddingVertical: 24, marginTop: 20, alignItems: "center" },
    ...
    noPermSub: { color: colors.goldMetallic, fontSize: 15, textAlign: "center", marginTop: 8, paddingHorizontal: 40 },
