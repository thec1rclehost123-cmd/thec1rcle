  ...
  const faqs = [
    {
      ...
      a: "Go to your ticket details in the 'My Tickets' tab and tap 'Transfer Tickets'. Enter your friend's phone number to send it to them instantly.",
    },
    {
      q: 'Can I get a refund?',
      a: 'Ticket purchases are generally non-refundable unless an event is cancelled by the organizer. You can always transfer your ticket to someone else.',
    },
    {
      q: 'How does the waiting list work?',
      a: "If an event is sold out, you can join the waiting list. You'll be notified immediately if more tickets are released.",
    },
    {
      q: 'Is my personal data secure?',
      a: 'Yes, we use industry-standard encryption to protect your data. We never sell your personal information.',
    },
  ];
      ...
      >
        ...
        <Animated.View entering={FadeInDown.delay(100)} style={styles.contactSection}>
          ...
          <Pressable
            ...
            onPress={() => Linking.openURL('https://thec1rcle.com/faq')}
          >
            <View style={styles.contactIconWrap}>
