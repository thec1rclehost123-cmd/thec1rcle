    ...
    <View style={styles.container}>
      ...
      <View style={[styles.floatingHeader, { paddingTop: insets.top }]}>
        <View style={styles.floatingHeaderContent}>
          <HeaderButton icon="←" onPress={() => router.back()} />
          ...
          <View style={styles.floatingHeaderActions}>
            <HeaderButton icon={isLiked ? "❤️" : "♡"} onPress={handleLike} />
            <HeaderButton icon="↗️" onPress={handleShare} />
            <HeaderButton icon="🛒" onPress={() => router.push("/checkout")} badge={cartCount} />
          </View>
        </View>
      </View>
      ...
      >
        ...
        <Animated.View style={[styles.heroContainer, headerAnimatedStyle]}>
          {event.coverImage ? (
            ...
            <LinearGradient colors={["#292929", "#1F1F1F", "#161616"]} style={styles.heroImage}>
        ...
        <View style={styles.content}>
          {/* Event Title */}
          <Animated.Text entering={FadeInDown.delay(100).springify()} style={styles.eventTitle}>
            {event.title}
          </Animated.Text>
          ...
          {/* Venue Map */}
          {venueCoords && (
            <Animated.View entering={FadeInDown.delay(180).springify()} style={styles.mapSection}>
              ...
              <View style={styles.mapContainer}>
                ...
                <View style={styles.mapActions}>
                  <Pressable onPress={handleGetDirections} style={styles.mapActionButton}>
                    <LinearGradient
                      colors={gradients.primary as [string, string]}
                      start={{ x: 0, y: 0 }}
                      end={{ x: 1, y: 0 }}
          ...
          {/* Attendees Preview */}
          <Animated.View entering={FadeInDown.delay(200).springify()} style={styles.attendeesCard}>
            ...
            <View style={styles.attendeesRow}>
              <View style={styles.attendeesAvatars}>
                {[0, 1, 2, 3, 4].map((i) => (
                  <View
                    key={i}
                    style={[styles.attendeeAvatar, { marginLeft: i > 0 ? -10 : 0, zIndex: 5 - i }]}
                  >
                    <LinearGradient
              ...
              <Text style={styles.attendeesCount}>+{event.stats?.rsvps || 0} attending</Text>
            </View>
          </Animated.View>
          ...
          {/* Safety Notice */}
          <Animated.View entering={FadeInDown.delay(400).springify()} style={styles.safetyCard}>
