...
import { initiateDMRequest, blockUser, isUserBlocked, checkEventEntitlement } from '@/lib/social';
...
export default function ProfileViewScreen() {
  ...
  const handleBlock = async () => {
    ...
    Alert.alert('Block User', "This user won't be able to message you anywhere.", [
