...
files.forEach(file => {
  ...
  const tags = ['ScrollView', 'FlatList', 'SectionList', 'FlashList', 
                'Animated\\.ScrollView', 'Animated\\.FlatList', 'Animated\\.FlashList', 
                'BottomSheetScrollView', 'BottomSheetFlatList', 'KeyboardAwareScrollView'];
