    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <View style={styles.hero}>
          ...
          <LinearGradient
            colors={['rgba(0,0,0,0.12)', 'rgba(0,0,0,0.72)', '#161616']}
        ...
        <View style={styles.body}>
          ...
          <View style={styles.ctaRow}>
            ...
            <Pressable
              onPress={() =>
                router.push({ pathname: '/map', params: { mode: 'venues', venueId: venue.id } })
              }
          ...
          <Animated.View entering={FadeInDown.delay(150)} style={styles.section}>
            <View style={styles.tabRow}>
              ...
              >
                <Text
                  style={[styles.tabButtonText, activeTab === 'menu' && styles.tabButtonTextActive]}
                >
                  Food Menu
                </Text>
              </Pressable>
              ...
              upcomingEvents.length > 0 ? (
                ...
                <View style={styles.emptyPanel}>
                  <Text style={styles.emptyPanelText}>
                    No upcoming events are scheduled here yet.
                  </Text>
                </View>
              )
            ) : menu.length > 0 ? (
      ...
      <Modal
        ...
        transparent
        animationType="fade"
        onRequestClose={() => setStoryModal(null)}
      >
        <View style={styles.storyBackdrop}>
          ...
          {storyModal ? (
            <Animated.View entering={FadeIn} style={styles.storyCard}>
              <Image
                source={{ uri: storyModal.highlight.images[storyModal.imageIndex] }}
