...
export default function EventDetailScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: '#000000' }]}>
                ...
                <View style={styles.confirmationBannerContent}>
                  ...
                  <View style={styles.confirmationBannerTextContainer}>
                    ...
                    <Text style={styles.confirmationBannerSubtitle}>
                      Tap below to view your order confirmation
                    </Text>
                  </View>
                </View>
                <Pressable
            ...
            <Animated.View entering={FadeInDown.delay(200).springify()}>
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <Text style={styles.guestlistPreviewText}>{eventInterested.length} Guests</Text>
                </View>
      ...
      <View
        style={[styles.floatingBottomBar, { paddingBottom: insets.bottom || 24 }]}
