    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.footer}>
                ...
                <Pressable onPress={() => router.push("/notification-permission")} style={styles.skipButton}>
...
const styles = StyleSheet.create({
    ...
    iconContainer: { width: 96, height: 96, borderRadius: 48, backgroundColor: "rgba(244, 74, 34, 0.1)", justifyContent: "center", alignItems: "center", marginBottom: 32 },
    title: { fontSize: 28, fontWeight: "800", color: "#FFFFFF", marginBottom: 16, textAlign: "center", letterSpacing: 0.5 },
