                ...
                <View style={styles.mainCard}>
                    ...
                    <View style={styles.progressBar}>
                        <View style={[
                            ...
                            {
                                width: `${fillPct}%`,
                                backgroundColor: fillPct >= 90 ? colors.error : fillPct >= 70 ? colors.warning : colors.success,
                            } as any
                        ]} />
                    </View>
                            ...
                            <View key={tier.id} style={styles.breakdownRow}>
                                <View style={styles.breakdownLeft}>
                                    <View style={[
                                        ...
                                        {
                                            backgroundColor:
                                                tier.entryType === "vip" ? colors.warning
                                                    : tier.entryType === "couple" ? colors.iris
                                                        : colors.success,
                                        }
                                    ]} />
...
const styles = StyleSheet.create({
    ...
    progressBar: { width: "100%", height: 12, backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 6, marginTop: 20, overflow: "hidden" },
    ...
    breakdownRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 12, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.04)" },
