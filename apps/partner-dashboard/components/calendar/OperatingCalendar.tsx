...
export function OperatingCalendar() {
  ...
  const selectedDay = useMemo(
    () => grid.find((d) => d?.dateStr === selectedDateStr),
    ...
    <div className="flex flex-col w-full gap-4" style={{ height: 'calc(100vh - 13rem)' }}>
      ...
      <div className="flex items-center justify-between gap-3 flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => {
              const n = parseAsIST(null);
              setCurrentDate(n);
              setSelected(toISODateIST(n));
            }}
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        ...
        >
          {/* ══ CALENDAR PANEL ═══════════════════════════════════ */}
          <div
            className="lg:flex-[2.4] flex flex-col min-h-0"
                ...
                : grid.map((cell, idx) => {
                    ...
                    return (
                      <button
                        key={cell.dateStr}
                        onClick={() => {
                          if (!isPast) setSelected(cell.dateStr);
                        }}
                        disabled={isPast}
              ...
              {selectedDateStr ? (
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p
                      className="text-[11px] leading-relaxed max-w-[140px] mx-auto"
                ...
                >
                  ...
                  {isSel && (
                    <div
                      ...
                      style={{ background: '#F44A22', boxShadow: '0 0 6px rgba(244,74,34,0.8)' }}
                    />
                  )}
                </button>
              );
...
function SidePanel({
  ...
  const { nowPct, isActive, nowTimeStr } = useMemo(() => {
    ...
    return {
      nowPct: pct(mins),
      isActive: active,
      nowTimeStr: `${h12}:${String(m).padStart(2, '0')} ${period}`,
    };
  }, [now, dateStr]);
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      >
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              {TIMELINE_HOURS.map(({ mins }) => (
                <div
                  ...
                  style={{
                    top: `${(mins / TOTAL_MINS) * 100}%`,
                    background:
                      mins % 240 === 0 ? 'rgba(255,255,255,0.12)' : 'rgba(255,255,255,0.05)',
                  }}
                />
              ))}
              ...
              {isActive && (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ background: C.orange, boxShadow: '0 2px 12px rgba(244,74,34,0.4)' }}
                  >
                    <span className="w-1 h-1 rounded-full bg-white animate-pulse" />
                    <span className="text-[8px] font-black text-white tracking-wide">
                      {nowTimeStr}
                    </span>
                  </div>
                </div>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        backgroundImage:
                          'repeating-linear-gradient(135deg, rgba(248,113,113,0.12) 0px, rgba(248,113,113,0.12) 2px, transparent 2px, transparent 12px)',
              ...
              {evCount === 0 && !isBlocked && (
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 pointer-events-none">
                  <div
                    ...
                    style={{
                      background: 'rgba(244,74,34,0.08)',
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[9px] mt-0.5" style={{ color: 'rgba(255,255,255,0.12)' }}>
                      Night is open
                    </p>
                  </div>
                </div>
              ...
              {events.map((e: any) => {
                ...
                const isNow =
                  isActive && isConfirmed && nowMinsCurrent >= sMin && nowMinsCurrent <= eMin;
                    ...
                    <div className="h-full pl-3.5 pr-3 py-2 flex items-start justify-between gap-2">
                      <div className="min-w-0">
                        <div className="flex items-center gap-1.5 mb-0.5">
                          <p className="text-[11px] font-black text-white tracking-tight truncate uppercase">
                            {e.title || 'Reserved'}
                          </p>
                          {isNow && (
                            <span
                              className="flex-shrink-0 flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-white text-[7px] font-black uppercase"
                              style={{ background: C.teal }}
                            >
                              <span className="w-1 h-1 rounded-full bg-white animate-pulse" />
                              Live
                        ...
                        <p
                          className="text-[9px] font-black tabular-nums uppercase"
                          style={{ color: 'rgba(255,255,255,0.35)' }}
                        >
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{ color: C.amber }}
              >
                Needs Approval · {pendingSlots.length}
              </span>
            </div>
                  ...
                  {role === 'venue' && (
                    <div className="flex gap-1.5">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg text-white text-[9px] font-black uppercase tracking-wide hover:opacity-80 transition-opacity"
                        style={{ background: C.teal }}
                      >
                        Approve
                      </button>
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-wide border hover:bg-white/5 transition-colors"
                        style={{
                          color: 'rgba(255,255,255,0.4)',
                          borderColor: 'rgba(255,255,255,0.1)',
                        }}
        ...
        {evCount === 0 && pendingSlots.length === 0 && (
          <div
            className="mx-5 mb-4 rounded-2xl p-5 text-center border"
            ...
            {isBlocked ? (
              <>
                ...
                {data?.block?.startTime && (
                  <p
                    className="text-[9px] tabular-nums font-black mt-1.5"
              ...
              <>
                <div
                  className="w-8 h-8 rounded-xl mx-auto mb-2.5 flex items-center justify-center"
                  style={{
      ...
      {role === 'venue' && isBlockingMode && (
        <div
          ...
          style={{ background: '#13131a', borderColor: 'rgba(255,255,255,0.07)' }}
        >
          {/* Header */}
          <div
          ...
          >
            ...
            {/* Preview pill */}
            <span
              className="text-[9px] font-black tabular-nums px-2.5 py-1 rounded-full border"
              style={{
          ...
          <div className="px-5 pt-3 pb-4 space-y-3">
            ...
            {data?.state === 'BLOCKED' && (
              <button
                ...
                disabled={isPending}
                className="text-[9px] font-black uppercase tracking-widest transition-opacity hover:opacity-60"
                style={{ color: C.red }}
              >
      ...
      {/* ── Footer ───────────────────────────────────────────────── */}
      <div
        className="flex-shrink-0 p-4 flex gap-2 border-t"
      ...
      >
        {role === 'venue' ? (
            ...
            {isBlockingMode ? (
              <>
                <button
                  ...
                  className="flex-1 h-10 rounded-xl text-[10px] font-black uppercase tracking-wide border transition-colors hover:bg-white/5"
                ...
                <button
                  onClick={handleBlock}
                  disabled={isPending}
                  className="flex-[1.4] h-10 rounded-xl text-[10px] font-black uppercase tracking-wide text-white transition-opacity hover:opacity-85"
              ...
              <button
                ...
                className="flex-1 h-10 rounded-xl text-[10px] font-black uppercase tracking-wide border flex items-center justify-center gap-1.5 transition-colors hover:bg-white/5"
                style={{ color: 'rgba(255,255,255,0.4)', borderColor: 'rgba(255,255,255,0.08)' }}
              >
                {data?.state === 'BLOCKED' ? (
          ...
          <Link
            href="/host/events"
            className="flex-1 h-10 rounded-xl text-[10px] font-black uppercase tracking-wide border flex items-center justify-center gap-2 transition-colors hover:bg-white/5"
            style={{ color: 'rgba(255,255,255,0.4)', borderColor: 'rgba(255,255,255,0.08)' }}
          >
        ...
        {!isBlockingMode && (
          <button
            onClick={onClose}
            className="h-10 px-5 rounded-xl text-[10px] font-black uppercase tracking-wide border transition-colors hover:bg-white/5"
            style={{ color: 'rgba(255,255,255,0.4)', borderColor: 'rgba(255,255,255,0.08)' }}
          >
            Close
          </button>
