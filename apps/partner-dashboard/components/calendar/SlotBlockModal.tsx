        ...
        >
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between rounded-lg border border-border-default bg-surface-secondary px-4 py-3">
              ...
              <Toggle checked={isPartial} onChange={setIsPartial} />
            </div>
              ...
              {isPartial && (
                ...
                >
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs text-text-secondary mb-1.5">Start time</label>
                      <Input
                        type="time"
                        value={startTime}
                    ...
                    <div>
                      <label className="block text-xs text-text-secondary mb-1.5">End time</label>
                      <Input
                        type="time"
                        value={endTime}
            ...
            {blockMut.isError && (
              <p className="text-sm text-red-400">{(blockMut.error as Error).message}</p>
            )}
          </div>
