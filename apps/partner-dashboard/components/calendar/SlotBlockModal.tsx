        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    className="relative z-10 w-full max-w-md rounded-[var(--r-xl)] border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-6 shadow-[var(--shadow-xl)]"
                >
                    <div className="flex items-start justify-between mb-6">
                        <div>
                            <h2 className="text-base font-semibold text-[var(--text-primary)]">Block Date</h2>
                            <p className="text-sm text-[var(--text-tertiary)] mt-0.5">{date}</p>
                        </div>
                        <button
                            onClick={onClose}
                            className="rounded-lg p-1.5 text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-secondary)] transition-colors"
                        >
                            <X className="h-4 w-4" />
                        </button>
                    </div>
                    ...
                    <div className="space-y-5">
                        {/* Full day vs partial */}
                        <div className="flex items-center justify-between rounded-lg border border-[var(--border-default)] bg-[var(--bg-fill)] px-4 py-3">
                            <div>
                                <p className="text-sm text-[var(--text-primary)]">Partial day block</p>
