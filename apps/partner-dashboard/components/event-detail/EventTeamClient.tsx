...
import {
    X, Search, Mail, Phone, Trash2, Edit2, UserPlus,
...
const MOCK_HOST_SALES: HostSalesRow[] = [
    { id: "1", name: "Teddy Eisenstein", clicks: 0, ticketsSold: 0, conversionRate: 0,   revenueGenerated: 0    },
    { id: "2", name: "Owen Colwell",     clicks: 18, ticketsSold: 4, conversionRate: 22.2, revenueGenerated: 3200 },
    { id: "3", name: "Eli Taylor-Lemire", clicks: 34, ticketsSold: 9, conversionRate: 26.5, revenueGenerated: 7200 },
];
...
function AddTeamMemberModal({
    ...
    const setM = (field: keyof ManualForm) =>
                    ...
                    <div className="p-6 flex flex-col gap-4">
                        ...
                        >
                            {(["email", "phone"] as SearchMode[]).map(m => (
                                <button
                                    ...
                                    style={
                                        mode === m
                                            ? { background: "var(--v-card)", color: "var(--v-text-primary)", boxShadow: "0 1px 4px rgba(0,0,0,0.3)" }
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder={mode === "email" ? "Search by email address…" : "Search by phone number…"}
                                value={searchQuery}
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[11px] font-semibold" style={{ color: "var(--v-text-tertiary)" }}>or</span>
                            <div className="flex-1 h-px" style={{ background: "var(--v-border)" }} />
                        </div>
                    ...
                    <form onSubmit={handleContinue}>
                        <div className="p-6 flex flex-col gap-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="block text-[11px] font-semibold mb-1.5" style={{ color: "var(--v-text-secondary)" }}>
                                        First Name *
                                    </label>
                                    <input
                                        style={inputStyle}
        ...
        },
        {
            ...
            render: (row) => (
                <div className="flex items-center gap-2">
                    <div className="w-20 h-1.5 rounded-full overflow-hidden" style={{ background: "var(--v-elevated)" }}>
                        <div
