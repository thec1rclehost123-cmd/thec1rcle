                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      {CANCELLATION_REASONS.map((r) => (
                        ...
                        >
                          ...
                          <span
                            className={`text-[11px] font-bold ${selectedReason === r.id ? 'text-rose-500' : 'text-text-secondary'}`}
                          >
                            {r.label}
                          </span>
                        </button>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <p
                                className={`text-[12px] font-bold ${refundPolicy === policy.id ? 'text-rose-500' : 'text-text-primary'}`}
                              >
                                {policy.label}
                              </p>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      <input
                        ...
                        className={`w-full px-5 py-4 rounded-[1.25rem] bg-surface-secondary border-2 text-[14px] font-black tracking-[0.15em] uppercase text-center placeholder:text-text-tertiary focus:outline-none transition-all ${
                          isConfirmValid
