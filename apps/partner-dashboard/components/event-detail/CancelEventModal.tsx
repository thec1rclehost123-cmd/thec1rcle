...
const REFUND_POLICIES: {
...
}[] = [
  {
    ...
    label: "Full Refund",
    description:
      "100% refund to all ticket holders. Recommended for organizer-initiated cancellations.",
    icon: DollarSign,
  },
  {
    id: "partial",
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Backdrop */}
          <div className="absolute inset-0 bg-stone-950/85 backdrop-blur-2xl" onClick={onClose} />
                ...
                {(["reason", "policy", "confirm"] as const).map((s, i) => (
                  <div
                    ...
                    className={`flex-1 h-1 rounded-full transition-all duration-500 ${
                      i <= ["reason", "policy", "confirm"].indexOf(step)
                        ? "bg-rose-500"
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      {CANCELLATION_REASONS.map((r) => (
                        <button
                          ...
                          className={`flex items-center gap-3 p-3.5 rounded-[1.25rem] border-2 text-left transition-all duration-200 ${
                            selectedReason === r.id
                        ...
                        >
                          ...
                          <span
                            className={`text-[11px] font-bold ${selectedReason === r.id ? "text-rose-500" : "text-[var(--text-secondary)]"}`}
                          >
                            {r.label}
                          </span>
                        </button>
                      ...
                      {REFUND_POLICIES.map((policy) => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full flex items-start gap-4 p-5 rounded-[1.5rem] border-2 text-left transition-all duration-200 ${
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <p
                                className={`text-[12px] font-bold ${refundPolicy === policy.id ? "text-rose-500" : "text-[var(--text-primary)]"}`}
                              >
                                {policy.label}
                              </p>
                      ...
                      >
                        <div className="p-5 rounded-[1.5rem] bg-[var(--surface-secondary)] border border-[var(--border-subtle)] space-y-3">
                          ...
                          <div className="flex justify-between text-[9px] font-bold text-[var(--text-tertiary)]">
                            ...
                            <span>
                              Est. refund: ₹
                              {Math.round((totalRevenue * partialPercent) / 100).toLocaleString(
                                "en-IN",
                              )}
                            </span>
                            <span>90%</span>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <p className="text-[12px] text-[var(--text-secondary)] leading-relaxed">
                        This action is <strong className="text-rose-500">irreversible</strong>. All
                        ticket holders will be notified, QR codes will be invalidated, and promoter
                        links will be deactivated.
                      </p>
                      <p className="text-[11px] font-bold text-[var(--text-primary)]">
                        Type{" "}
                        <span className="text-rose-500 font-black tracking-[0.1em]">
                          {confirmRequired}
                        </span>{" "}
                        to confirm:
                      </p>
                      <input
                        ...
                        className={`w-full px-5 py-4 rounded-[1.25rem] bg-[var(--surface-secondary)] border-2 text-[14px] font-black tracking-[0.15em] uppercase text-center placeholder:text-[var(--text-tertiary)] focus:outline-none transition-all ${
                          isConfirmValid
            ...
            <div className="px-10 py-6 border-t border-[var(--border-subtle)] bg-[var(--surface-secondary)] flex items-center justify-between">
              ...
              {step !== "confirm" ? (
                <button
                  ...
                  className={`px-8 py-3.5 rounded-xl text-[11px] font-black uppercase tracking-[0.15em] transition-all ${
                    canProceedFromReason || step === "policy"
                ...
                <button
                  ...
                  className={`px-8 py-3.5 rounded-xl text-[11px] font-black uppercase tracking-[0.15em] flex items-center gap-2.5 transition-all ${
