            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 relative">
                <div
                  ...
                  style={{
                    width: `${widthPct}%`,
                    background: stage.count === 0 ? 'var(--v-neutral-bg)' : color,
                ...
                >
                  <span
                    ...
                    style={{
                      color: stage.count === 0 ? 'var(--v-text-muted)' : 'rgba(255,255,255,0.9)',
                    }}
                  >
          ...
          <div key={row.label} className="group">
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                ...
                {row.badge && (
                  <span
                    ...
                    style={{
                      background: row.badgeColor ? `${row.badgeColor}22` : 'var(--v-neutral-bg)',
              ...
              <div className="text-right shrink-0 ml-3">
                <span
                  ...
                  style={{
                    color: row.value === 0 ? 'var(--v-text-muted)' : 'var(--v-text-primary)',
                  }}
                >
                  {row.formattedValue ??
                ...
                {row.subValue && (
                  <div className="text-[10px] font-medium" style={{ color: 'var(--v-text-muted)' }}>
                    {row.subValue}
                  </div>
                )}
              </div>
            ...
            >
              <div
                ...
                style={{
                  width: `${widthPct}%`,
                  background: row.value === 0 ? 'var(--v-neutral-bg)' : color,
  ...
  return (
    <div className={cn('space-y-2', className)}>
      {cohorts.map((cohort) => {
        ...
        const color =
          pct >= 60 ? 'var(--v-success)' : pct >= 30 ? 'var(--v-warning)' : 'var(--v-error)';
...
export function ScoreRing({ score, label, size = 64, strokeWidth = 5, className }: ScoreRingProps) {
  ...
  const color =
    score >= 80 ? 'var(--v-success)' : score >= 50 ? 'var(--v-warning)' : 'var(--v-error)';
