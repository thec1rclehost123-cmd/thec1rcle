...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: () => void }) {
  ...
  const typeStyles = {
    success:
      'border-green-500/30 bg-green-500/10 shadow-[0_0_20px_rgba(34,197,94,0.15)] backdrop-blur-xl',
    error:
      'border-orange-500/30 bg-orange-500/10 shadow-[0_0_20px_rgba(249,115,22,0.15)] backdrop-blur-xl',
    warning:
      'border-yellow-500/30 bg-yellow-500/10 shadow-[0_0_20px_rgba(234,179,8,0.15)] backdrop-blur-xl',
...
export default function Toast({
  ...
  return (
    <div
      className={cn(
        'toast flex items-start gap-3 p-4 relative overflow-hidden border rounded-2xl',
        typeStyles[type],
        className,
      )}
    >
