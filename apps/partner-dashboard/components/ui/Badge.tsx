...
const toneStyles: Record<BadgeTone, string> = {
  ...
  accent:
    "bg-[var(--c1rcle-orange-glow)] text-[var(--c1rcle-orange)] border-[var(--c1rcle-orange)]/20",
  neutral:
    "bg-[var(--surface-tertiary)] text-[var(--text-secondary)] border-[var(--border-subtle)]",
};
...
export const BadgeConfirmed = (props: Omit<BadgeProps, "tone">) => (
  <Badge tone="success" {...props} />
);
export const BadgePending = (props: Omit<BadgeProps, "tone">) => (
