                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-2">
                            <p className="text-[10px] text-text-secondary uppercase tracking-[0.2em] font-bold">Sales Account</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="space-y-1">
                            {section.items.map((item) => (
                                ...
                                >
                                    ...
                                    {isActive(item.href) && <div className="h-1 w-1 rounded-full bg-green-500 shadow-[0_0_10px_#10B981]" />}
                                </Link>
                            ))}
                        </div>
                    </div>
            ...
            <div className="p-6 border-t border-black/[0.05]">
                <div className="mb-6 px-2">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-sm font-medium text-text-primary truncate">{profile?.displayName || "Promoter"}</p>
                    </div>
                </div>
                <button
                    onClick={() => signOut()}
