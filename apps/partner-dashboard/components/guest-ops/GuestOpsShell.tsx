                    ...
                    {kpis && !isLoading ? (
                        compactMode ? (
                            ...
                            <div className="flex items-center gap-3 flex-wrap flex-1">
                                <KPIBadge icon={<Users size={13} className="text-slate-400" />}       label="Expected"   value={kpis.totalExpected} />
                                <KPIBadge icon={<CheckCircle2 size={13} className="text-green-500" />} label="In"         value={kpis.checkedIn} emphasis />
                                <KPIBadge icon={<XCircle size={13} className="text-red-400" />}        label="Denied"     value={kpis.denied} />
