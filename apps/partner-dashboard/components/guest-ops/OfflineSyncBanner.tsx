                ...
                {hasQueue && (
                    <>
                        ...
                        <span className="flex items-center gap-1 text-amber-400">
                            ...
                            {syncState.queuedCount} check-in{syncState.queuedCount !== 1 ? "s" : ""} pending upload
                        </span>
                    </>
                )}
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-amber-400/80 mt-0.5">
                                    Guestlist is read from local cache.
                                    Check-ins will be queued and uploaded automatically when you reconnect.
                                </p>
                            </div>
                        </div>
                    </motion.div>
