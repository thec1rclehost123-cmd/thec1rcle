...
const VENUE_ROLE_OPTIONS: Array<{ value: EditableVenueRole; label: string; description: string }> = [
    {
        value: "MANAGER",
        label: "Manager",
        description: "Best for day-to-day operators handling events, guests, and live floor decisions.",
    },
    {
        value: "FINANCE_ADMIN",
        label: "Finance",
        description: "Best for trusted finance support who need money visibility without running the floor.",
    },
    {
        value: "SECURITY",
        label: "Security",
...
export function EditPermissionsModal(props: EditPermissionsModalProps) {
    ...
    const hostInitialRole: EditableHostRole =
        props.partnerType === "host" && props.currentRole !== "OWNER"
            ? props.currentRole
            : "MANAGER";
