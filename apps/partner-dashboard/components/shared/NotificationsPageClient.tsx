...
export function NotificationsPageClient({ apiPath, typeColors, emptyHint }: NotificationsPageClientProps) {
    ...
    const dotColor = (type?: string) => typeColors[type?.toLowerCase() ?? ""] ?? "#6b7280";
        ...
        >
            {loading ? (
                ...
                <div className="flex flex-col items-center gap-3 py-24 text-center">
                    ...
                    <p className="text-text-placeholder text-xs">{emptyHint}</p>
                </div>
            ) : (
