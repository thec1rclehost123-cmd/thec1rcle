                ...
                <div key={item.href}>
                  ...
                  <div className="relative">
                    <Link
                      ...
                      className={`nav-item relative group w-full ${
                        active || isChildActive ? "nav-item-active" : ""
                      }`}
                    >
                      {/* Active Indicator */}
                          ...
                          {item.children?.map((child) => {
                            ...
                            return (
                              <Link
                                key={child.href}
                                href={child.href}
                                className={`block px-4 py-2.5 rounded-lg text-[13px] font-medium transition-all ${
                                  childActive
