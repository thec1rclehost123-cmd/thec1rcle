    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="px-8 pb-8">
          ...
          {error ? (
            <div
              className="mb-4 flex items-center gap-2 rounded-[18px] px-4 py-3 text-[13px]"
            ...
            {methodType === 'bank_account' ? (
              <>
                <ModalInput
                  ...
                  onChange={(value) =>
                    setBankForm((prev) => ({ ...prev, accountHolderName: value }))
                  }
                />
                <ModalInput
                ...
                <ModalInput
                  ...
                  onChange={(value) =>
                    setBankForm((prev) => ({ ...prev, ifscCode: value.toUpperCase() }))
                  }
                />
                <ModalInput
              ...
              <>
                ...
                <ModalInput
                  ...
                  onChange={(value) =>
                    setCardForm((prev) => ({ ...prev, cardNumber: value.replace(/\D/g, '') }))
                  }
                />
