    ...
    return (
        <div className={cn(className)} style={{ position: "relative", overflow: "hidden", borderRadius: "1.5rem" }}>
            ...
            <div style={{
                ...
                background: "radial-gradient(ellipse at 55% -15%, rgba(244,74,34,0.20) 0%, transparent 60%)",
            }} />
            ...
            <div style={{
                ...
                <div className="flex items-start justify-between flex-wrap gap-4 mb-5">
                    <div>
                        <p style={{ fontSize: 10, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.14em", color: "rgba(244,74,34,0.8)", marginBottom: 6 }}>
                            Cashflow
                        </p>
                        <p className="tabular-nums" style={{ fontSize: 36, fontWeight: 700, color: "#fff", letterSpacing: "-0.025em", lineHeight: 1 }}>
                    ...
                    <div className="flex flex-col items-end gap-3">
                        {/* Time range picker */}
                        {showTimeRangePicker && (
                            <div className="flex items-center gap-0.5 p-0.5 rounded-xl" style={{ background: "rgba(255,255,255,0.06)" }}>
                                {TIME_RANGES.map((r) => (
                                    <button
                                        key={r.value}
                                        ...
                                        style={{
                                            ...
                                            border: activeRange === r.value ? "1px solid rgba(244,74,34,0.3)" : "1px solid transparent",
                                        }}
                                    >
                                        {r.label}
                                    </button>
                ...
                {loading ? (
                    ...
                    <div
                        ...
                        style={{ height, background: "rgba(255,255,255,0.03)", border: "1px dashed rgba(255,255,255,0.08)" }}
                    >
                        <span className="text-[11px] font-semibold uppercase tracking-widest" style={{ color: "rgba(255,255,255,0.28)" }}>
