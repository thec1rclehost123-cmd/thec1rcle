...
import { HelpCircle, Pencil, Plus, RefreshCw, CheckCircle2, Clock, XCircle, ArrowDownLeft, Minus, Wallet2 } from "lucide-react";
...
const statusToneMap: Record<NonNullable<FinancePayoutRow["statusTone"]>, { bg: string; color: string; border: string }> = {
    ...
    neutral: { bg: "rgba(255,255,255,0.04)", color: "var(--v-text-secondary)", border: "var(--v-border)" },
};
    ...
    return (
        ...
        >
            <div className="mb-6 flex items-center justify-between gap-3">
                <p className="text-[11px] font-black uppercase tracking-[0.26em]" style={{ color: "rgba(255,255,255,0.42)" }}>
                    {title}
                </p>
                {actions}
            </div>
                            ...
                            <div className="relative mt-6 grid gap-3">
                                {balanceRows.slice(1).map((row) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-[15px] font-semibold tabular-nums" style={{ color: "#fff" }}>
                                            {row.value}
                                        </span>
                                    </div>
                                ))}
                            ...
                            <div className="space-y-3.5">
                                {balanceRows.map((row) => (
                                    <div key={row.label} className="flex items-center justify-between gap-3">
                                        ...
                                        <span className="text-[15px] font-semibold tabular-nums" style={{ color: "rgba(255,255,255,0.92)" }}>
                                            {row.value}
                                        </span>
                                    </div>
                                ))}
                    ...
                    <div className="space-y-5">
                        {settingsRows.map((row) => (
                            <div key={row.label} className="flex items-center justify-between gap-5">
                                ...
                                <div className="min-w-0 text-right text-[14px] font-medium" style={{ color: "rgba(255,255,255,0.92)" }}>
                                    {row.value}
                                </div>
                            </div>
                        ))}
                        ...
                        <div className="flex items-center gap-2">
                            {onEditBanks ? (
                                <button
                                    ...
                                    style={{ border: "1px solid rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.46)" }}
                                >
                                    <Pencil size={14} />
                                </button>
                            ) : null}
                                ...
                                >
                                    ...
                                    {account.badge ? (
                                        <span
                                            ...
                                            style={{ background: "rgba(255,255,255,0.05)", color: "rgba(255,255,255,0.52)" }}
                                        >
                                            {account.badge}
                                        </span>
                                    ) : null}
            ...
            >
                ...
                {payoutsLoading ? (
                    ...
                    <div className="flex min-h-[620px] flex-col items-center justify-center px-8 text-center">
                        ...
                        <p className="mt-2 max-w-[420px] text-[18px]" style={{ color: "rgba(255,255,255,0.28)" }}>
                    ...
                    <>
                        <div className="px-5 py-5 space-y-3">
                            {payouts.map((payout) => {
                                ...
                                const StatusIcon =
                                    payout.statusTone === "success" ? CheckCircle2 :
                                    payout.statusTone === "warning" ? Clock :
                                    payout.statusTone === "danger"  ? XCircle :
                                    payout.statusTone === "info"    ? ArrowDownLeft :
                                    Minus;
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                {subtitle ? (
                                                    <p className="mt-1 truncate text-[13px]" style={{ color: "rgba(255,255,255,0.72)" }}>
                                                        {subtitle}
                                                    </p>
                                                ) : null}
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div style={{ textAlign: "right", flexShrink: 0 }}>
                                            <p className="tabular-nums" style={{ fontSize: 15, fontWeight: 700, color: tone.color, letterSpacing: "-0.01em" }}>
                                                {payout.amount}
                                            </p>
                                            <span style={{
