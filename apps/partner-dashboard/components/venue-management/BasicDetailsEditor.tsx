        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--text-tertiary)]">
              Square image, displayed on banner overlay
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        {multiline ? (
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 bg-[var(--surface-secondary)] border border-[var(--border-subtle)] rounded-xl text-sm resize-none focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
          />
        ) : (
          <input
            type="text"
            ...
            onBlur={handleBlur}
            placeholder={placeholder}
            className={`w-full px-4 py-3 bg-[var(--surface-secondary)] border border-[var(--border-subtle)] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 ${icon ? "pl-10" : ""}`}
          />
        )}
      </div>
    </div>
