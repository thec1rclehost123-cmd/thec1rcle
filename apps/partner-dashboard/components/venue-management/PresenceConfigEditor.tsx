    ...
    <div className="space-y-5 max-w-2xl">
      ...
      {error && (
        <div
          ...
          style={{ background: 'var(--v-error-bg)', border: '1px solid rgba(248,113,113,0.2)' }}
        >
          <AlertCircle size={16} style={{ color: 'var(--v-error)' }} />
          <p className="text-sm flex-1" style={{ color: 'var(--v-error)' }}>
            {error}
          </p>
              ...
              >
                {url ? (
                  ...
                  >
                    ...
                    <span className="text-[10px]" style={{ color: 'var(--v-text-tertiary)' }}>
                      {idx + 1}
                    </span>
                  </button>
                )}
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          >
            <span
              ...
              style={{
                transform: config.bookingConfig.enabled ? 'translateX(24px)' : 'translateX(2px)',
              }}
            />
          </button>
        </div>
