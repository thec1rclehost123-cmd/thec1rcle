...
export default function LivePreviewEditor({
  ...
  return (
    <div className="space-y-8">
      ...
      <div
        className={`relative bg-[#0A0A0A] rounded-3xl overflow-hidden border border-white/10 shadow-2xl transition-all ${isEditing ? "ring-2 ring-emerald-500/50" : ""}`}
      >
          ...
          <div className="relative aspect-[16/10] w-full overflow-hidden group">
            ...
            {isEditing && (
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="px-6 py-3 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 text-white text-xs font-bold uppercase tracking-widest flex items-center gap-2">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-30 px-6 pb-6 pointer-events-none">
              <div className="flex items-end gap-4">
                <div
                  ...
                  className="relative w-20 h-20 rounded-2xl overflow-hidden border-4 border-[#0A0A0A] shadow-2xl cursor-pointer group pointer-events-auto bg-slate-800"
                >
                  {logo ? (
                    <img
                      src={logo}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2">
                    {isEditing ? (
                      <input
                        ...
                        className="px-3 py-1 bg-white/10 border border-white/20 rounded-full text-[10px] font-black uppercase tracking-widest text-white w-24 text-center pointer-events-auto"
                      />
                    ) : (
                      <span className="px-3 py-1 bg-white/10 border border-white/10 rounded-full text-[10px] font-black uppercase tracking-widest text-white/80">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="text-3xl font-black uppercase tracking-tighter text-white bg-transparent border-b-2 border-white/30 focus:border-white outline-none w-full pointer-events-auto"
                    />
                  ) : (
                    <h1 className="text-3xl font-black uppercase tracking-tighter text-white leading-[0.9] drop-shadow-lg">
                      {venue.name}
                    </h1>
                  )}
                </div>
          ...
          <div className="flex items-center gap-2 text-white/60">
            ...
            {isEditing ? (
              <input
                ...
                placeholder="City"
                className="text-sm font-bold bg-transparent border-b border-white/30 text-white/60 w-32 focus:outline-none"
              />
            ) : (
        ...
        <div className="px-6 py-6 border-b border-white/10">
          ...
          {isEditing ? (
            <textarea
              ...
              rows={3}
              className="w-full p-4 bg-white/5 border border-white/10 rounded-xl text-white text-sm resize-none focus:outline-none focus:border-white/30"
            />
          ) : (
