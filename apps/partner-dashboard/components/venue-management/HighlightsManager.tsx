  ...
  const handleUploadImage = async (highlightId: string, file: File) => {
    ...
    try {
      ...
      const storageRef = ref(
        storage,
        `venues/${venueId}/highlights/${highlightId}/${Date.now()}_${file.name}`,
      );
            ...
            >
              ...
              <div className="flex items-center gap-4 p-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  />
                  <p className="text-xs text-text-tertiary">{highlight.images.length} / 9 images</p>
                </div>
                  ...
                  >
                    <div className="p-4 space-y-4">
                      ...
                      <p className="text-xs text-text-tertiary">
                        💡 Tip: Images will auto-advance like Instagram stories when users tap the
                        highlight
                      </p>
                    </div>
                  </motion.div>
          ...
          >
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-center">
              ...
              <p className="text-text-primary/60 text-sm">
                {previewIndex + 1} / {previewHighlight.images.length}
              </p>
            </div>
          </motion.div>
        )}
