            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  {/* Code */}
                  <div className="font-mono text-xl font-bold text-white">{code.code}</div>
              ...
              {code.stats && !code.isRevoked && (
                <div className="flex items-center gap-6 mt-3 pt-3 border-t border-slate-700/50">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-slate-400">{code.stats.scansCount} scans</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 rounded-2xl p-6 w-full max-w-md border border-slate-700">
            <h3 className="text-xl font-semibold text-white mb-4">Generate Scanner Code</h3>
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="text-xs text-slate-400 mt-1">Scan tickets + Door entry</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-xs text-slate-400 mt-1">Ticket scanning only</div>
                </button>
              </div>
            </div>
            ...
            {/* Gate Name */}
            <div className="mb-6">
              <label className="block text-sm text-slate-400 mb-2">Gate/Zone Name (optional)</label>
              <input
                type="text"
                value={newCodeGate}
