        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    className="relative z-10 w-full max-w-md rounded-2xl border border-[var(--border-default)] bg-[var(--bg-fill)] dark:bg-[#111] p-6 shadow-2xl"
                >
                    <button
                        onClick={onClose}
                        className="absolute top-4 right-4 rounded-lg p-1.5 text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-secondary)]"
                    >
                        <X className="h-4 w-4" />
                    </button>
                    ...
                    {!done ? (
                        <>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[var(--text-tertiary)] truncate max-w-[260px]">{eventTitle}</p>
                                </div>
                            </div>

                            <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-fill)] p-4 mb-5 space-y-2">
                                <p className="text-xs font-medium text-[var(--text-secondary)]">What gets copied</p>
                                ...
                                <p className="text-xs font-medium text-[var(--text-secondary)] mt-3">What resets</p>
                                <ul className="space-y-1 text-xs text-[var(--text-tertiary)]">
                                    <li>✗ Status → Draft</li>
                            ...
                            <div className="flex gap-3">
                                ...
                                <Button
                                    className="flex-1 bg-[var(--bg-secondary)] text-[var(--text-primary)] border border-[var(--border-default)] hover:bg-[var(--bg-elevated)]"
                        ...
                        <div className="text-center py-4">
                            ...
                            <h2 className="text-base font-semibold text-[var(--text-primary)] mb-1">Draft created</h2>
