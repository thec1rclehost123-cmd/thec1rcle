            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-3xl border border-slate-100">
                ...
                <div className="text-2xl font-black text-slate-900">
                  {analytics.total_demand || 0} sessions
                </div>
              </div>
              <div className="bg-white p-6 rounded-3xl border border-slate-100">
                <span className="text-[8px] font-black uppercase tracking-widest text-slate-400 block mb-1">
                ...
                <div className="text-2xl font-black text-slate-900">
                  {analytics.conversion_stats.admitted > 0
                    ? Math.round(
                        (analytics.conversion_stats.consumed /
                          analytics.conversion_stats.admitted) *
                          100,
                      )
                    : 0}
                  %
              ...
              <div className="bg-white p-6 rounded-3xl border border-slate-100">
                ...
                <div className="text-2xl font-black text-slate-900">
                  {analytics.conversion_stats.admitted -
                    analytics.conversion_stats.abandoned_pre_reserve}
                  <span className="text-[10px] text-slate-300 ml-1">
                    v. {analytics.conversion_stats.admitted}
                  </span>
                </div>
              </div>
              <div className="bg-white p-6 rounded-3xl border border-slate-100">
                ...
                <div className="text-2xl font-black text-rose-500">
                  {analytics.conversion_stats.payment_failed +
                    analytics.conversion_stats.abandoned_pre_reserve}
                </div>
              </div>
            </div>
        ...
        {isSurging && (
          <div className="mt-8 flex items-center gap-4 px-6 py-4 bg-rose-600 text-white rounded-2xl animate-in slide-in-from-bottom-2 duration-500">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest">
              Lane Model Admission Active: Prioritizing Loyal & Authenticated cohorts to mitigate
              bot impact.
            </p>
          </div>
        )}
