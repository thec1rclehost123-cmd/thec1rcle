        ...
        <div className="flex flex-col gap-6">
          <div className="bg-surface-elevated rounded-2xl border border-border-subtle p-6 flex flex-col items-center text-center">
            ...
            <h2 className="text-xl font-bold text-text-primary mb-1">
              {formData.displayName || 'Unknown'}
            </h2>
            <p className="text-sm font-mono text-emerald-500 bg-emerald-500/10 px-2 py-0.5 rounded-md border border-emerald-500/20">
              @{formData.handle || 'unknown'}
            </p>
          </div>
            ...
            <label className="flex items-center justify-between p-4 border border-border-subtle rounded-xl bg-surface-base cursor-pointer hover:border-emerald-500/50 transition-colors">
              <div className="flex flex-col max-w-[200px]">
                ...
                <span className="text-xs text-text-secondary mt-1">
                  {formData.isPublic
                    ? 'Visible on your custom promoter landing page.'
                    : 'Hidden from public view.'}
                </span>
              </div>
              <div
                className={`w-11 h-6 rounded-full transition-colors relative flex items-center ${formData.isPublic ? 'bg-emerald-500' : 'bg-surface-tertiary'}`}
              >
                <div
                  className={`w-4 h-4 bg-white rounded-full mx-1 transition-transform ${formData.isPublic ? 'translate-x-5' : 'translate-x-0'}`}
                />
                {isEditing && (
                  <input
                    type="checkbox"
            ...
            <div className="flex flex-col gap-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="flex flex-col gap-2">
                  ...
                  {isEditing ? (
                    ...
                    <div className="w-full bg-surface-base border border-transparent rounded-lg px-3 py-2 text-sm text-text-primary font-medium">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {isEditing ? (
                    <div className="flex items-center w-full bg-surface-base border border-border-subtle rounded-lg overflow-hidden focus-within:border-emerald-500 transition-colors">
                      <span className="pl-3 pr-1 text-text-muted text-sm border-r border-border-subtle py-2 bg-surface-tertiary">
                        @
                      </span>
                      <input
                        type="text"
              ...
              <div className="flex flex-col gap-2">
                ...
                {isEditing ? (
                  ...
                  <div className="w-full bg-surface-base border border-transparent rounded-lg px-3 py-2 text-sm text-text-primary leading-relaxed">
                    {formData.bio}
                  </div>
                )}
              </div>
