...
export default function GenerateLinkModal({
  ...
  const promoterEnabledTiers = (selectedEvent?.tickets || []).filter(
    (tier: any) => tier.promoterEnabled !== false,
  );
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black text-white tracking-tight">New Link</h2>
          ...
          {!generatedLink ? (
            ...
            >
                ...
                <div className="mt-4">
                  ...
                  <div className="space-y-2 max-h-40 overflow-y-auto pr-1 custom-scrollbar">
                    {promoterEnabledTiers.map((tier: any) => (
                      <label
                        key={tier.id}
                        className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.06] cursor-pointer transition-colors"
                      >
                        <div
                          className={`w-4 h-4 rounded flex items-center justify-center border transition-colors ${selectedTicketTierIds.includes(tier.id) ? 'bg-emerald-500 border-emerald-500' : 'border-white/20 bg-black/50'}`}
                        >
                  ...
                  <p className="text-[11px] text-text-tertiary mt-2 ml-1">
                    Select the tickets this link applies to. Leave blank to apply to all enabled
                    tickets.
                  </p>
                </div>
              )}
              ...
              <div className="mt-4">
                ...
                {customTrackingCodeError ? (
                  ...
                  <p className="text-[11px] text-text-tertiary mt-2 ml-1">
                    If you don't have a code yet, enter your desired permanent code. Leave blank to
                    auto-generate.
                  </p>
                )}
              </div>
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.color = 'var(--v-text-primary, #fafafa)')
                }
                onMouseLeave={(e) =>
