...
import { X, Link2, Copy, CheckCircle2, PencilLine, ChevronDown, Loader2 } from 'lucide-react';
            ...
            >
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {!lockEvent ? (
                      <ChevronDown
                        size={14}
                        style={{ color: 'var(--v-text-tertiary, #a1a1aa)', flexShrink: 0 }}
                      />
                    ) : null}
                  </button>
                      ...
                      {events.length === 0 ? (
                        ...
                        events.map((event) => (
                          <button
                            ...
                            onMouseEnter={(e) =>
                              (e.currentTarget.style.background = 'var(--v-elevated, #222226)')
                            }
                            onMouseLeave={(e) =>
              ...
              <div>
                ...
                {campaignLabel && (
                  ...
                  >
                    Saved as:{' '}
                    <span style={{ color: '#a78bfa' }}>{sanitizeLabel(campaignLabel)}</span>
                  </p>
                )}
              </div>
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: isSelected
                              ...
                              : '1px solid var(--v-border, rgba(255,255,255,0.08))',
                            color:
                              isSelected || targetingAll
                                ? 'var(--v-text-primary, #fafafa)'
                                : 'var(--v-text-secondary, #d1d1d6)',
                          }}
                        >
                          <span>{tier.name}</span>
