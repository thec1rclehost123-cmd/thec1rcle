...
export function PayoutConfig({ payout, promoterId, token, onUpdated }: Props) {
    ...
    const accountNumberChanged = form.accountNumber !== originalAccountNumber && originalAccountNumber !== "";
    ...
    const handleReAuth = async () => {
        ...
        try {
            ...
            setError(e.code === "auth/wrong-password" ? "Incorrect password." : "Re-authentication failed.");
        } finally {
                ...
                <div className="flex items-start gap-2 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] text-amber-400/70 mt-0.5">
                            Payouts are paused until {new Date(holdUntil!).toLocaleString("en-IN")} following
                            your account number change.
                        </p>
                    </div>
                </div>
            )}
