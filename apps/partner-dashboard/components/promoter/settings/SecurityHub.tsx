  ...
  const handleToggle2FA = async (enable: boolean) => {
    ...
    try {
      const res = await fetch('/api/partners/promoters/settings/notifications', {
        ...
        body: JSON.stringify({
          promoterId,
          security: { twoFaEnabled: false, twoFaFlaggedAt: null },
        }),
      });
          ...
          <div className="bg-[#0f0f14] border border-white/10 rounded-[2rem] p-8 w-full max-w-sm mx-4 space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-white/40 mt-2 leading-relaxed">
                Full TOTP enrollment is coming soon. By confirming, your account will be flagged for
                2FA setup and our support team will reach out to complete the configuration.
              </p>
            </div>
