    ...
    >
      ...
      <div
        style={{
          ...
          fontSize: 11,
          fontWeight: 900,
          color: isFirst ? '#fff' : 'rgba(255,255,255,0.45)',
        }}
      >
        {rank}
      </div>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 2 }}>
          ...
          >
            {copied ? (
              <Check className="w-3 h-3" style={{ color: isFirst ? '#fff' : '#22c55e' }} />
            ) : (
              <Copy className="w-3 h-3" style={{ color: subColor }} />
            )}
          </button>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexShrink: 0 }}>
        <div style={{ textAlign: 'center' }}>
          <p className="tabular-nums" style={{ fontSize: 14, fontWeight: 800, color: textColor }}>
            {(link.clicks || 0).toLocaleString('en-IN')}
          </p>
          <p
            style={{
              fontSize: 9,
        ...
        <div style={{ textAlign: 'center' }}>
          <p className="tabular-nums" style={{ fontSize: 14, fontWeight: 800, color: textColor }}>
            {(link.sales || 0).toLocaleString('en-IN')}
          </p>
          <p
            style={{
              fontSize: 9,
        ...
        <div style={{ textAlign: 'right' }}>
          <p className="tabular-nums" style={{ fontSize: 14, fontWeight: 800, color: convColor }}>
            {link.conversion || '0.0%'} ✦
          </p>
          <p
            style={{
