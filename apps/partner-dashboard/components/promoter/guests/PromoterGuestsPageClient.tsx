                        ...
                        <div className="flex-1">
                             ...
                             <div className="flex items-center gap-4 mt-3">
                                 ...
                                 <div className="whitespace-nowrap text-sm font-bold font-mono text-text-primary">
                                     {data.totalUsed} <span className="text-text-tertiary">/ {data.totalAllowance} SPOTS</span>
                                 </div>
                             </div>
                        </div>
                    </div>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="flex flex-col">
                                                        <span className="font-semibold text-text-primary tracking-tight">{guest.name}</span>
