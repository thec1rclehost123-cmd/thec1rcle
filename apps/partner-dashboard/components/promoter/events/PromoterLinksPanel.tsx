    ...
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center mb-2">
        <div>
          ...
          <p className="text-sm text-text-secondary">
            Manage and create unique referral URIs for your marketing channels.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {links.map((link) => (
          <div
            key={link.id}
            className="bg-surface-elevated border border-border-subtle rounded-2xl p-5 hover:border-border-active transition-colors group flex flex-col items-start h-full"
          >
            <div className="w-full flex justify-between items-start mb-4">
              <div className="flex flex-col">
                <span className="font-bold text-lg text-text-primary tracking-tight leading-tight mb-1">
                  {link.name}
                </span>
