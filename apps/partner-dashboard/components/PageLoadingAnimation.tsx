            ...
            {isLoading && (
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center">
                        ...
                        {/* Progress Bar */}
                        <div className="w-64 h-1 bg-[var(--bg-elevated)]/10 rounded-full mt-8 overflow-hidden relative">
                            <motion.div
                        ...
                        <div className="flex justify-between w-64 mt-2 text-[9px] font-mono text-[var(--text-primary)]/40">
