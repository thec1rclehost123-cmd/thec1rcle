          ...
          {onboardingStatus === 'changes_requested' ? (
            <>
              ...
              <p className="text-text-tertiary font-medium leading-relaxed mb-8">
                The administration has requested some updates to your onboarding profile. Please
            ...
            <>
              ...
              <p className="text-text-tertiary font-medium leading-relaxed mb-8">
                Unfortunately, your application for dashboard access has been rejected. Contact
            ...
            <>
              ...
              <p className="text-text-tertiary font-medium leading-relaxed mb-8">
                Your onboarding request is currently being processed by our compliance team. You
                will receive an automated alert once access is provisioned.
              </p>
            </>
          )}
          ...
          <div className="p-6 rounded-2xl bg-surface-tertiary border border-border-subtle flex items-center gap-4 text-left mb-10">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-text-tertiary">
              ...
              <span className="text-text-primary">
                {onboardingStatus?.replace('_', ' ') || 'Queued'}
              </span>
            </p>
          </div>
