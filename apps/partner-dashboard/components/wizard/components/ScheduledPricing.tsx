...
import { Clock, Calendar, Plus, X, ChevronDown, ChevronUp, Sparkles, Zap } from "lucide-react";
...
export function ScheduledPricing({
  ...
  const updateSchedule = (id: string, updates: Partial<ScheduledPrice>) => {
    onChange(scheduledPrices.map((s) => (s.id === id ? { ...s, ...updates } : s)));
  };
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <p className="text-[13px] font-semibold text-[#1d1d1f]">Scheduled Pricing</p>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1 relative">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateSchedule(schedule.id, { price: parseInt(e.target.value) || 0 })
                        }
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-2 rounded-lg bg-[#f5f5f7]/50 border border-[rgba(0,0,0,0.04)]">
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-1.5 h-1.5 rounded-full ${schedule.quantityLimit ? "bg-[#007aff]" : "bg-[#86868b]/30"}`}
                        />
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-[9px] text-[#86868b] font-medium uppercase tracking-tight">
                          Tickets
                        </span>
                      </div>
                    </div>
