...
export function PromoCodeManager({
  ...
  const toggleCodeActive = (id: string) => {
    onChange(promoCodes.map((c) => (c.id === id ? { ...c, isActive: !c.isActive } : c)));
  };
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <p className="text-[13px] font-semibold text-[#1d1d1f]">Promo Codes</p>
            ...
            {promoCodes.map((code) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 mt-2 text-[11px] text-[#86868b]">
                  ...
                  {code.maxPerUser && <span>1 per user</span>}
            ...
            {showAddForm ? (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    <label className="text-[10px] text-[#86868b] uppercase font-medium">
                      Discount Type
                    </label>
                    <select
