    ...
    return (
        <button
            ...
            className={`relative flex-shrink-0 w-[130px] p-4 rounded-[1.5rem] border-2 transition-all duration-300 text-left group ${isSelected
                ...
                : "border-[var(--border-subtle)] bg-[var(--bg-base)] hover:border-indigo-500/30 hover:bg-[var(--bg-elevated)]"
                }`}
        >
    ...
    return (
        <div className="space-y-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex p-1 rounded-[1.25rem] bg-[var(--bg-fill)] border border-[var(--border-subtle)] w-fit relative">
                    <div className="relative flex">
                        ...
                        <button
                            ...
                            className={`relative px-6 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-[0.1em] transition-colors duration-200 z-10 w-[140px] ${uploadMode === "manual" ? "text-white" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)]"
                                }`}
                        >
                            Standard
                        </button>
                        <button
                            ...
                            className={`relative px-6 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-[0.1em] transition-colors duration-200 z-10 w-[140px] flex items-center justify-center gap-2 ${uploadMode === "ai" ? "text-white" : "text-[var(--text-tertiary)] hover:text-[var(--text-primary)]"
                                }`}
                        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <AnimatePresence mode="wait">
                        {uploadMode === "manual" ? (
                            <motion.div
                                ...
                                className="aspect-[4/5] rounded-[3rem] border-2 border-dashed border-[var(--border-default)] bg-[var(--bg-fill)] flex flex-col items-center justify-center text-center transition-all hover:border-indigo-500/30 hover:bg-indigo-500/5 group cursor-pointer relative overflow-hidden"
                            >
                                <input
                                    type="file"
                                    accept="image/*"
                                ...
                                <div className="w-24 h-24 rounded-[2.5rem] bg-[var(--bg-base)] flex items-center justify-center mb-8 shadow-2xl shadow-black/5 group-hover:scale-110 transition-transform duration-700 ease-out border border-[var(--border-subtle)]">
                                ...
                                <div className="mt-12 px-10 py-3.5 bg-text-primary rounded-2xl text-[11px] font-black text-white uppercase tracking-[0.2em] shadow-xl shadow-black/10 group-hover:bg-indigo-600 transition-all duration-300">
                                    Mount Asset
                                </div>
                            </motion.div>
                        ) : (
                            <motion.div
                                ...
                                animate={{ opacity: 1, scale: 1 }}
                                exit={{ opacity: 0, scale: 0.98 }}
                                className="rounded-[3rem] bg-[var(--bg-fill)] border border-[var(--border-subtle)] p-8 flex flex-col space-y-8"
                            >
                                {/* AI Header */}
                                <div className="flex items-center gap-5">
                                    <div className="w-14 h-14 rounded-[1.25rem] bg-indigo-600 text-[var(--text-primary)] flex items-center justify-center shadow-2xl shadow-indigo-500/20 ring-8 ring-indigo-500/5">
                                ...
                                <div className="p-4 rounded-[1.25rem] bg-[var(--bg-base)] border border-[var(--border-subtle)] shadow-sm relative overflow-hidden">
                                        ...
                                        {MOOD_OPTIONS.map((mood) => (
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-xl text-[11px] font-bold transition-all duration-200 flex items-center gap-1.5 ${selectedMood === mood.id
                                                    ...
                                                    : "bg-[var(--bg-base)] text-[var(--text-secondary)] border border-[var(--border-subtle)] hover:border-indigo-500/20"
                                                    }`}
                                            >
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between px-1">
                                        ...
                                        <div className="group relative">
                                            ...
                                            <div className="absolute bottom-full right-0 mb-4 w-72 p-4 bg-[var(--bg-elevated)] backdrop-blur-md text-[var(--text-primary)] text-[11px] rounded-[1.25rem] opacity-0 group-hover:opacity-100 transition-all pointer-events-none z-20 shadow-2xl leading-relaxed border border-[var(--border-default)]">
                                    ...
                                    <div className="relative">
                                        <textarea
                                            ...
                                            className="w-full min-h-[120px] p-5 rounded-[1.5rem] bg-[var(--bg-base)] border border-[var(--border-subtle)] text-body-sm text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:ring-[6px] focus:ring-indigo-500/10 focus:border-indigo-500/20 resize-none transition-all shadow-sm"
                                        />
                                    ...
                                    <AnimatePresence>
                                        {showAdvanced && (
                                            ...
                                            >
                                                        ...
                                                        {ASPECT_RATIO_OPTIONS.map((ar) => (
                                                            <button
                                                                ...
                                                                className={`px-3 py-2 rounded-xl text-[10px] font-bold transition-all ${selectedAspectRatio === ar.id
                                                                    ...
                                                                    : "bg-[var(--bg-base)] text-[var(--text-tertiary)] border border-[var(--border-subtle)]"
                                                                    }`}
                                                            >
                                                ...
                                                <div className="flex items-center justify-between p-4 rounded-[1.25rem] bg-[var(--bg-base)] border border-[var(--border-subtle)]">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-12 h-7 rounded-full transition-all duration-300 relative ${includeTextOnPoster ? "bg-indigo-600 shadow-lg shadow-indigo-500/20" : "bg-[var(--bg-secondary)]"}`}
                                                    >
                                                        <motion.div
                                                            className="absolute top-0.5 left-0.5 w-6 h-6 rounded-full bg-[var(--bg-elevated)] shadow-md"
                                                ...
                                                <div className="flex items-center justify-between p-4 rounded-[1.25rem] bg-[var(--bg-base)] border border-[var(--border-subtle)]">
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={!eventDate}
                                                        className={`w-12 h-7 rounded-full transition-all duration-300 relative ${includeDate && eventDate ? "bg-indigo-600 shadow-lg shadow-indigo-500/20" : "bg-[var(--bg-secondary)]"
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full px-4 py-3 rounded-xl bg-[var(--bg-base)] border border-[var(--border-subtle)] text-[12px] text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500/20"
                                                    />
                                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <button
                                        ...
                                        className={`btn w-full py-5 text-[12px] font-black uppercase tracking-[0.25em] flex items-center justify-center gap-3 transition-all duration-500 scale-100 active:scale-95 ${isGenerating
                                            ? "bg-text-primary text-white opacity-90 cursor-wait"
                                            : generationState === "success"
                                                ? "bg-emerald-600 text-[var(--text-primary)] shadow-2xl shadow-emerald-500/20"
                                                : canGenerate
                                                    ? "btn-primary shadow-2xl shadow-indigo-500/20"
                                                    : "bg-[var(--bg-secondary)] text-[var(--text-tertiary)] cursor-not-allowed border-[var(--border-subtle)]"
                                            }`}
                                    >
                                        {isGenerating ? (
                                            <>
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between px-1">
                        ...
                        {selectedImage && (
                            <div className="px-3 py-1 rounded-full bg-[var(--bg-secondary)] text-[10px] font-black uppercase tracking-widest text-[var(--text-tertiary)] flex items-center gap-2">
                                <div className="w-1.5 h-1.5 rounded-full bg-green-500" /> Active
                            </div>
                        )}
                    </div>

                    <div className="aspect-[4/5] rounded-[3.5rem] bg-[var(--bg-fill)] border border-[var(--border-subtle)] overflow-hidden relative group shadow-2xl shadow-black/5 transition-all duration-700 hover:shadow-indigo-500/10">
                        {selectedImage ? (
                            <>
                                <img
                                    src={selectedImage}
                                ...
                                <div className="absolute inset-0 bg-[var(--bg-fill)]/40 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col items-center justify-center gap-5">
                                    <label className="bg-[var(--bg-elevated)] text-[var(--text-primary)] px-10 py-3.5 rounded-2xl text-[11px] font-black uppercase tracking-[0.15em] cursor-pointer shadow-2xl hover:scale-105 transition-transform active:scale-95 duration-300">
                                        Swap Master
                                        <input
                                            type="file"
                                            accept="image/*"
                                    ...
                                    <button
                                        ...
                                        className="bg-rose-600/90 text-[var(--text-primary)] px-8 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-[0.15em] shadow-xl hover:bg-rose-600 transition-all duration-300"
                                    >
                                        Drop Asset
                                    </button>
                                </div>
                                ...
                                {/* Status Indicators */}
                                <div className="absolute top-8 right-8 w-14 h-14 rounded-[1.75rem] bg-green-500 text-[var(--text-primary)] flex items-center justify-center shadow-2xl ring-[6px] ring-white/20 backdrop-blur-md">
                                    <Check className="w-7 h-7" />
                                </div>

                                {currentGenerationId && (
                                    <div className="absolute top-8 left-8 px-5 py-2.5 rounded-[1.25rem] bg-indigo-600/90 backdrop-blur-xl shadow-2xl border border-[var(--border-subtle)]">
                                        <span className="text-[10px] text-[var(--text-primary)] font-black uppercase tracking-[0.25em] flex items-center gap-2.5">
                            ...
                            <div className="w-full h-full flex flex-col items-center justify-center space-y-6">
                                {isGenerating ? (
                                    ...
                                    <>
                                        <div className="w-28 h-28 rounded-[3rem] bg-[var(--bg-base)] flex items-center justify-center shadow-2xl shadow-black/5 border border-[var(--border-subtle)]">
                    ...
                    {selectedImage && uploadMode === "ai" && (
                        <button
                            ...
                            disabled={isGenerating || !canGenerate}
                            className="group w-full py-5 rounded-[2rem] bg-[var(--bg-fill)] border border-[var(--border-subtle)] text-[11px] font-black uppercase tracking-[0.2em] text-[var(--text-primary)] flex items-center justify-center gap-3 hover:bg-[var(--bg-elevated)] hover:border-indigo-500/30 transition-all duration-500 shadow-sm active:scale-[0.98]"
                        >
            ...
            <div className="relative group">
                ...
                <div className="relative flex flex-wrap items-center justify-center gap-y-6 gap-x-12 py-8 px-12 rounded-[2.5rem] border border-[var(--border-subtle)] bg-[var(--bg-fill)] backdrop-blur-sm">
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-[1rem] bg-[var(--bg-base)] shadow-sm flex items-center justify-center border border-[var(--border-subtle)]">
                ...
                {isCropping && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-[var(--bg-base)] rounded-[3.5rem] w-full max-w-4xl overflow-hidden flex flex-col shadow-[0_0_100px_rgba(0,0,0,0.5)] border border-[var(--border-default)]"
                        >
                            {/* Modal Header */}
                            <div className="px-12 py-10 border-b border-[var(--border-subtle)] flex items-center justify-between bg-[var(--bg-fill)]">
                                <div className="space-y-1">
                                ...
                                <button
                                    ...
                                    className="w-14 h-14 flex items-center justify-center hover:bg-[var(--bg-secondary)] rounded-2xl transition-all duration-300"
                                >
                            ...
                            {/* Cropper Workspace */}
                            <div className="relative h-[480px] bg-[var(--bg-fill)] flex items-center justify-center">
                            ...
                            {/* Interaction Area */}
                            <div className="p-12 bg-[var(--bg-base)] space-y-10">
                                <div className="space-y-5">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-1.5 bg-[var(--bg-secondary)] rounded-lg appearance-none cursor-pointer accent-indigo-600"
                                    />
                                </div>
