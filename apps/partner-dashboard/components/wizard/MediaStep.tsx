...
function StyleCard({
  ...
  return (
    ...
    >
      ...
      <p
        className={`text-[11px] font-black tracking-wide leading-tight ${isSelected ? "text-indigo-400" : "text-[var(--text-primary)]"}`}
      >
        {style.label}
      </p>
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            {uploadMode === "manual" ? (
              ...
              >
                ...
                <div className="p-4 rounded-[1.25rem] bg-[var(--surface-base)] border border-[var(--border-subtle)] shadow-sm relative overflow-hidden">
                  ...
                  <p
                    className={`text-body-sm font-bold truncate ${eventName ? "text-[var(--text-primary)]" : "text-[var(--text-tertiary)] italic"}`}
                  >
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between px-1">
            <p className="text-label font-black uppercase tracking-widest text-[var(--text-tertiary)]">
              Master Asset
            </p>
            {selectedImage && (
          ...
          >
            ...
            >
              ...
              <div className="px-12 py-10 border-b border-[var(--border-subtle)] flex items-center justify-between bg-[var(--surface-secondary)]">
                <div className="space-y-1">
                  <h3 className="text-display-xs tracking-tight text-[var(--text-primary)]">
                    Refine Visual Asset
                  </h3>
                  <p className="text-[11px] font-black uppercase tracking-[0.25em] text-[var(--text-tertiary)]">
                    Standard 4:5 Master Ratio
                  </p>
                </div>
                <button
              ...
              <div className="p-12 bg-[var(--surface-base)] space-y-10">
                <div className="space-y-5">
                  <div className="flex justify-between items-center px-1">
                    <span className="text-[11px] font-black uppercase tracking-[0.2em] text-[var(--text-tertiary)]">
                      Optical Scaling
                    </span>
