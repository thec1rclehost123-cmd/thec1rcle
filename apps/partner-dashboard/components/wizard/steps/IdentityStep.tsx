    ...
    <div className="space-y-8">
      ...
      <div className="card-elevated p-8 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <AppleSelect
            label="City / Hub"
            options={["Pune", "Mumbai", "Goa", "Bengaluru", "Delhi", "Hyderabad", "Chennai"].map(
              (c) => ({ label: c, value: c }),
            )}
            value={formData.city}
      ...
      {role === "venue" ? (
        <div className="card-elevated p-8 space-y-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h3 className="text-headline-sm">Venue Identity</h3>
              <p className="text-caption">The physical location for this event</p>
            </div>
          </div>
      ...
      <div className="card-elevated p-8 space-y-6">
        ...
        <AppleInput
          ...
          onChange={(e) =>
            updateFormData({ capacity: e.target.value === "" ? "" : parseInt(e.target.value) || 0 })
          }
