...
export function CapacityStep({ formData, updateFormData, validationErrors }: CapacityStepProps) {
  ...
  return (
    <div className="space-y-8">
        ...
        <FieldGroup>
          ...
          {capacityExceeded && (
            <div className="mt-2 p-3 rounded-lg bg-red-50 border border-red-100 text-[13px] text-red-700">
              Total tickets ({totalTickets}) exceed venue capacity ({formData.capacity}). Reduce
              ticket quantities or increase capacity.
            </div>
          )}
      ...
      <Section title="Purchase Limits" description="Control how many tickets one person can buy.">
        <FieldGroup>
