    ...
    <div className="space-y-8">
      ...
      <div className="card-elevated p-8 space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <button type="button" onClick={addArtist} className="btn btn-secondary px-4">
            ...
            <div className="flex flex-wrap gap-3">
              {AGE_OPTIONS.map((option) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg border-2 text-body-sm font-medium transition-all ${
          ...
          <AnimatePresence>
            {formData.ageRestriction && formData.ageRestriction !== "all" && (
              ...
              >
                ...
                <div>
                  <p className="text-body font-medium text-[var(--state-warning)]">
                    ID Verification Required
                  </p>
                  <p className="text-caption text-[var(--state-warning)] opacity-80 mt-1">
                    Guests will be required to show valid government ID at entry. This will be
