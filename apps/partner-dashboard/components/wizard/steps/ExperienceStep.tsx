...
export function ExperienceStep({ formData, updateFormData, validationErrors }: ExperienceStepProps) {
                ...
                <div>
                    <div className="flex items-center justify-between mb-2.5">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest text-indigo-500">Music & Genre Tags</span>
                        </div>
                        {genres.length > 0 && (
            ...
            <div className="space-y-5">
                ...
                <div>
                    <div className="flex items-center gap-2 mb-2.5">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-amber-500">Dress Code</span>
                    </div>
                ...
                <div>
                    <div className="flex items-center gap-2 mb-2.5">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-red-500">Age Restriction</span>
                    </div>
