  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <span className="text-[17px] font-bold text-[#1d1d1f]">₹{Number(table.price) || 0}</span>
          {expanded ? (
            ...
            <div className="p-4 space-y-4">
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (
                            !table.name ||
                            TABLE_TYPES.some((t) => table.name === `${t.label} Table`)
                          ) {
                      ...
                      >
                        ...
                        />
                        <p
                          className={`text-[11px] font-medium ${isSelected ? "text-[#007aff]" : "text-[#1d1d1f]"}`}
                        >
                          {type.label}
                        </p>
                      </button>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onUpdate({
                          minimumSpend: e.target.value === "" ? "" : parseInt(e.target.value) || 0,
                        })
                      }
                      placeholder="0"
              ...
              <div className="p-3 rounded-xl bg-[#f5f5f7] flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[13px] font-medium text-[#1d1d1f]">Promoter Sales</p>
                    <p className="text-[11px] text-[#86868b]">Allow promoters to sell this table</p>
                  </div>
                </div>
                <button
                  onClick={() => onUpdate({ promoterEnabled: !table.promoterEnabled })}
                  className={`w-12 h-7 rounded-full relative transition-colors ${
                    table.promoterEnabled ? "bg-[#34c759]" : "bg-[rgba(0,0,0,0.1)]"
                  }`}
                >
                  <div
                    className={`absolute top-0.5 w-6 h-6 bg-white rounded-full shadow-sm transition-transform ${
                      table.promoterEnabled ? "translate-x-[22px]" : "translate-x-0.5"
                    }`}
                  />
                </button>
              </div>
              ...
              {table.promoterEnabled && (
                <div className="space-y-3">
                  ...
                  >
                    <div
                      className={`absolute left-0 top-0 bottom-0 w-12 flex items-center justify-center text-[16px] font-black text-white ${
                        (table.promoterCommissionType || "percent") === "percent"
                          ? "bg-[#F44A22]"
                          : "bg-[#1d1d1f]"
                      }`}
                  ...
                  <div className="p-3 rounded-xl bg-[#34c759]/5 border border-[#34c759]/10 flex items-center justify-between mt-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[13px] font-medium text-[#1d1d1f]">Buyer Discount</p>
                        <p className="text-[11px] text-[#86868b]">
                    ...
                    <button
                      onClick={() =>
                        onUpdate({ buyerDiscountEnabled: !table.buyerDiscountEnabled })
                      }
                      className={`w-12 h-7 rounded-full relative transition-colors ${
                        table.buyerDiscountEnabled ? "bg-[#34c759]" : "bg-[rgba(0,0,0,0.1)]"
                      }`}
                    >
                      <div
                        className={`absolute top-0.5 w-6 h-6 bg-white rounded-full shadow-sm transition-transform ${
                          table.buyerDiscountEnabled ? "translate-x-[22px]" : "translate-x-0.5"
                        }`}
                      />
                    </button>
                  </div>
...
export function TableBookingStep({
  formData,
  updateFormData,
  validationErrors,
  ...
  const totalCapacity = tables.reduce(
    (sum, t) => sum + (Number(t.quantity) || 0) * (Number(t.capacity) || 0),
    0,
  );
  const totalValue = tables.reduce(
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-label mt-1">Offer premium table packages for group bookings</p>
        </div>
        <button
      ...
      {!tablesEnabled ? (
        ...
        >
          ...
          <h3 className="text-display-sm mb-2">Reservations Offline</h3>
          <p className="text-body text-secondary mb-8 max-w-md mx-auto">
            Enable table reservations to offer premium group packages with bottle service, reserved
            seating, and exclusive VIP perks.
          </p>
          <button
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="apple-glass-card rounded-[2rem] p-6 space-y-1">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-[28px] font-black text-[#1d1d1f] tracking-tight">
                  {totalTables}
                </span>
            ...
            <div className="apple-glass-card rounded-[2rem] p-6 space-y-1">
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-[28px] font-black text-[#F44A22] tracking-tight">
          ...
          <div className="p-4 rounded-2xl bg-[#fff9c4] border border-[#ffd54f]">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-[13px] font-semibold text-[#e65100] mb-1">
                  Pro Tips for Table Packages
                </p>
