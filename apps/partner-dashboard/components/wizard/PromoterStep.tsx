...
import { Users, Percent, Search, Check, X, Loader2, ChevronDown, ChevronUp } from 'lucide-react';
              ...
              <div className="px-6 pb-5 space-y-5 border-t border-border-subtle pt-4">
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    onClick={() =>
                      updatePromoterSetting('promotersEnabled', !formData.promotersEnabled)
                    }
                ...
                {formData.promotersEnabled && (
                  <>
                    ...
                    <label className="flex items-center justify-between cursor-pointer">
                      ...
                      >
                        <span
                          className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white transition-transform ${formData.useDefaultCommission ? 'translate-x-5' : 'translate-x-0'}`}
                        />
                      </button>
                    </label>
