...
const ENTRY_TYPES = [
  ...
  },
  {
    ...
    label: "Female",
    icon: User,
    description: "Girl's entry",
    defaultName: "Female Entry",
  },
  {
    id: "vip",
    label: "VIP",
      ...
      <div className="p-6 flex items-center gap-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3">
            <span className="text-label uppercase tracking-widest text-indigo-500 font-bold">
              {selectedEntryType.label}
            </span>
            <div className="w-1 h-1 rounded-full bg-[var(--border-strong)]" />
            <span className="text-body-sm text-muted">{tier.quantity} units available</span>
          </div>
        </div>

        <div className="text-right mr-2">
          <p
            className={`text-stat-sm font-black ${isRSVP ? "text-indigo-500" : "text-[var(--text-primary)]"}`}
          >
                ...
                <div className="grid grid-cols-3 gap-2">
                  {ENTRY_TYPES.map((type) => {
                    ...
                    return (
                      ...
                      >
                        <Icon
                          className={`w-4 h-4 mb-1 ${isSelected ? "text-indigo-500" : "text-[var(--text-tertiary)]"}`}
                        />
                        <p
                          className={`text-[13px] font-bold uppercase tracking-wider ${isSelected ? "text-indigo-500" : "text-[var(--text-primary)]"}`}
                        >
                          {type.label}
                        </p>
                      </button>
                  ...
                  <div className="p-3 rounded-xl bg-[var(--surface-tertiary)] flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`w-12 h-7 rounded-full relative transition-colors ${
                        tier.promoterEnabled ? "bg-[#34c759]" : "bg-[var(--surface-elevated)]"
                      }`}
                    >
                      <div
                        className={`absolute top-0.5 w-6 h-6 bg-white rounded-full shadow-sm transition-transform ${
                          tier.promoterEnabled ? "translate-x-[22px]" : "translate-x-0.5"
                        }`}
                      />
                    </button>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        >
                          ...
                          <span
                            className={`text-[13px] font-semibold ${tier.overrideCommission ? "text-[#F44A22]" : "text-[var(--text-primary)]"}`}
                          >
                            {tier.overrideCommission
                        ...
                        {tier.overrideCommission && (
                          <div className="px-3 pb-3 space-y-2">
                              ...
                              <div className="flex p-0.5 bg-white rounded-lg border border-[#F44A22]/20">
                                <button
                                  ...
                                  className={`px-2.5 py-1 rounded-md text-[10px] font-bold transition-all ${
                                    (tier.promoterCommissionType || "percent") === "percent"
                                ...
                                <button
                                  ...
                                  className={`px-2.5 py-1 rounded-md text-[10px] font-bold transition-all ${
                                    tier.promoterCommissionType === "amount"
                            ...
                            <p className="text-[10px] text-[#86868b]">
                              Promoters earn {tier.promoterCommission || 0}
                              {(tier.promoterCommissionType || "percent") === "percent"
                                ? "%"
                                : "₹"}{" "}
                              for this tier
                      ...
                      {!isRSVP && buyerDiscountsEnabled && (
                        ...
                        >
                          ...
                          >
                            ...
                            <span
                              className={`text-[13px] font-semibold ${tier.overrideDiscount ? "text-[#34c759]" : "text-[var(--text-primary)]"}`}
                            >
                              {tier.overrideDiscount
                          ...
                          {tier.overrideDiscount && (
                            <div className="px-3 pb-3 space-y-2">
                              <div className="flex gap-2">
                                <div className="flex p-0.5 bg-white rounded-lg border border-[#34c759]/20">
                                  <button
                                    ...
                                    className={`px-2.5 py-1 rounded-md text-[10px] font-bold transition-all ${
                                      (tier.promoterDiscountType || "percent") === "percent"
                                  ...
                                  <button
                                    ...
                                    className={`px-2.5 py-1 rounded-md text-[10px] font-bold transition-all ${
                                      tier.promoterDiscountType === "amount"
                                        ? "bg-[#1d1d1f] text-white"
                                        : "text-[#86868b]"
                                    }`}
                                  >
                              ...
                              <p className="text-[10px] text-[#86868b]">
                                Buyers get {tier.promoterDiscount || 0}
                                {(tier.promoterDiscountType || "percent") === "percent"
                                  ? "%"
                                  : "₹"}{" "}
                                off via promoter links
                              </p>
                            </div>
                          )}
                        </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[12px] text-[var(--text-secondary)]">
                Enable for guestlists and free registrations
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[12px] text-[var(--text-secondary)]">
                Allow ambassadors and promoters to sell your tickets
              </p>
            </div>
          </div>
          <button
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between px-1">
                <p className="text-label font-black uppercase tracking-widest text-[#F44A22]">
                  Promoter Commission
                </p>
                <div className="px-3 py-1 rounded-full bg-orange-500/10 text-[#F44A22] text-[9px] font-black tracking-widest uppercase border border-orange-500/20">
                  Promoter Payouts
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-5 rounded-[1.5rem] bg-[var(--surface-tertiary)] border border-[var(--border-default)]">
                <div className="space-y-0.5">
                  <p className="text-body-sm font-bold text-[var(--text-primary)]">
                    Standardize Promoter Commission
                  </p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative w-24">
                      <input
                        ...
                        onChange={(e) =>
                          updateFormData({
                            commission: e.target.value === "" ? "" : parseInt(e.target.value) || 0,
                          })
                        }
            ...
            {!formData.isRSVP && (
              <div className="space-y-6">
                <div className="flex items-center justify-between px-1">
                  <p className="text-label font-black uppercase tracking-widest text-[#34c759]">
                    Buyer Discounts
                  </p>
                ...
                <div className="flex items-center justify-between p-5 rounded-[1.5rem] bg-[var(--surface-tertiary)] border border-[var(--border-default)]">
                  <div className="space-y-0.5">
                    <p className="text-body-sm font-bold text-[var(--text-primary)]">
                      Incentivize Buyer Sales
                    </p>
                    <p className="text-[10px] text-[var(--text-tertiary)] font-black uppercase tracking-widest">
                      Offer discounts on promoter links
                    </p>
                  </div>
                  <button
                    onClick={() =>
                      updateFormData({ buyerDiscountsEnabled: !formData.buyerDiscountsEnabled })
                    }
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-0.5">
                  ...
                  <p className="text-[12px] text-[var(--text-secondary)] font-medium">
                    Early Bird & Last Call scheduling
                  </p>
                </div>
              </div>
              <button
            ...
            {formData.scheduledPricingEnabled && (
              <div className="pt-4 border-t border-[var(--border-default)] space-y-4">
                    ...
                    (schedule: DefaultScheduledPrice) => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            onClick={() => {
                              const updated = formData.defaultScheduledPrices.filter(
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="relative flex-grow">
                            ...
                            />
                            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[12px] font-bold text-[#86868b]">
                              %
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div className="space-y-1">
                            <label className="text-[10px] text-[#86868b] font-bold uppercase">
                              Starts
                            </label>
                            <input
                              type="datetime-local"
                        ...
                        <div className="pt-2 border-t border-[rgba(0,0,0,0.06)]">
                          <div className="flex items-center justify-between gap-4">
                            <div className="flex items-center gap-2">
                              <div
                                className={`w-2 h-2 rounded-full ${schedule.quantityLimit ? "bg-[#007aff]" : "bg-[#86868b]/30"}`}
                              />
                ...
                <p className="text-[11px] text-[#86868b] p-3 rounded-lg bg-[#f5f5f7]">
                  💡 These price schedules apply to <strong>all ticket tiers</strong> by default.
                  You can override for specific tiers below.
                </p>
              </div>
            )}
          </div>
          ...
          {!formData.isRSVP && (
            <div className="p-5 rounded-2xl border border-[rgba(0,0,0,0.06)] bg-white shadow-sm space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[12px] text-[#86868b]">
                    Set min/max tickets allowed per account for this event
                  </p>
                </div>
              </div>
              ...
              <p className="text-[11px] text-[#86868b] bg-[#f5f5f7] p-3 rounded-lg flex items-start gap-2">
                <span>💡</span>
                <span>
                  These limits apply per user/account across the entire event.{" "}
                  <strong>Couple tickets</strong> count as 1 unit towards these limits.
                </span>
              </p>
            </div>
          )}
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-[24px] font-bold text-[#1d1d1f]">
                  {totalTickets}{" "}
                  <span className="text-[17px] font-normal text-[#86868b]">/ {capacity}</span>
                </p>
              </div>
              {!formData.isRSVP && (
