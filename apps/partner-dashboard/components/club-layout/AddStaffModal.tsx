...
type ClubStaffRole = "OWNER" | "CLUB_MANAGER" | "FLOOR_MANAGER" | "TABLE_MANAGER" | "SECURITY" | "OPS_STAFF";
...
const ROLE_OPTIONS: { value: ClubStaffRole; label: string; description: string }[] = [
...
export function AddStaffModal({ isOpen, onClose, onAdd }: AddStaffModalProps) {
    ...
    const [selectedRole, setSelectedRole] = useState<ClubStaffRole>("FLOOR_MANAGER");
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        <input
                                            ...
                                            onChange={(e) => setSelectedRole(e.target.value as ClubStaffRole)}
