...
export function VenueExecutiveHeader({
  ...
  const buttonLabel = selectedDate ? DATE_FMT.format(selectedDate) : contextLabel;

  return (
    <div
      className="sticky top-0 z-40 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 xl:-mx-10 xl:px-10 border-b border-[var(--v-border)] backdrop-blur-2xl"
    ...
    >
      ...
      <div className="flex items-center justify-between h-14 md:h-16">
        <div className="flex items-center gap-8 shrink-0">
          {/* Title */}
          <h1 className="v-text-title tracking-[-0.04em] text-[var(--v-text-primary)]">{title}</h1>
