...
const MENU_GROUPS = [
    {
        ...
        items: [
            ...
            { label: "Event Calendar", href: "/venue/calendar", icon: CalendarDays, minPlan: "basic" },
            { label: "My Events", href: "/venue/events", icon: GlassWater, minPlan: "basic" },
        ]
    },
    {
        label: "Operations",
        items: [
            { label: "Entry & Security", href: "/venue/security", icon: ShieldCheck, minPlan: "silver" },
            { label: "Nightly Logs", href: "/venue/registers", icon: ClipboardList, minPlan: "silver" },
            { label: "Tables & VIP", href: "/venue/tables", icon: Armchair, minPlan: "gold" },
        ]
    },
    {
        label: "Partners",
        items: [
            { label: "Host List", href: "/venue/hosts", icon: UserCheck, minPlan: "diamond" },
            { label: "Promoter List", href: "/venue/promoters", icon: Handshake, minPlan: "diamond" },
        ]
    }
];
