        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <div className="relative h-11 w-11 rounded-xl bg-gradient-to-br from-[#1a1a1f] to-[#0f0f12] flex items-center justify-center border border-white/10 shadow-lg">
              <span className="text-lg font-black bg-gradient-to-br from-white to-white/60 bg-clip-text text-transparent">
                C
              </span>
            </div>
          </div>
          ...
          {/* Plan Badge */}
          <div
            className={`px-2 py-1 rounded-md ${planStyle.bg} ${planStyle.glow} border border-white/5`}
          >
                      ...
                      {visibleItems.map((item) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              <Icon
                                className={`h-3.5 w-3.5 transition-all ${active ? "text-violet-400" : ""}`}
                              />
                            </div>
