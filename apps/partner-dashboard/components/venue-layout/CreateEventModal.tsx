...
export function CreateEventModal({ isOpen, onClose, venueId, onSubmit }: CreateEventModalProps) {
  ...
  const updateTicketPhase = (id: string, field: string, value: any) => {
    setTicketPhases(ticketPhases.map((p) => (p.id === id ? { ...p, [field]: value } : p)));
  };
        ...
        <div className="sticky top-0 bg-white border-b border-slate-200 p-6 flex items-center justify-between z-10">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Step {step} of 4 -{" "}
              {["Basic Info", "Ticketing", "Entry & Promoters", "Review"][step - 1]}
            </p>
          </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <label className="text-sm font-semibold text-slate-700">Ticket Phases</label>
                  <button
                ...
                <div className="space-y-3">
                  {ticketPhases.map((phase, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-sm font-bold text-slate-700">Phase {index + 1}</span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <input
                          type="text"
                          value={phase.name}
                          onChange={(e) => updateTicketPhase(phase.id, "name", e.target.value)}
                ...
                <div className="mb-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="h-4 w-4"
                    />
                    <span className="text-sm font-semibold text-slate-700">Enable Promoters</span>
                  </label>
                </div>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm font-semibold text-blue-900">📋 Review & Submit</p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-slate-50 rounded-lg border border-slate-200">
                    ...
                    <p className="text-xl font-bold text-slate-900">
                      {promotersEnabled ? "Enabled" : "Disabled"}
                    </p>
                  </div>
