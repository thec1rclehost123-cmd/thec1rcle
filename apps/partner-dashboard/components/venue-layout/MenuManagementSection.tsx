            ...
            <section className="space-y-6">
                <div className="flex items-start gap-4">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        />
                        <div className="w-11 h-6 bg-[var(--bg-fill)] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-[var(--bg-elevated)] after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-amber-500" />
            ...
            {venue?.hasRestaurant && (
                <>
                            ...
                            {PRICE_BANDS.map((band) => (
                                <button
                                    ...
                                    className={`p-4 rounded-2xl border transition-all text-left ${venue?.priceBand === band.value
                                        ...
                                        : "bg-[var(--bg-fill)] border-[var(--border-subtle)] hover:border-[var(--border-default)]"
                                        }`}
                                >
                            ...
                            {CUISINE_OPTIONS.map((cuisine) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl text-[11px] font-bold transition-all ${venue?.cuisineTags?.includes(cuisine)
                                        ...
                                        : "bg-[var(--bg-fill)] text-[var(--text-secondary)] border border-[var(--border-subtle)] hover:bg-[var(--bg-elevated)]"
                                        }`}
                                >
                                    {cuisine}
                                </button>
                    ...
                    <section className="space-y-4 pt-8 border-t border-[var(--border-subtle)]">
                        ...
                        {venue?.menuURL ? (
                            <div className="flex items-center justify-between p-6 bg-[var(--bg-fill)] rounded-2xl border border-[var(--border-subtle)]">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="px-4 py-2 bg-[var(--bg-elevated)] rounded-xl text-[11px] font-bold text-[var(--text-secondary)] hover:bg-[var(--bg-base)] border border-[var(--border-subtle)]"
                                    >
                                        Replace
                                    </button>
                                    <button
                            ...
                            <button
                                ...
                                className="w-full py-12 border-2 border-dashed border-[var(--border-subtle)] rounded-2xl flex flex-col items-center justify-center gap-4 hover:bg-[var(--bg-fill)] transition-all group"
                            >
                                {isUploading ? (
                                    <Loader2 className="w-8 h-8 text-[var(--text-tertiary)] animate-spin" />
                                ) : (
                                    <>
                                        <div className="p-4 bg-[var(--bg-fill)] rounded-2xl group-hover:scale-110 transition-transform">
                    ...
                    <section className="space-y-4 pt-8 border-t border-[var(--border-subtle)]">
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-amber-500 text-[var(--text-primary)] rounded-xl text-[11px] font-bold hover:bg-amber-400 transition-all"
                            >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {venue?.popularDishes?.map((dish: any) => (
                                <div key={dish.id} className="relative group rounded-2xl overflow-hidden border border-[var(--border-subtle)] bg-[var(--bg-fill)]">
                                    {dish.image ? (
                                    ...
                                    <div className="absolute bottom-4 left-4 right-4">
                                        {dish.tag && (
                                            <span className="inline-block px-2 py-1 bg-amber-500 rounded-md text-[9px] font-black text-[var(--text-primary)] uppercase mb-2">
                                                {dish.tag}
                                            </span>
                                        )}
                                        <p className="text-[var(--text-primary)] font-bold">{dish.name}</p>
                                        <p className="text-amber-400 font-bold">{dish.price}</p>
                                    </div>
                                    <button
                                        onClick={() => handleRemoveDish(dish.id)}
                                        className="absolute top-3 right-3 p-2 bg-black/40 backdrop-blur-md rounded-xl text-[var(--text-primary)] opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-500"
                                    >
                                        <Trash2 className="w-4 h-4" />
                                    </button>
                                </div>
                            ...
                            {(!venue?.popularDishes || venue.popularDishes.length === 0) && (
                                <div className="col-span-full py-16 text-center bg-[var(--bg-fill)]/30 rounded-2xl border border-dashed border-[var(--border-subtle)]">
                                    ...
                                    <p className="text-[var(--text-quaternary)] text-xs mt-1">Showcase your best items</p>
                                </div>
                            )}
                        </div>
                    </section>
                ...
                {showAddDish && (
                    ...
                    >
                        <motion.div
                            ...
                            className="w-full max-w-md bg-[var(--bg-base)] rounded-3xl border border-[var(--border-subtle)] overflow-hidden shadow-2xl"
                        >
                            <div className="p-8">
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-[var(--bg-fill)] border border-[var(--border-subtle)] rounded-xl text-sm"
                                        />
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <button
                                            ...
                                            className="w-full py-8 border-2 border-dashed border-[var(--border-subtle)] rounded-xl flex flex-col items-center justify-center gap-2 hover:bg-[var(--bg-fill)] transition-all"
                                        >
                                            {newDish.image ? (
                                ...
                                <div className="flex gap-3 mt-6">
                                    <button
                                        onClick={() => setShowAddDish(false)}
                                        className="flex-1 py-3 bg-[var(--bg-fill)] text-[var(--text-secondary)] rounded-xl text-sm font-bold"
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        ...
                                        className="flex-1 py-3 bg-amber-500 text-[var(--text-primary)] rounded-xl text-sm font-bold disabled:opacity-50"
                                    >
                                        Add Dish
                                    </button>
                                </div>
