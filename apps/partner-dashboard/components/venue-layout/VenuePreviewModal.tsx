      ...
      >
            ...
            <div className="flex p-1 bg-white/5 rounded-xl border border-white/10">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[11px] font-bold transition-all ${
                  device === "desktop" ? "bg-white text-black" : "text-white/60 hover:text-white"
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[11px] font-bold transition-all ${
                  device === "mobile" ? "bg-white text-black" : "text-white/60 hover:text-white"
                }`}
              >
        ...
        <div className="flex-1 overflow-auto p-8 flex justify-center">
          ...
          >
            ...
            <div
              className={`w-full h-full overflow-y-auto ${theme === "dark" ? "bg-[#0A0A0A] text-white" : "bg-white text-black"}`}
            >
              {/* Hero Section */}
              ...
              >
                <div className="text-center">
                  ...
                  <p
                    className={`text-[10px] font-bold uppercase ${theme === "dark" ? "text-white/40" : "text-black/40"}`}
                  >
                    Followers
                  </p>
                </div>
              ...
              <div className="p-6">
                <h3
                  className={`text-sm font-black uppercase tracking-widest mb-3 ${theme === "dark" ? "text-white/60" : "text-black/60"}`}
                >
                  About
                </h3>
                <p
              ...
              {/* Contact Preview */}
              <div
                className={`m-6 p-6 rounded-2xl ${theme === "dark" ? "bg-white/5" : "bg-black/5"}`}
              >
                <h3
                  className={`text-sm font-black uppercase tracking-widest mb-4 ${theme === "dark" ? "text-white/60" : "text-black/60"}`}
                >
                  Contact
                </h3>
