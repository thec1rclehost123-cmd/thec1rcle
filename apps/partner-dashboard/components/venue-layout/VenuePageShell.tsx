      ...
      <div className="mb-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div className="min-w-0">
            ...
            {subtitle ? (
              <div className="mt-1 text-sm leading-6" style={{ color: 'var(--v-text-secondary)' }}>
                {subtitle}
              </div>
            ) : null}
          </div>
      ...
      {hasControlBar && (
        ...
        >
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="min-w-0 flex-1 overflow-x-auto scrollbar-hide">{filterBar}</div>
            {actions && filterBar && (
...
export function VenueActionButton({
  ...
  const variants = {
    primary: 'bg-[var(--v-orange)] text-white hover:brightness-110 active:scale-[0.98]',
    secondary:
          ...
          return (
            <button
              ...
              style={{
                ...
                boxShadow: isActive
                  ? '0 0 20px rgba(244, 74, 34, 0.1), inset 0 0 0 1px var(--v-border)'
                  : 'none',
