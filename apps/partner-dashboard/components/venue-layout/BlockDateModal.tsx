...
export function BlockDateModal({ isOpen, onClose, selectedDate, onBlock }: BlockDateModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Modal */}
            <div className="relative bg-[var(--bg-elevated)] rounded-2xl shadow-2xl w-full max-w-md">
                {/* Header */}
                <div className="border-b border-[var(--border-default)] p-6 flex items-center justify-between">
                    <div>
                        <h2 className="text-xl font-bold text-[var(--text-primary)]">Block Date</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div className="p-4 bg-[var(--bg-secondary)] rounded-lg border border-[var(--border-default)]">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-xs font-semibold text-[var(--text-tertiary)] uppercase tracking-wider">Selected Date</p>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                            className="w-full px-4 py-3 bg-[var(--bg-secondary)] border border-[var(--border-default)] rounded-lg text-[var(--text-primary)] focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                        >
                            {BLOCK_REASONS.map((r) => (
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-4 py-3 bg-[var(--bg-secondary)] border border-[var(--border-default)] rounded-lg text-[var(--text-primary)] placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 resize-none"
                    ...
                    <div className="flex items-center gap-3 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex-1 px-4 py-3 bg-[var(--bg-fill)] text-[var(--text-primary)] font-semibold rounded-lg hover:bg-[var(--bg-secondary)] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
