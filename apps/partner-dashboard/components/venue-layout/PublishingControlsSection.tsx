        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-tertiary)]">
              Control your venue page visibility
            </p>
          </div>
        </div>
          ...
          >
            ...
            >
              <div className="p-6 border-b border-[var(--border-subtle)]">
                ...
                <p className="text-sm text-[var(--text-tertiary)]">
                  Previous versions of your venue page
                </p>
              </div>
              ...
              <div className="max-h-96 overflow-y-auto p-6 space-y-4">
                {versionHistory.map((version) => (
                  <div
                    key={version.id}
                    className="p-4 bg-[var(--surface-secondary)] rounded-2xl border border-[var(--border-subtle)]"
                  >
                    ...
                    <ul className="space-y-1">
                      {version.changes.map((change, idx) => (
                        <li
                          key={idx}
                          className="text-[11px] text-[var(--text-tertiary)] flex items-center gap-2"
                        >
