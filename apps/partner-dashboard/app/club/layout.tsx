...
const menuSections = [
    ...
    {
        items: [
            { icon: CalendarDays, label: "Events", href: "/club/events" },
            { icon: PlusCircle, label: "Create Event", href: "/club/create" },
            { icon: Calendar, label: "Calendar", href: "/club/calendar" },
        ]
    },
    {
        items: [
            { icon: Users, label: "Connections", href: "/club/connections" },
            { icon: Shield, label: "Staff", href: "/club/staff" },
            { icon: FileText, label: "Registers", href: "/club/registers" },
        ]
    },
    {
        items: [
            { icon: Building2, label: "Venue Page", href: "/club/page-management" },
