...
export async function POST(
    ...
    const ctx = await requireVenueAccess(
        request,
        parsedBody.mode === "cancel_and_relist" ? "orders_refundResell" : "orders_refund"
    );
    ...
    try {
        ...
        console.error("[venue/orders/[orderId]/cancel]", error?.message || error);
