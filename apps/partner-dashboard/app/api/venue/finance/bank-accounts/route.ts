...
export async function GET(req: NextRequest) {
    ...
    return proxyToGateway(req, `${GATEWAY_URL}/api/v1/venue/finance/bank-accounts?${searchParams}`, {});
}
...
export async function POST(req: NextRequest) {
    ...
    return proxyToGateway(req, `${GATEWAY_URL}/api/v1/venue/finance/bank-accounts`, {
        method: "POST",
