...
export async function POST(req: NextRequest) {
  try {
    ...
    const { promoterId, promoterName, eventId, ticketTierIds, customCommission } = body;
    ...
    const commissionRate =
      customCommission || event.promoterSettings?.defaultCommission || event.commission || 15;
