...
import { Clock, CheckCircle2, XCircle, Users, Search, RefreshCw, Loader2 } from 'lucide-react';
...
export default function PromoterConnectionsPage() {
  ...
  const fetchConnections = useCallback(async () => {
    ...
    try {
      ...
      const approved = data.connections.filter(
        ...
        <div className="flex items-center p-1.5 bg-slate-100/80 backdrop-blur-sm rounded-2xl w-fit overflow-x-auto">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2.5 px-5 py-2.5 rounded-xl text-[13px] font-semibold transition-all shrink-0 ${
                activeTab === tab.id
              ...
              {loading ? (
                ...
                <div className="py-24 bg-white/50 rounded-[3rem] border border-dashed border-slate-200 flex flex-col items-center text-center px-10">
                  ...
                  <p className="text-slate-500 font-medium mt-2 max-w-xs">
                    Visit the Discover tab to find new partners and grow your network.
                  </p>
                </div>
              ) : (
                    ...
                    >
                      <div className="flex items-start justify-between mb-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <span
                              className={`inline-flex items-center px-2.5 py-0.5 rounded-lg text-[11px] font-bold uppercase tracking-wider mt-1.5 ${
                                connection.otherType === 'host'
                      ...
                      <div className="space-y-4 pt-6 border-t border-slate-50">
                        ...
                        <div className="flex items-center justify-between text-[13px]">
                          ...
                          <span
                            className={`font-bold px-3 py-1 rounded-full text-[11px] uppercase tracking-tight ${
