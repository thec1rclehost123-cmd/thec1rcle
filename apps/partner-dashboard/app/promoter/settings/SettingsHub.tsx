        ...
        >
            <div className="space-y-8">
                ...
                <div className="min-h-[600px]">
                    {activeTab === "general" && <GeneralSettings setActions={setActions} activeTab={activeTab} />}
                    {activeTab === "persona" && <PersonaSettings setActions={setActions} />}
                    {activeTab === "notifications" && <GeneralSettings setActions={setActions} activeTab="notifications" />}
                    {activeTab === "security" && <GeneralSettings setActions={setActions} activeTab="security" />}
                </div>
            </div>
        </VenuePageShell>
    );
