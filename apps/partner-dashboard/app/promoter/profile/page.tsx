...
function SectionHeader({ title }: { title: string }) {
  return (
    <div className="flex items-center gap-4">
      <h3 className="text-[11px] font-bold text-[#86868b] uppercase tracking-widest whitespace-nowrap">
        {title}
      </h3>
...
function ProfileItem({ icon: Icon, label, value, readOnly, editing, onChange, placeholder }: any) {
  return (
    <div className="space-y-2">
      <label className="text-[11px] font-bold text-[#86868b] uppercase tracking-widest ml-1">
        {label}
      </label>
      <div
      ...
      >
        ...
        {editing && !readOnly ? (
          ...
          <span
            className={`text-sm font-semibold ${value ? "text-[#1d1d1f]" : "text-[#86868b] italic"}`}
          >
