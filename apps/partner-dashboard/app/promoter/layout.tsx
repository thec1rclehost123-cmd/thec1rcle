...
const menuSections = [
  ...
  {
    items: [{ icon: Users, label: "Connections", href: "/promoter/connections" }],
  },
  {
    items: [{ icon: CreditCard, label: "Payouts", href: "/promoter/payouts" }],
  },
  {
    items: [
        ...
        <div className="min-h-screen bg-[var(--surface-base)]">
          ...
          <header className="lg:hidden h-14 bg-[var(--surface-base)]/90 backdrop-blur-xl border-b border-[var(--border-subtle)] fixed top-0 left-0 right-0 z-50 px-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className="w-7 h-7 rounded-lg bg-[var(--text-primary)] flex items-center justify-center text-[var(--text-inverse)] text-[11px] font-bold">
                P
              </span>
