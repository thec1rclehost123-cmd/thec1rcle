...
export default function HostDiscoverPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12 animate-in fade-in duration-700">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-8">
          <div className="space-y-4 max-w-2xl">
            <div className="flex items-center gap-3">
              ...
              <h4 className="text-sm font-bold text-slate-900 uppercase tracking-[0.1em]">
                Partnership Economics
              </h4>
            </div>
            <p className="text-slate-600 text-[15px] font-medium leading-relaxed">
              Connect with <span className="text-slate-900 font-bold">Venues</span> to unlock their
              Availability Calendar and request event slots. Partner with{" "}
              <span className="text-slate-900 font-bold">Promoters</span> to give them access to
              your events and boost your conversion rates.
            </p>
          </div>
      ...
      <DiscoveryView allowedTypes={["venue", "promoter"]} partnerId={hostId} role="host" />
    </div>
  );
}
