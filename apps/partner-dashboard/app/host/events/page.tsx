...
export default function HostEventsPage() {
    ...
    const matchesTab =
      activeTab === "all"
        ...
        : activeTab === "live"
          ? e.status === "live"
          : activeTab === "submitted"
            ? e.lifecycle === "submitted"
            : activeTab === "approved"
              ? e.lifecycle === "approved" || e.lifecycle === "scheduled"
              : activeTab === "drafts"
                ? e.lifecycle === "draft"
                : true;
  ...
  const tabCounts = {
    ...
    approved: events.filter((e) => e.lifecycle === "approved" || e.lifecycle === "scheduled")
      .length,
              ...
              <DashboardEventCard
                ...
                secondaryActions={[
                  ...
                  },
                  {
                    ...
                    href: `/host/analytics?event=${event.id}`,
                  },
                  {
                    label: "Copy Link",
                    icon: <Share2 size={16} />,
