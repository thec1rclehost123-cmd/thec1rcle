...
export default function HostPageManagement() {
  ...
  return (
    ...
    >
      {/* Quick Stats */}
      <div
        className="grid grid-cols-2 md:grid-cols-4 gap-4 rounded-[32px] p-6 border"
      ...
      <div className="flex p-1 bg-surface-secondary rounded-xl border border-border-subtle overflow-x-auto scrollbar-hide">
        {[
          ...
          <button
            ...
            className={`flex-1 py-2 px-4 whitespace-nowrap flex items-center justify-center gap-1.5 rounded-lg text-[11px] font-semibold transition-all ${
              activeTab === tab.id
                ...
                <section className="space-y-5 pt-6 border-t border-border-subtle">
                  ...
                  >
                    ...
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent py-4 opacity-0 group-hover:opacity-100 transition-opacity">
                      <p className="text-[10px] font-bold text-text-primary text-center uppercase tracking-widest">
                        Click to Change
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {GENRE_OPTIONS.map((genre) => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all ${
                            data?.profile?.genres?.includes(genre)
                    ...
                    <div className="flex flex-wrap gap-2">
                      {STYLE_TAGS.map((tag) => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all ${
                            data?.profile?.styleTags?.includes(tag)
                              ? 'bg-surface-secondary text-text-primary shadow-sm'
                              : 'bg-surface-secondary/50 text-text-secondary hover:bg-surface-elevated border border-border-subtle'
                          }`}
                        >
                ...
                <section className="space-y-5">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <EngagementStat
                      ...
                      value={`${(((data?.stats?.totalLikes || 0) / Math.max(data?.stats?.followersCount || 1, 1)) * 100).toFixed(1)}%`}
                      change="+3%"
                      positive
                    />
                    <EngagementStat
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <FormField
                  ...
                  onChange={(v: any) => setNewVideo({ ...newVideo, title: v })}
                  inline
                />
                <FormField
                  label="Video URL"
                  ...
                  value={newVideo.url}
                  onChange={(v: any) => setNewVideo({ ...newVideo, url: v })}
                  inline
                />
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-[9px] font-bold text-text-primary/40 uppercase tracking-widest">
          {label}
        </p>
      </div>
    </div>
...
function FormField({
  ...
  const inputClasses =
    'w-full px-4 py-3 bg-surface-secondary border border-border-subtle rounded-xl text-sm font-medium text-text-primary focus:outline-none focus:ring-2 focus:ring-slate-900/10 focus:border-border-strong transition-all';
