      ...
      <div className="flex p-1.5 bg-[var(--surface-secondary)] rounded-2xl border border-[var(--border-subtle)]">
        {[
          ...
          <button
            ...
            className={`flex-1 py-3.5 flex items-center justify-center gap-2 rounded-xl text-[11px] font-bold transition-all ${
              activeTab === tab.id
                ...
                <section className="space-y-6 pt-8 border-t border-[var(--border-subtle)]">
                  ...
                  >
                    ...
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent py-6 opacity-0 group-hover:opacity-100 transition-opacity">
                      <p className="text-[11px] font-bold text-white text-center uppercase tracking-widest">
                        Click to Change
                      </p>
                    </div>
                  </div>
                ...
                <section className="space-y-6 pt-8 border-t border-[var(--border-subtle)]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {data?.profile?.pressSnippets?.map((snippet: any, idx: number) => (
                      <div
                        key={idx}
                        className="p-6 bg-[var(--surface-secondary)]/50 rounded-2xl border border-[var(--border-subtle)]"
                      >
                        <Quote className="w-5 h-5 text-[var(--text-tertiary)] mb-3" />
                        <p className="text-[var(--text-secondary)] text-sm mb-3 italic">
                          "{snippet.quote}"
                        </p>
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                    {data?.profile?.photos?.map((photo: string, idx: number) => (
                      <div
                        key={idx}
                        className="relative aspect-square rounded-2xl overflow-hidden border border-[var(--border-subtle)] group"
                      >
                        <img
                          src={photo}
              ...
              >
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <EngagementStat
                      label="This Month"
                      value={Math.floor((data?.stats?.followersCount || 0) * 0.15)}
                      change="+8%"
                      positive
                    />
                    <EngagementStat
                ...
                <section className="space-y-6 pt-8 border-t border-[var(--border-subtle)]">
                  <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-12 text-center">
                    ...
                    <p className="text-white/60 max-w-md mx-auto text-sm">
                      Deep audience insights, demographic breakdowns, and engagement patterns are
            ...
            <div className="p-8">
              ...
              <div className="flex gap-3 mt-6">
                <button
                  ...
                  className="flex-1 py-3 bg-[var(--surface-secondary)] text-[var(--text-secondary)] rounded-xl text-sm font-bold hover:bg-[var(--surface-elevated)] transition-all"
                >
                  Cancel
                </button>
              </div>
            ...
            <div className="p-8">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-slate-900 text-white rounded-xl text-sm font-bold disabled:opacity-50"
                >
                  Add Video
                </button>
              </div>
...
function FormField({
  ...
  const inputClasses =
    "w-full px-4 py-3 bg-[var(--surface-secondary)] border border-[var(--border-subtle)] rounded-xl text-sm font-medium text-[var(--text-primary)] focus:outline-none focus:ring-2 focus:ring-slate-900/10 focus:border-[var(--border-strong)] transition-all";
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        {Icon && (
          <Icon className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--text-tertiary)]" />
        )}
        {multiline ? (
          <textarea
            value={localValue}
    ...
    <div className="bg-[var(--surface-secondary)]/50 rounded-2xl border border-[var(--border-subtle)] overflow-hidden group hover:border-[var(--border-strong)] transition-all">
      ...
      <div className="p-5">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            onClick={onDelete}
            className="p-1.5 text-[var(--text-placeholder)] hover:text-red-500 opacity-0 group-hover:opacity-100 transition-all"
          >
  ...
  return (
    <div className="flex-shrink-0 group relative">
      <div className="w-24 h-24 rounded-full border-2 border-[var(--border-strong)] p-1 mb-3 transition-transform group-hover:scale-105">
        <div
          className="w-full h-full rounded-full bg-[var(--surface-secondary)] flex items-center justify-center"
          style={{ backgroundColor: `${highlight.color}15` }}
        >
          <Camera className="w-6 h-6 text-[var(--text-tertiary)]" />
        </div>
      </div>
      <p className="text-[11px] font-bold text-[var(--text-secondary)] text-center truncate w-24">
        {highlight.title}
      </p>
      <button
        onClick={onDelete}
  ...
  return (
    <div className="bg-[var(--surface-secondary)]/50 rounded-2xl border border-[var(--border-subtle)] overflow-hidden group hover:border-[var(--border-strong)] transition-all">
      ...
      <div className="p-4 flex items-center justify-between">
        ...
        <button
          onClick={onDelete}
          className="p-1.5 text-[var(--text-placeholder)] hover:text-red-500"
        >
          <Trash2 className="h-4 w-4" />
        </button>
      </div>
...
function EngagementStat({
  ...
  return (
    <div className="p-6 bg-[var(--surface-secondary)]/50 rounded-2xl border border-[var(--border-subtle)]">
      <p className="text-[10px] font-bold text-[var(--text-tertiary)] uppercase tracking-widest mb-2">
        {label}
      </p>
      <p className="text-3xl font-bold text-[var(--text-primary)] mb-1">
        {typeof value === "number" ? value.toLocaleString() : value}
      </p>
      <span className={`text-[11px] font-bold ${positive ? "text-emerald-500" : "text-red-500"}`}>
        {change}
      </span>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 hover:bg-[var(--surface-secondary)] rounded-xl z-10"
        >
