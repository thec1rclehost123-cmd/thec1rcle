      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-200 pb-10">
        <div>
          ...
          <p className="text-slate-500 text-lg font-medium mt-3">
            Curate how your host profile appears to guests and potential partners.
          </p>
        </div>
        ...
        <div className="p-10">
              ...
              <div className="col-span-full space-y-8 pt-10 border-t border-slate-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                  {data?.profile?.photos?.map((photo: string, idx: number) => (
                    <div
                      key={idx}
                      className="relative aspect-square rounded-3xl overflow-hidden border border-slate-100 group"
                    >
                      <img
                        src={photo}
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {data?.posts?.map((post: any) => (
                  <div
                    key={post.id}
                    className="p-0 bg-slate-50 rounded-3xl border border-slate-100 group relative overflow-hidden transition-all hover:shadow-md"
                  >
                    {post.imageUrl && (
          ...
          {activeTab === "followers" && (
            <div className="space-y-10">
              <div>
                <h3 className="text-xl font-black uppercase tracking-tight text-slate-900 border-b border-slate-100 pb-6">
                  Your Community
                </h3>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 sm:p-24">
            ...
            >
              ...
              <div className="w-full md:w-[380px] bg-slate-50 p-10 flex flex-col">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-8">
                  Page Preview
                </label>
...
function TabButton({ active, icon: Icon, label, onClick }: any) {
  return (
    <button
      onClick={onClick}
      className={`flex-1 py-6 flex flex-col items-center gap-2 border-b-2 transition-all ${
        active
