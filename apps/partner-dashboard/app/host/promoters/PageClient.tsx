    ...
    return (
        <div className="space-y-10">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-black text-text-primary tracking-tight transition-all">Promoter Network</h1>
                    <p className="text-text-tertiary font-medium mt-1">Manage and track your promoter team performance.</p>
                </div>
                <button
                    onClick={() => {
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-indigo-600 text-text-primary rounded-2xl font-bold hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-surface-elevated p-6 rounded-3xl border border-border-default shadow-sm flex items-center gap-6">
                    <div className="h-14 w-14 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center">
                        <Users className="h-7 w-7" />
                    </div>
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-text-tertiary">Total Network</p>
                        <p className="text-2xl font-black text-text-primary">{promoters.length}</p>
                    </div>
                </div>
                <div className="bg-surface-elevated p-6 rounded-3xl border border-border-default shadow-sm flex items-center gap-6">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-text-tertiary">Pending Requests</p>
                        <p className="text-2xl font-black text-text-primary">{pendingRequests.length}</p>
                    </div>
                </div>
                <div className="bg-surface-elevated p-6 rounded-3xl border border-border-default shadow-sm flex items-center gap-6">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-text-tertiary">Connected</p>
                        <p className="text-2xl font-black text-text-primary">{approvedConnections.length}</p>
                    </div>
                </div>
                <div className="bg-surface-elevated p-6 rounded-3xl border border-border-default shadow-sm flex items-center gap-6">
                    <div className="h-14 w-14 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-text-tertiary">Total Sales</p>
            ...
            <div className="flex items-center gap-1 p-1 bg-surface-secondary rounded-xl w-fit">
                ...
                >
                    ...
                    {pendingRequests.length > 0 && (
                        <span className="px-1.5 py-0.5 bg-amber-500 text-text-primary rounded-full text-[10px]">
            ...
            {/* Network Tab */}
            {activeTab === "network" && (
                <div className="bg-surface-elevated border border-border-default rounded-[2.5rem] shadow-sm overflow-hidden">
                    <div className="p-8 border-b border-border-subtle flex items-center justify-between bg-surface-tertiary/50">
                        <div className="relative w-72">
                            <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-text-tertiary" />
                            <input
                                type="text"
                                placeholder="Find promoter..."
                                className="w-full bg-surface-elevated border border-border-default rounded-xl pl-12 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
                            />
                        </div>
                    </div>
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-slate-50">
                                    <th className="px-8 py-5 text-[10px] font-black text-text-tertiary uppercase tracking-widest">Promoter</th>
                                    <th className="px-8 py-5 text-[10px] font-black text-text-tertiary uppercase tracking-widest">Performance</th>
                                    <th className="px-8 py-5 text-[10px] font-black text-text-tertiary uppercase tracking-widest">Status</th>
                                    <th className="px-8 py-5 text-[10px] font-black text-text-tertiary uppercase tracking-widest text-right">Action</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr>
                                        <td colSpan={4} className="px-8 py-20 text-center">
                                            <div className="max-w-xs mx-auto">
                                                ...
                                                <p className="text-text-tertiary font-bold">No promoters found in your network.</p>
                                                <p className="text-xs text-text-tertiary mt-2">Invite your team to start tracking sales and performance.</p>
                                            </div>
                                        </td>
                                    </tr>
                                ) : (
                                        ...
                                        <tr key={promoter.id} className="hover:bg-surface-tertiary group transition-all">
                                            <td className="px-8 py-6">
                                                <div className="flex items-center gap-4">
                                                    <div className="h-12 w-12 rounded-2xl bg-surface-secondary border border-border-default flex items-center justify-center font-black text-text-tertiary group-hover:bg-surface-elevated group-hover:text-indigo-600 transition-all">
                                                        {promoter.name?.[0] || 'P'}
                                                    </div>
                                                    <div>
                                            ...
                                            <td className="px-8 py-6">
                                                <div className="flex items-center gap-4">
                                                    <div className="h-2 w-24 bg-surface-secondary rounded-full overflow-hidden">
                                                        <div className="h-full bg-indigo-600 rounded-full" style={{ width: '0%' }}></div>
                                                    </div>
                                                    <span className="text-xs font-bold text-text-tertiary">0% Grade</span>
                                                </div>
                                            </td>
                                            <td className="px-8 py-6">
            ...
            {activeTab === "requests" && (
                <div className="space-y-6">
                    {/* Pending Requests */}
                    <div>
                        <h3 className="text-xs font-black uppercase tracking-widest text-text-tertiary mb-4 flex items-center gap-2">
                        ...
                        {pendingRequests.length === 0 ? (
                            <div className="bg-surface-elevated border border-border-default rounded-3xl p-12 text-center">
                                ...
                                <p className="text-text-tertiary font-bold">No pending requests</p>
                                <p className="text-xs text-text-tertiary mt-2">When promoters request to connect with you, they'll appear here.</p>
                            </div>
                        ) : (
                            <div className="space-y-3">
                                {pendingRequests.map(request => (
                                    <div key={request.id} className="bg-surface-elevated border border-border-default rounded-[2rem] p-8 shadow-sm hover:shadow-md transition-all">
                                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
                                            <div className="flex-1 space-y-6">
                                                <div className="flex items-start gap-4">
                                                    ...
                                                    <div>
                                                        <h4 className="text-xl font-bold text-text-primary">{request.promoterName || "Unknown Promoter"}</h4>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    <div className="p-5 bg-surface-tertiary rounded-2xl border border-border-subtle">
                                                        <p className="text-[10px] font-black uppercase tracking-widest text-text-tertiary mb-2">Promoter Biography</p>
                                            ...
                                            <div className="flex flex-col gap-3 min-w-[140px]">
                                                <button
                                                    ...
                                                    className="w-full py-4 bg-emerald-600 text-text-primary rounded-2xl font-bold uppercase tracking-widest text-[10px] hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-100 disabled:opacity-50"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    disabled={processingRequest === request.id}
                                                    className="w-full py-4 bg-surface-elevated border border-border-default text-text-tertiary rounded-2xl font-bold uppercase tracking-widest text-[10px] hover:bg-surface-tertiary transition-all disabled:opacity-50"
                                                >
                                                    {processingRequest === request.id ? (
                                                        <Loader2 className="w-4 h-4 animate-spin mx-auto" />
                                                    ) : (
                    ...
                    <div>
                        ...
                        {approvedConnections.length === 0 ? (
                            <div className="bg-surface-tertiary border border-dashed border-border-default rounded-3xl p-8 text-center">
                                <p className="text-text-tertiary text-sm">No approved connections yet.</p>
                            </div>
                        ) : (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {approvedConnections.map(connection => (
                                    <div key={connection.id} className="bg-surface-elevated border border-border-default rounded-2xl p-4 flex items-center justify-between">
            ...
            {/* Invite Modal */}
            {showInviteModal && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-6 bg-surface-secondary/40 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="max-w-lg w-full bg-surface-elevated rounded-[3rem] p-12 shadow-2xl animate-in zoom-in-95 duration-200 relative">
                        <button
                            onClick={() => setShowInviteModal(false)}
                            className="absolute top-8 right-8 p-2 text-text-tertiary hover:text-text-primary transition-all"
                        >
                            <X className="h-6 w-6" />
                        </button>
                        ...
                        <div className="text-center mb-10">
                            ...
                            <h2 className="text-3xl font-black text-text-primary tracking-tight">Expand Your Team</h2>
                            <p className="text-text-tertiary font-medium mt-2">Generate a unique onboarding link for your promoter.</p>
                        </div>
                        ...
                        {!inviteLink ? (
                            <form onSubmit={handleInvite} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-14 bg-surface-tertiary border border-border-default rounded-2xl px-6 text-sm font-bold focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all"
                                ...
                                <button
                                    disabled={loading}
                                    type="submit"
                                    className="w-full h-14 bg-surface-secondary text-text-primary rounded-2xl font-bold uppercase tracking-widest text-xs hover:bg-surface-tertiary transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                                >
                            ...
                            <div className="space-y-8">
                                <div className="p-8 bg-emerald-50 rounded-3xl border border-emerald-100 text-center">
                                    <div className="h-12 w-12 bg-surface-elevated rounded-2xl flex items-center justify-center text-emerald-600 mx-auto mb-4 border border-emerald-100 shadow-sm">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-2 p-4 bg-surface-tertiary border border-border-default rounded-2xl">
                                        <input
                                            readOnly
                                            value={inviteLink}
                                        ...
                                        <button
                                            ...
                                            className={`p-2 rounded-xl transition-all ${copied ? 'bg-emerald-600 text-text-primary' : 'bg-surface-elevated border border-border-default text-text-tertiary hover:text-text-primary'}`}
                                        >
                                ...
                                <button
                                    onClick={() => setShowInviteModal(false)}
                                    className="w-full h-14 border border-border-default text-text-primary rounded-2xl font-bold uppercase tracking-widest text-[10px] hover:bg-surface-tertiary transition-all"
                                >
                                    Done
                                </button>
                            </div>
