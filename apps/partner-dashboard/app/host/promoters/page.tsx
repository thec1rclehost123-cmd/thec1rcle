...
export default function PromotersPage() {
  ...
  useEffect(() => {
    ...
    const q = query(collection(db, "promoters"), where("associatedHostId", "==", hostId));
            ...
            {!inviteLink ? (
              ...
              <div className="space-y-8">
                <div className="p-8 bg-emerald-50 rounded-3xl border border-emerald-100 text-center">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-widest text-emerald-600/60 mt-2">
                    Valid for 7 Days
                  </p>
                </div>
