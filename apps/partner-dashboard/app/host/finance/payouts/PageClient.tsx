...
import { CheckCircle2, Banknote, ShieldCheck, Clock, ArrowLeft, Landmark } from 'lucide-react';
      ...
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
        ...
        {saved ? (
          ...
          >
            ...
            <p
              className="text-[14px] max-w-md mx-auto mb-8"
              style={{ color: 'rgba(255,255,255,0.42)' }}
            >
              Your payout bank account has been saved. Future payouts from events will be sent to
              this account.
            </p>
                ...
                >
                  ...
                  <div className="px-8 pb-8">
                    <BankSetupForm
                      ...
                      error={error}
                      submitLabel={
                        hasExisting === 'yes' ? 'Update Bank Account' : 'Save Bank Account'
                      }
