      ...
      if (authUser && authUser.email === effectiveEmail) {
        ...
        try {
          ...
          if (err.code === "auth/email-already-in-use") {
            setError(
              "This email is already registered. Please log in first, then return to complete your registry.",
            );
            setLoading(false);
            return;
          }
      ...
      <main className="max-w-xl mx-auto px-6 pb-24">
        <AnimatePresence mode="wait">
          ...
          {step === "details" && (
            ...
            >
              <div className="mb-10">
                <p className="text-label text-[var(--c1rcle-orange)] mb-2">
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-[14px] font-semibold text-[var(--state-error)] mb-2">
                        {error}
                      </p>
          ...
          {step === "success" && (
            ...
            >
              ...
              <p className="text-body text-[var(--text-secondary)] mb-10 max-w-md mx-auto">
                ...
                has been received. We'll review your details and send access credentials via email
                once approved.
              </p>
              ...
              <div className="p-6 rounded-2xl bg-[var(--surface-secondary)] border border-[var(--border-subtle)] mb-10 flex items-start gap-4 text-left">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[var(--text-tertiary)] leading-relaxed">
                    Our team typically reviews applications within 24-48 hours. You'll receive an
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <h3
            className={`text-[16px] font-semibold mb-1 ${active ? "text-white" : "text-[var(--text-primary)]"}`}
          >
            {title}
          </h3>
          <p
            className={`text-[13px] leading-relaxed ${active ? "text-white/60" : "text-[var(--text-tertiary)]"}`}
          >
            {description}
          </p>
        </div>
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative group">
        ...
        <input
          className={`w-full bg-[var(--surface-secondary)] border border-[var(--border-subtle)] rounded-xl text-[14px] text-[var(--text-primary)] placeholder:text-[var(--text-placeholder)] transition-all outline-none ${
