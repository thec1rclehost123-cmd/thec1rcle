      ...
      >
        ...
        {status.message && (
          <motion.div
            ...
            className={`mb-6 relative overflow-hidden rounded-2xl border px-4 py-3 text-[13px] font-semibold text-center backdrop-blur-md ${
              status.type === 'error'
                ? 'border-orange-500/30 bg-orange-500/10 text-orange-500 shadow-[0_0_20px_rgba(249,115,22,0.15)]'
        ...
        <div className="glass-panel overflow-hidden rounded-[32px] border border-white/10 bg-white/5 p-8 backdrop-blur-2xl shadow-2xl">
          <div className="space-y-4">
            ...
            <div className="relative my-8 flex items-center py-2">
              ...
              <span className="mx-4 flex-shrink text-[10px] uppercase tracking-[0.3em] text-white/20 font-bold">
                or
              </span>
              <div className="flex-grow border-t border-white/5"></div>
            </div>
