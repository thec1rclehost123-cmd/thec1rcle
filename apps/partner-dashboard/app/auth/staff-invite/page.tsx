...
function StaffInviteContent() {
    ...
    const [inviteInfo, setInviteInfo] = useState<{ name: string; email: string; role: string; venueName: string } | null>(null);
    ...
    return (
        <div className="min-h-screen bg-[#0d0d0f] flex items-center justify-center p-4">
            <div className="max-w-sm w-full space-y-6">
                ...
                {step === "error" && (
                    <div className="rounded-2xl p-6 space-y-4 border border-red-500/20" style={{ background: "rgba(239,68,68,0.05)" }}>
                ...
                {step === "form" && inviteInfo && (
                    ...
                    >
                        {/* Invite summary */}
                        <div>
                            <p className="text-[12px] text-white/40 uppercase tracking-widest font-bold mb-2">Invitation</p>
                        ...
                        <form onSubmit={handleAccept} className="space-y-4">
                            <div>
                                <p className="text-[11px] text-white/40 uppercase tracking-widest font-bold mb-1">Email</p>
