            ...
            {type && p && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        style={{ background: type === "venue" ? "rgba(244,74,34,0.22)" : p.blob, filter: type === "venue" ? "blur(60px)" : "blur(80px)", width: type === "venue" ? 420 : 500, height: type === "venue" ? 420 : 500, top: "50%", left: "50%", x: "-50%", y: "-50%" }}
                        animate={type === "venue"
                            ? { scale: [1, 1.15, 1], opacity: [0.7, 1, 0.7] }
                            : type === "host"
                            ? { x: ["-50%", "-40%", "-60%", "-50%"], y: ["-50%", "-60%", "-40%", "-50%"], scale: [1, 1.1, 1] }
                    ...
                    {[0, 120, 240].map((deg, i) => (
                        <motion.div key={i}
                            className="absolute"
                            style={{
                                width: 340 + i * 80, height: 340 + i * 80,
...
function LoginForm() {
    ...
    const ringColors = [
        ...
        userType === "venue" ? "rgba(244,74,34,VAL)"  : userType === "promoter" ? "rgba(34,197,94,VAL)" : "rgba(255,255,255,VAL)",
    ...
    }, [user, authLoading, isApproved, profile, onboardingStatus, router, userType, searchParams, step]);
                ...
                {[
                    ...
                    return (
                        <motion.div
                            ...
                            transition={{ duration: dur, delay: delay * 0.25, repeat: Infinity, ease: "easeInOut", times: [0, 0.1, 0.85, 1] }}
                        />
                    );
                })}
                        ...
                        {step === "select" ? (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-body text-[var(--text-secondary)]">Select your workspace to continue.</p>
                                </div>
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    {(["venue", "host", "promoter"] as UserType[]).map((type) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <Icon className={`h-6 w-6 mx-auto mb-3 transition-colors ${isActive ? "text-[var(--accent-primary)]" : "text-[var(--text-tertiary)] group-hover:text-[var(--text-secondary)]"}`} />
                                                <p className={`text-[13px] font-semibold transition-colors ${isActive ? "text-[var(--accent-primary)]" : "text-[var(--text-secondary)]"}`}>
                                                    {config.label}
                                                </p>
                                                <p className={`text-[11px] mt-1 transition-colors ${isActive ? "text-[var(--accent-primary)]/70" : "text-[var(--text-tertiary)]"}`}>
                                                    {config.description}
                                                </p>
                                            </button>
                                        );
