      ...
      <div className="relative overflow-hidden p-6 rounded-[2rem] bg-text-primary text-text-inverse border border-border-default shadow-sm group">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="text-[11px] font-black tracking-[0.2em] text-text-inverse uppercase">
              C1RCLE PRO
            </h4>
          </div>
...
function QuickLink({ icon: Icon, label, href }: { icon: any; label: string; href: string }) {
  return (
    <Link
      href={href}
      className="flex flex-col items-center justify-center p-5 rounded-2xl bg-surface-elevated border border-border-subtle hover:border-accent-primary transition-all group"
    >
