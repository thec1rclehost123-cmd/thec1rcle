      ...
      actions={
        <div className="flex items-center gap-2">
          ...
          <div
            ...
            style={{ background: 'var(--v-hero)', border: '1px solid var(--v-border)' }}
          >
            <button
        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div
                key={i}
                className="rounded-2xl p-4 flex items-center gap-3 border border-border-subtle"
        ...
        <>
          ...
          <BentoCard padding="sm" header={<span className="v-label">FLOOR STATUS</span>}>
            <div className="divide-y" style={{ borderColor: 'var(--v-border)' }}>
              {tables.map((table) => {
                const booking = eventTableStatus?.bookings?.find(
                  (b: any) => b.tableId === table.id,
                );
    ...
    >
      ...
      >
            ...
            >
              <div
                ...
                style={{
                  ...
                  left: formData.isActive ? 'calc(100% - 20px)' : '4px',
                }}
              />
            </button>
            <span
        ...
        <div
          ...
          style={{ borderTop: '1px solid var(--v-border)', background: 'var(--v-hero)' }}
        >
          <button
            onClick={onClose}
