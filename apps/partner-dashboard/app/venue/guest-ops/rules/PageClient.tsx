        ...
        <div className="max-w-2xl space-y-6">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-[15px] font-semibold text-[var(--v-text-primary)]">
                Guest Rules
              </h2>
            </div>
            {isDirty && canEdit && (
            ...
            <>
              ...
              <RulesSection title="Entry Policies">
                ...
                {draftRules.entryCutoffEnabled && (
                  <div className="pl-4">
                    <label className="block text-[11px] text-[var(--v-text-muted)] mb-1">
                      Cutoff Time
                    </label>
                    <input
                      type="time"
                    ...
                    <>
                      <div className="flex items-center gap-3 px-4 py-3">
                        <div className="flex-1">
                          <div className="text-[13px] font-medium text-[var(--v-text-primary)]">
                            PII Level
                          </div>
                          <div className="text-[11px] text-[var(--v-text-muted)]">
                            What personal data is included in exports
                          </div>
                        </div>
                        <select
                          ...
                          onChange={(e) =>
                            updateDraft(
                              'exportPiiLevel',
                              e.target.value as GuestRules['exportPiiLevel'],
                            )
                          }
                          disabled={!canEdit}
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-[14px] font-semibold text-[var(--v-text-primary)]">
                    Allocations
                  </h3>
                  {allocLoading && (
                    <Loader2 size={12} className="animate-spin text-[var(--v-text-muted)]" />
                  )}
                </div>
                ...
                {allocations.length === 0 ? (
                  ...
                  >
                    ...
                    {allocations.map((alloc, i) => (
                      ...
                      >
                        <div>
                          <div className="font-medium text-[var(--v-text-primary)]">
                            {alloc.name}
                          </div>
                          <div className="text-[11px] text-[var(--v-text-muted)]">
                        ...
                        <div className="text-center font-bold text-[var(--v-text-primary)] tabular-nums">
                          {alloc.allocatedCount}
                        </div>
                        <div className="text-center font-bold text-green-600 dark:text-green-400 tabular-nums">
                          {alloc.usedCount}
                        </div>
                        <div
                          className={cn(
              ...
              {rules.updatedAt && (
                <p className="text-[11px] text-[var(--v-text-muted)]">
                  Last updated{' '}
                  {new Date(rules.updatedAt).toLocaleString('en-IN', {
                    month: 'short',
                    day: 'numeric',
                    hour: '2-digit',
                    minute: '2-digit',
...
function RulesSection({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div>
      <div className="text-[12px] font-semibold text-[var(--v-text-muted)] uppercase tracking-wide mb-2">
        {title}
      </div>
      <div
...
function ToggleRow({
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3" style={{ background: 'var(--v-card)' }}>
      <div className="flex-1">
        ...
        >
          {Array.from({ length: 3 }).map((_, j) => (
            ...
            >
              ...
              <div
                className="w-10 h-5.5 bg-[var(--v-elevated)] rounded-full"
                style={{ height: '22px' }}
              />
            </div>
          ))}
