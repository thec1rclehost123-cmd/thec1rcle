            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="space-y-6">
                    <div className="bg-surface-elevated rounded-3xl border border-border-subtle p-6 shadow-sm">
                        <h3 className="text-[11px] font-black text-text-tertiary uppercase tracking-[0.2em] mb-6 px-2">Menu Sections</h3>
                ...
                <div className="lg:col-span-3 space-y-6">
                    <div className="bg-surface-elevated rounded-[2.5rem] border border-border-subtle shadow-sm overflow-hidden">
                        <div className="p-8 border-b border-slate-50 flex items-center justify-between bg-surface-tertiary/30">
                            <div>
                                <h2 className="text-xl font-black text-text-primary capitalize tracking-tight">{activeSection} Items</h2>
                                <p className="text-text-tertiary text-xs font-medium mt-1 uppercase tracking-widest">Manage prices and availability</p>
                            </div>
                        ...
                        <div className="divide-y divide-slate-50">
                            {[
                                ...
                                <div key={idx} className="p-6 flex items-center justify-between group hover:bg-surface-tertiary/50 transition-all">
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            <h4 className="text-sm font-bold text-text-primary flex items-center gap-3">
                                                {item.name}
                                                {!item.available && (
                                                    <span className="px-2 py-0.5 bg-surface-secondary rounded text-[9px] text-text-tertiary uppercase tracking-tighter">Out of Stock</span>
                                                )}
                                            </h4>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className={`w-10 h-5 rounded-full relative transition-colors cursor-pointer ${item.available ? "bg-green-500" : "bg-surface-tertiary"}`}>
                                            <div className={`absolute top-0.5 w-3.5 h-3.5 bg-surface-elevated rounded-full shadow-sm transition-all ${item.available ? "left-5.5" : "left-0.5"}`} />
                                        </div>
                                    </div>
                                </div>
                            ))}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="p-6 bg-surface-elevated rounded-3xl border border-border-subtle shadow-sm">
                            <p className="text-[10px] font-black text-text-tertiary uppercase tracking-widest mb-2">Most Popular</p>
                            <p className="text-lg font-bold text-text-primary tracking-tight">Mutton Kheema</p>
                        </div>
                        <div className="p-6 bg-surface-elevated rounded-3xl border border-border-subtle shadow-sm">
                            <p className="text-[10px] font-black text-text-tertiary uppercase tracking-widest mb-2">Veg Mix</p>
                        ...
                        <div className="p-6 bg-surface-elevated rounded-3xl border border-border-subtle shadow-sm group cursor-pointer hover:border-emerald-200 transition-all">
                            <p className="text-[10px] font-black text-text-tertiary uppercase tracking-widest mb-2">Storefront Sync</p>
