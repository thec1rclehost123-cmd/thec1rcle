  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tight">Gate & Security</h1>
            ...
            <div className="p-10 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-50/30">
              <div>
                ...
                <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1">
                  Local override & validation terminal
                </p>
              </div>
            ...
            <div className="flex-1 overflow-auto px-6">
              <table className="w-full text-left border-collapse">
                <thead className="sticky top-0 z-10 bg-white/80 backdrop-blur-md">
                  <tr>
                    ...
                    <th className="px-6 py-8 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-right">
                      Verification
                    </th>
                  </tr>
                </thead>
                    ...
                    <tr key={guest.id} className="hover:bg-slate-50/50 transition-all group">
                      <td className="px-6 py-6">
                        <div className="flex flex-col">
                          <span className="font-extrabold text-slate-900 text-sm group-hover:translate-x-1 transition-transform">
              ...
              {filteredGuests.length === 0 && (
                <div className="py-32 text-center">
                  ...
                  <p className="font-black text-slate-200 uppercase tracking-[0.2em] text-sm">
