                ...
                {entries.length === 0 ? (
                    ...
                    <div className="overflow-x-auto">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: "var(--v-text-muted)" }}>Contact</span>
                            <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: "var(--v-text-muted)" }}>Email</span>
                            <span className="text-[10px] font-bold uppercase tracking-widest text-center" style={{ color: "var(--v-text-muted)" }}>Gender</span>
                            ...
                            <AnimatePresence initial={false}>
                                {entries.map((entry, i) => (
                                    ...
                                    >
                                        ...
                                        <p className="text-[12px] truncate" style={{ color: "var(--v-text-secondary)" }}>
                                            {entry.email || "—"}
                                        </p>
                                        ...
                                        <p className="text-[12px] tabular-nums text-center" style={{ color: "var(--v-text-secondary)" }}>
                                            {entry.age > 0 ? entry.age : "—"}
                                        </p>
                                        <p className="text-[11px] tabular-nums text-center" style={{ color: "var(--v-text-muted)" }}>
