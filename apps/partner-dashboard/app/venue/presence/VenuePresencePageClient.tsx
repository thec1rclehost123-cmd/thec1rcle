  ...
  if (isError) {
    return (
      <div className="py-24 flex flex-col items-center justify-center gap-4">
        ...
        <p className="font-semibold text-sm" style={{ color: 'var(--v-text-secondary)' }}>
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-6 px-8 pt-8 pb-7 relative">
          ...
          <div
            onClick={() => {
              setPhotoModal({ field: 'photoURL', currentUrl: data?.profile?.photoURL || '' });
              setPhotoInputUrl(data?.profile?.photoURL || '');
            }}
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[13px] mt-2" style={{ color: 'rgba(255,255,255,0.45)' }}>
              {data?.profile?.tagline ||
                'Curate how your public profile appears to guests and partners.'}
            </p>
          </div>
          ...
          <div className="w-full max-w-[280px] space-y-3 flex-shrink-0">
            <button
              ...
              style={{
                background: isPublicProfileEnabled
                  ? 'rgba(255,255,255,0.08)'
                  : 'rgba(255,255,255,0.04)',
                borderColor: isPublicProfileEnabled
                  ? 'rgba(244,74,34,0.35)'
            ...
            >
              <div className="mb-2 flex items-center justify-between gap-3">
                ...
                <span
                  ...
                  style={{
                    background: isPublicProfileEnabled ? '#F44A22' : 'rgba(255,255,255,0.14)',
                  }}
                >
                  <span
                    className="h-4 w-4 rounded-full bg-white transition-transform"
                    style={{
                      transform: isPublicProfileEnabled ? 'translateX(20px)' : 'translateX(0px)',
                    }}
                  />
                </span>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4">
          {[
            {
              value: data?.stats?.followersCount || 0,
              label: 'Followers',
              icon: Users,
              color: '#818CF8',
            ...
            <button
              ...
              style={
                isActive
                  ? {
                      background:
                        'linear-gradient(135deg, rgba(244,74,34,0.18) 0%, rgba(244,74,34,0.08) 100%)',
            ...
            {activeTab === 'identity' && (
              ...
              >
                ...
                <section className="space-y-5">
                  <SectionHeader
                    title="Core Identity"
                    subtitle="The fundamentals of your public presence"
                  />
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <FormField
                      ...
                      onSave={(v: string) => handleUpdateProfile({ displayName: v })}
                    />
                    <FormField
                      label="Tagline"
                      placeholder="A one-liner that defines you"
                      defaultValue={data?.profile?.tagline}
                      onSave={(v: string) => handleUpdateProfile({ tagline: v })}
                    />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div className="space-y-2">
                      ...
                      <FormField
                        ...
                        onSave={(v: string) => handleUpdateProfile({ neighborhood: v })}
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[11px] font-bold text-text-tertiary uppercase tracking-widest">
                  ...
                  <FormField
                    ...
                    onSave={(v: string) => handleUpdateProfile({ bio: v })}
                    multiline
                    rows={5}
                  />
                          ...
                          <button
                            ...
                            style={
                              isActive
                                ? {
                                    background:
                                      'linear-gradient(135deg, var(--c1rcle-orange), #FF6B4A)',
                                    color: '#fff',
                ...
                >
                  <SectionHeader
                    title="Action Layer"
                    subtitle="Configure primary call-to-action buttons for your page"
                    icon={Zap}
                  />
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <FormField
                ...
                >
                  <SectionHeader
                    ...
                    subtitle="Cover image for your public page"
                  />
                  <div
                    onClick={() => {
                      setPhotoModal({ field: 'coverURL', currentUrl: data?.profile?.coverURL });
                      setPhotoInputUrl(data?.profile?.coverURL || '');
                    }}
                    ...
                    style={{
                      background:
                        'linear-gradient(135deg, var(--v-elevated) 0%, var(--v-card) 100%)',
                  ...
                  >
                    <div className="flex flex-col items-center gap-4">
                      <div
                        ...
                        style={{
                          background: 'rgba(244,74,34,0.10)',
                ...
                >
                  <SectionHeader
                    title="Sound & Style"
                    subtitle="Help guests discover you by genre and vibe"
                    icon={Music}
                  />
                ...
                >
                  <SectionHeader
                    ...
                    subtitle="Connect your channels and let fans find you everywhere"
                    icon={Link2}
                  />
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                    <FormField
                      ...
                      onSave={(v: string) =>
                        handleUpdateProfile({
                          socialLinks: { ...data?.profile?.socialLinks, instagram: v },
                        })
                      }
                    />
                    <FormField
                      ...
                      onSave={(v: string) =>
                        handleUpdateProfile({
                          socialLinks: { ...data?.profile?.socialLinks, twitter: v },
                        })
                      }
                    />
                    <FormField
                      ...
                      onSave={(v: string) =>
                        handleUpdateProfile({
                          socialLinks: { ...data?.profile?.socialLinks, soundcloud: v },
                        })
                      }
                    />
                    <FormField
                      ...
                      onSave={(v: string) =>
                        handleUpdateProfile({
                          socialLinks: { ...data?.profile?.socialLinks, spotify: v },
                        })
                      }
                    />
                    <FormField
              ...
              >
                ...
                <section className="space-y-5">
                  <div className="flex items-center justify-between">
                    <SectionHeader
                      ...
                      subtitle="Share news, announcements, and behind-the-scenes"
                    />
                    <button
                ...
                >
                  <div className="flex items-center justify-between">
                    <SectionHeader
                      ...
                      subtitle="Pin your best moments to the top of your page"
                      icon={Camera}
                    />
                    <button
                ...
                >
                  <SectionHeader
                    ...
                    subtitle="Showcase media mentions and press coverage"
                    icon={Quote}
                  />
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {data?.profile?.pressSnippets?.map((snippet: any, idx: number) => (
                      <div
                        key={idx}
                        className="p-5 bg-surface-secondary/50 rounded-xl border border-border-subtle"
                      >
              ...
              >
                ...
                <section className="space-y-5">
                  <div className="flex items-center justify-between">
                    <SectionHeader
                      title="Photo Gallery"
                      subtitle="Showcase your best shots from events and performances"
                    />
                    <button
                      onClick={() => {
                        setPhotoModal({ field: 'photos', currentUrl: '' });
                        setPhotoInputUrl('');
                      }}
                      className="flex items-center gap-2 px-4 py-2 bg-surface-secondary text-text-primary rounded-xl text-[10px] font-bold hover:bg-surface-tertiary transition-all"
                    >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
                    {data?.profile?.photos?.map((photo: string, idx: number) => (
                      <div
                        key={idx}
                        className="relative aspect-square rounded-2xl overflow-hidden border border-border-subtle group"
                      >
                        <img
                          src={photo}
                        ...
                        <button
                          onClick={() => {
                            const newPhotos = data.profile.photos.filter(
                              (p: string) => p !== photo,
                            );
                ...
                >
                  <div className="flex items-center justify-between">
                    <SectionHeader
                      ...
                      subtitle="Share recaps, aftermovies, and performance clips"
                      icon={Video}
                    />
                    <button
              ...
              >
                ...
                <section className="space-y-5">
                  <SectionHeader
                    ...
                    subtitle="Understand your community and reach"
                    icon={Users}
                  />
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <EngagementStat
                      ...
                      value={
                        data?.stats?.engagementRate != null ? `${data.stats.engagementRate}%` : '—'
                      }
                      change=""
                      positive
                    />
                ...
                <section className="space-y-6 pt-8 border-t border-border-subtle">
                  <SectionHeader
                    ...
                    subtitle="Track your audience expansion over time"
                    icon={TrendingUp}
                  />
                ...
                >
                  <SectionHeader
                    ...
                    subtitle="Who your followers are"
                    icon={Users}
                  />
                      ...
                      {[
                        ...
                        <div key={c.city} className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <span className="w-6 h-6 rounded-lg bg-surface-secondary flex items-center justify-center text-[10px] font-black text-text-tertiary">
                              {i + 1}
                            </span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div className="bg-surface-secondary/30 rounded-2xl border border-border-subtle p-6 space-y-4">
                      ...
                      {[
                        ...
                        <div
                          key={slot.day}
                          className="flex items-center justify-between p-3 bg-surface-secondary/30 rounded-xl"
                        >
                          <div>
              ...
              >
                <section className="space-y-6">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(135deg, rgba(99,102,241,0.15) 0%, rgba(15,15,20,0.9) 100%)',
                    ...
                    <div className="pt-6 border-t border-white/5 space-y-4">
                      <div className="flex items-center gap-3 text-accent-primary">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-[0.2em]">
                          Target: {data?.stats?.followersCount || 0} Followers
                        </span>
                      </div>
                      ...
                      {broadcastStatus === 'error' && (
                        <div className="flex items-center gap-3 py-3 px-5 bg-red-500/10 border border-red-500/20 rounded-2xl">
                          ...
                          <span className="text-[11px] font-bold text-red-300 uppercase tracking-widest">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div className="p-6 bg-surface-secondary/30 rounded-2xl border border-border-subtle">
                      <h4 className="text-[10px] font-bold text-text-primary mb-2 uppercase tracking-widest">
                        Auto-Broadcasts
                      </h4>
          ...
          <Modal onClose={() => setPhotoModal(null)}>
            <div className="p-6">
              ...
              <p className="text-text-tertiary text-xs mb-5">
                Upload a new{' '}
                {photoModal.field === 'photoURL'
                  ? 'profile photo'
                  : photoModal.field === 'coverURL'
                    ? 'cover image'
                    : 'gallery photo'}
              </p>
              ...
              <div className="flex gap-3 mt-5">
                <button
                  ...
                  className="flex-1 py-2.5 bg-surface-secondary text-text-secondary rounded-xl text-xs font-bold hover:bg-surface-elevated transition-all"
                >
                  Cancel
                </button>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <FormField
                  ...
                  onChange={(v: string) => setNewVideo({ ...newVideo, title: v })}
                  inline
                />
                <FormField
                  label="Video URL"
                  ...
                  value={newVideo.url}
                  onChange={(v: string) => setNewVideo({ ...newVideo, url: v })}
                  inline
                />
                  ...
                  <div className="flex gap-2">
                    {['aftermovie', 'recap', 'promo', 'live'].map((type) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg text-[11px] font-bold capitalize ${
                          newVideo.type === type
              ...
              <div className="flex gap-3 mt-5">
                <button
                  ...
                  className="flex-1 py-2.5 bg-surface-secondary text-text-secondary rounded-xl text-xs font-bold"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-2.5 bg-surface-secondary text-text-primary rounded-xl text-xs font-bold disabled:opacity-50"
                >
                  Add Video
                </button>
              </div>
            ...
            <div className="flex flex-col md:flex-row max-h-[85vh]">
              ...
              <div className="w-full md:w-80 bg-surface-secondary p-6">
                ...
                <div className="bg-surface-base rounded-2xl overflow-hidden border border-border-subtle">
                  {composerImage && (
                    <img src={composerImage} className="w-full aspect-video object-cover" alt="" />
                  )}
                  <div className="p-3">
...
function QuickStat({
  ...
  // This component is replaced inline above; kept for type safety
  return null;
}
    ...
    <div className="flex items-start gap-3.5">
      {Icon && (
        <div
          ...
          style={{ background: 'rgba(244,74,34,0.10)', border: '1px solid rgba(244,74,34,0.18)' }}
        >
          <Icon className="w-3.5 h-3.5" style={{ color: 'var(--c1rcle-orange)' }} />
        </div>
      )}
      <div>
        <h3 className="text-[15px] font-bold" style={{ color: 'var(--v-text-primary)' }}>
          {title}
        </h3>
...
function FormField({
  ...
  const inputClasses =
    'w-full px-4 py-3 rounded-xl text-sm font-medium focus:outline-none transition-all';
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        {Icon && (
          <Icon className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-text-tertiary" />
        )}
        {multiline ? (
          <textarea
            value={localValue}
    ...
    <div className="bg-surface-secondary/50 rounded-2xl border border-border-subtle overflow-hidden group hover:border-border-strong transition-all">
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            onClick={onDelete}
            className="p-1 text-text-placeholder hover:text-red-500 opacity-0 group-hover:opacity-100 transition-all"
          >
  ...
  return (
    <div className="flex-shrink-0 group relative">
      <div className="w-24 h-24 rounded-full border-2 border-border-strong p-1 mb-3 transition-transform group-hover:scale-105">
        <div
          className="w-full h-full rounded-full bg-surface-secondary flex items-center justify-center"
          style={{ backgroundColor: `${highlight.color}15` }}
        >
          <Camera className="w-6 h-6 text-text-tertiary" />
        </div>
      </div>
      <p className="text-[11px] font-bold text-text-secondary text-center truncate w-24">
        {highlight.title}
      </p>
      <button
        onClick={onDelete}
...
function EngagementStat({
  ...
  return (
    <div className="p-3 bg-surface-secondary/50 rounded-xl border border-border-subtle">
      <p className="text-[9px] font-bold text-text-tertiary uppercase tracking-widest mb-1">
        {label}
      </p>
      <p className="text-xl font-bold text-text-primary mb-0.5">
        {typeof value === 'number' ? formatNumber(value) : value}
      </p>
      <span className={`text-[9px] font-bold ${positive ? 'text-emerald-500' : 'text-red-500'}`}>
        {change}
      </span>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 hover:bg-surface-secondary rounded-xl z-10"
        >
