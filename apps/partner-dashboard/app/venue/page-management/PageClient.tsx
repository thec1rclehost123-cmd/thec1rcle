...
const EnhancedVenueEditor = dynamic(
    ...
    { ssr: false, loading: () => <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4"><Loader2 className="w-10 h-10 animate-spin text-[var(--c1rcle-orange)]" /><p className="text-sm font-bold uppercase tracking-widest text-[var(--text-tertiary)]">Initializing Editor Engine...</p></div> }
);
