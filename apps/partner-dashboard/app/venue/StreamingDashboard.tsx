...
async function fetchOrdersPage(token: string, venueId: string, page: number, limit: number) {
...
export default function VenueDashboardStreaming() {
  ...
  const warnings = summaryQuery.data?.warnings || [];
  ...
  return (
    <div className="pt-[3px] lg:pt-[6px]">
      <VenuePageShell title="Overview" noPadding>
        {warnings.length > 0 && (
          <motion.div
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[12px] text-zinc-400 mt-1">
                  Your venue profile has active compliance warnings from the platform
                  administration. Please ensure compliance to prevent account restriction or feature
                  lock.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                {!canViewOrders ? (
                  ...
                  >
                    ...
                    >
                      This graph is built from cross-event venue orders, so it only appears for
                      roles with guestlist access.
                    </p>
                  </div>
