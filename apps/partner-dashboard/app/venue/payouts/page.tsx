    ...
    <div className="max-w-[1400px] mx-auto space-y-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-slate-400 text-sm font-medium mt-2 uppercase tracking-widest">
            Tracking your earnings and bank transfers
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="btn btn-primary">Settlement Help</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-900 p-8 rounded-[2.5rem] text-white">
          <p className="text-[10px] font-bold opacity-40 uppercase tracking-[0.2em] mb-4">
            Current Balance
          </p>
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-4 py-2 bg-slate-50 border-none rounded-xl text-[11px] font-medium w-48 focus:ring-1 focus:ring-indigo-100 outline-none"
              />
            </div>
          </div>
        </div>
