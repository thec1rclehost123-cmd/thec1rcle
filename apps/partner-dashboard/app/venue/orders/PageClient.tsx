                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex h-12 items-center gap-2 rounded-full bg-[var(--v-elevated)] border border-[var(--v-border)] px-5 transition-all hover:border-[var(--v-border-strong)]">
                            <span className="text-[10px] font-black uppercase tracking-widest text-[var(--v-text-tertiary)]">Event</span>
                            <select
                                value={eventId}
                                onChange={(e) => {
                ...
                {ordersQuery.isLoading ? (
                    ...
                    <div className="dashboard-empty-state min-h-[300px] rounded-[32px] border border-dashed border-[var(--v-border)] bg-[var(--v-card)]">
                        <div className="text-center">
                            ...
                            <h3 className="text-lg font-semibold text-[var(--v-text-primary)]">No orders matched</h3>
                            <p className="text-sm text-[var(--v-text-tertiary)]">Try adjusting your filters or search query.</p>
                        </div>
                    </div>
                ) : (
                    orders.map((order) => (
