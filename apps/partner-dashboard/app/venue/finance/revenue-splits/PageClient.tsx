  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[11px] mt-0.5" style={{ color: 'var(--v-text-tertiary)' }}>
          {sublabel}
        </p>
      </div>
      <p
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div>
          ...
          <p className="text-[12px] mt-0.5" style={{ color: 'var(--v-text-secondary)' }}>
            Once active, every ticket sale automatically routes funds to the right wallets — no
            manual settlement needed. Splits are configured per event.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <p className="text-[11px] mt-4" style={{ color: 'var(--v-text-tertiary)' }}>
          * Example uses placeholder values. Actual splits are configured per event at the time of
          ticket tier setup.
        </p>
      </div>
