...
import { Settings, Lock, UserCircle } from 'lucide-react';
...
function TabContent({
  ...
  switch (activeTab) {
    case 'profile':
      return <VenueProfileClient setActions={setActions} />;
    case 'general':
      return <GeneralClient setActions={setActions} />;
    case 'security':
      return <SecurityClient setActions={setActions} />;
    default:
      return <VenueProfileClient setActions={setActions} />;
  }
}
