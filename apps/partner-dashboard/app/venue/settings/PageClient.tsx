...
export default function VenueSettingsClient({
  ...
  return (
    <div className="space-y-8">
      <div className="inline-flex rounded-[24px] border border-[var(--v-border)] bg-[var(--v-card)] p-2 shadow-[0_20px_60px_rgba(0,0,0,0.18)]">
        {TABS.map((tab) => (
          ...
          >
            <tab.icon
              size={18}
              className={activeTab === tab.id ? 'text-[var(--c1rcle-orange)]' : ''}
            />
            {tab.label}
          </button>
        ))}
      ...
      <BentoCard
        padding="lg"
        className="overflow-visible border-[var(--v-border)] shadow-[0_30px_90px_rgba(0,0,0,0.2)]"
      >
            ...
            {activeTab === 'general' ? (
              <>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <Field
                    label="Admin Email"
                    description="Used for internal alerts and account follow-up."
                  >
                    <input
                      type="email"
                  ...
                  <Field
                    ...
                    description="Shown to staff or guests when support is needed."
                  >
                    <input
              ...
              <>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <Field
                    ...
                    description="How often your payouts should be grouped."
                  >
                    <select
                      ...
                      onChange={(event) =>
                        patch((current) => ({
                          ...current,
                          settlementCadence: event.target
                            .value as VenueSettings['settlementCadence'],
                        }))
                      }
                      className={inputClassName()}
                    >
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div className="rounded-[30px] border border-[var(--v-border)] bg-[var(--v-elevated)] p-7">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-[var(--v-text-secondary)]">
                      Record when your main venue password was last updated so the team can keep it
                      fresh.
                    </p>
                    <input
                      type="datetime-local"
                  ...
                  <div className="rounded-[30px] border border-[var(--v-border)] bg-[var(--v-elevated)] p-7">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-[var(--v-text-secondary)]">
                          Toggle this on when you want an extra verification step for critical
                          access.
                        </p>
                      </div>
                    </div>
