...
export default function VenueSettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "general" | "ticketing" | "payouts" | "notifications" | "security"
  >("general");
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-slate-400 text-sm font-medium mt-2 uppercase tracking-widest">
            Manage your venue's technical & operational core
          </p>
        </div>
        ...
        <AnimatePresence mode="wait">
          {activeTab === "general" && (
            ...
            >
              <SectionHeader
                ...
                subtitle="Primary identity and contact settings"
                icon={Building2}
              />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <FormGroup
                  ...
                  description="Used for technical alerts and billing."
                >
                ...
                <FormGroup
                  ...
                  description="Primary language for customer comms."
                >
                  <select className="form-input">
          ...
          {activeTab === "ticketing" && (
            ...
            >
              <SectionHeader
                title="Taxation & Fees"
                subtitle="Manage how fees and taxes are calculated"
                icon={Percent}
              />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <FormGroup
                  label="Platform Fee Strategy"
                  description="How the platform fee is displayed."
                >
                  <select className="form-input">
              ...
              <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-4">
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Ensure your GST number is correctly updated in{" "}
                  <b>Page Presence &gt; Business Details</b>. All invoices generated by C1RCLE will
                  use these settings for calculating settlements.
                </p>
              </div>
            </motion.div>
          )}
          ...
          {activeTab === "payouts" && (
            ...
            >
              <SectionHeader
                ...
                subtitle="Manage bank accounts and payout cycles"
                icon={CreditCard}
              />
          ...
          {activeTab === "notifications" && (
            ...
            >
              <SectionHeader
                ...
                subtitle="Select what you want to be alerted about"
                icon={Bell}
              />
              ...
              <div className="space-y-4">
                <ToggleItem
                  ...
                  description="Receive email & push for every table request."
                  defaultChecked
                />
                <ToggleItem
                  title="Ticket Sales"
                  description="Instant alert for high-value ticket purchases."
                  defaultChecked
                />
                <ToggleItem
                  title="Host/Promoter Requests"
                  description="Alert when partners want to collaborate."
                  defaultChecked
                />
                <ToggleItem
                  title="Revenue Summaries"
                  description="Daily digest of your venue's earnings."
                />
                <ToggleItem
                  title="Marketing Broadcasts"
                  description="Updates about new C1RCLE features."
                />
              </div>
            </motion.div>
          )}
          ...
          {activeTab === "security" && (
            ...
            >
              <SectionHeader
                ...
                subtitle="Protect your venue dashboard account"
                icon={Shield}
              />
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-white/40 font-medium uppercase tracking-widest mt-0.5">
                          Secure your login with TOTP
                        </p>
                      </div>
                    </div>
                    <button className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">
                      Enable 2FA
                    </button>
                  </div>
                </div>
