        ...
        <div className="max-w-[1600px] mx-auto space-y-10 pb-20 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[var(--text-tertiary)]">Operating • Live System</span>
                    </div>
                    <h1 className="text-4xl font-black text-[var(--text-primary)] tracking-tight">At a glance.</h1>
                </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className="xl:col-span-2 space-y-6">
                    <div className="bg-[var(--surface-primary)] border border-[var(--border-subtle)] rounded-[2.5rem] overflow-hidden shadow-sm">
                        <div className="p-10">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                                <div>
                                    <h2 className="text-2xl font-black mb-1">Tonight's Reality</h2>
                                    <p className="text-sm text-[var(--text-tertiary)] font-medium">Monitoring real-time performance of your venue.</p>
                                </div>
                                {tonight ? (
                                    <div className="px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                                        <div className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" />
                                        Live: {tonight.checkedIn} In
                                    </div>
                                ) : (
                                    <div className="px-4 py-2 rounded-full bg-[var(--surface-secondary)] border border-[var(--border-subtle)] text-[var(--text-tertiary)] text-[10px] font-black uppercase tracking-widest">
                                        No Event Tonight
                                    </div>
                                )}
                            </div>
                            ...
                            {tonight ? (
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <TonightStat label="Tickets" value={tonight.ticketsSold} sub="Inventory Cleared" progress={100} color="indigo" />
                                    </div>
                                    <div className="flex flex-col justify-between">
                                        ...
                                        >
                                            <div>
                                                <p className="text-[10px] font-black uppercase tracking-widest text-[var(--text-tertiary)] mb-0.5">Control Center</p>
                                                <p className="font-bold text-sm">Entry Console</p>
                                            </div>
                    ...
                    <div className="bg-[var(--surface-primary)] border border-[var(--border-subtle)] rounded-[2.5rem] p-10 shadow-sm">
                        <div className="flex items-center justify-between mb-8">
                            <h2 className="text-2xl font-black">Upcoming Schedule</h2>
                ...
                <div className="space-y-8">
                    {/* Ops Queue */}
                    <div className="bg-[var(--surface-primary)] border border-[var(--border-subtle)] rounded-[2.5rem] p-8 shadow-sm h-fit">
                        <h3 className="text-xl font-black mb-6">Operations Queue</h3>
                    ...
                    <div className="p-8 rounded-[2.5rem] bg-[var(--text-primary)] text-[var(--surface-primary)] relative overflow-hidden">
...
function MetricCard({ label, value, trend, icon: Icon, color }: any) {
    ...
    return (
        <div className="bg-[var(--surface-primary)] border border-[var(--border-subtle)] p-8 rounded-[2.5rem] shadow-sm hover:shadow-md transition-all group">
