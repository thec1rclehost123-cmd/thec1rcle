...
export default function VenueError({
  ...
  useEffect(() => {
    console.error('[Venue] Runtime error:', error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6 text-center bg-[#030303]">
      <div className="max-w-md w-full">
        ...
        <h1 className="text-xl font-bold text-white mb-2">Venue Workspace Error</h1>
        <p className="text-zinc-400 text-sm mb-8 leading-relaxed">
          An error occurred in the venue dashboard. The issue has been logged.
        </p>
        ...
        <button
          ...
          className="mt-6 text-zinc-500 hover:text-white text-[11px] font-medium uppercase tracking-widest transition-colors"
        >
