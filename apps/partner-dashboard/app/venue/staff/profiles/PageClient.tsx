    ...
    >
          ...
          <div className="lg:col-span-4 space-y-2">
            {profiles.length === 0 ? (
              ...
              >
                ...
                <Link href="/venue/staff/profiles/new">
                  <button
                    className="mt-1 px-4 py-2 rounded-xl text-[12px] font-bold"
                ...
                <div className="space-y-1.5">
                  {unassignedStaff.map((s) => (
                    <div key={s.id} className="flex items-center gap-2">
                      <div
                        className="w-6 h-6 rounded-lg flex items-center justify-center text-[8px] font-black shrink-0"
            ...
            {selectedProfile ? (
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span
                        ...
                        style={{
                          background: (ROLE_COLORS[selectedProfile.baseRole] ?? ROLE_COLORS.STAFF)
                            .bg,
                          color: (ROLE_COLORS[selectedProfile.baseRole] ?? ROLE_COLORS.STAFF).text,
                        }}
                      >
                ...
                <div className="overflow-y-auto max-h-[calc(100vh-260px)]">
                  <div
                    className="grid grid-cols-1 xl:grid-cols-2 divide-y xl:divide-y-0 xl:divide-x"
                    style={{ borderColor: 'var(--v-border)' }}
                  >
                ...
                >
                  {saveError ? (
                    ...
                    <p className="text-[11px]" style={{ color: '#34d399' }}>
                      Saved — changes apply on staff's next page load
                    </p>
                  ) : (
                    <p className="text-[11px]" style={{ color: 'var(--v-text-muted)' }}>
              ...
              <div
                className="rounded-2xl border flex flex-col items-center justify-center py-16 gap-3 text-center"
                style={{ borderColor: 'var(--v-border)', background: 'var(--v-card)' }}
              >
                <Shield className="w-8 h-8" style={{ color: 'var(--v-text-muted)' }} />
      ...
      >
        <p className="text-[11px] leading-relaxed" style={{ color: 'var(--v-text-muted)' }}>
          ...
          <strong style={{ color: 'var(--v-text-secondary)' }}>base role</strong> that sets default
          access. An <strong style={{ color: 'var(--v-text-secondary)' }}>access profile</strong>{' '}
          overlays custom tab visibility, action gates, and PII rules. Changes take effect on the
          staff member's{' '}
          <strong style={{ color: 'var(--v-text-secondary)' }}>next page load</strong>.
        </p>
      </div>
    </VenuePageShell>
  );
