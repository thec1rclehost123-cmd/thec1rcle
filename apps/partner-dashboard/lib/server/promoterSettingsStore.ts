...
export async function upsertPayoutAccount(
    promoterId: string,
    fields: Partial<Pick<PromoterPayoutAccount, "bankName" | "accountNumber" | "ifsc" | "upiId" | "threshold">>,
    actor: { uid: string },
    ...
    await db
        .collection("promoter_payout_accounts")
        .doc(promoterId)
...
export async function patchPreferences(
    ...
    await db
        .collection("promoter_preferences")
        .doc(promoterId)
