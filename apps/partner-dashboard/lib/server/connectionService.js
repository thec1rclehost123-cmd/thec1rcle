...
export async function approveRequest(connectionId, type, role, partnerId, partnerName, token) {
  ...
  return promoterConnectionStore.approveConnectionRequest(
    connectionId,
...
export async function rejectRequest(
  ...
  return promoterConnectionStore.rejectConnectionRequest(
    connectionId,
    { uid: partnerId, name: partnerName, role },
    reason,
    token,
...
export async function blockRequest(
  ...
  return promoterConnectionStore.blockConnectionRequest(
    connectionId,
