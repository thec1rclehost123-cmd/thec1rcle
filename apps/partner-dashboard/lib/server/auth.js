...
export async function verifyAuth(request) {
  ...
  try {
    ...
    console.log(
      "[verifyAuth] Admin app initialized, project:",
...
export async function verifyPartnerAccess(request, partnerId) {
  ...
  try {
    ...
    if (!membershipSnapshot.empty) {
      ...
      console.log(
        `[verifyPartnerAccess] Membership found: role=${membershipData.role}, status=${membershipData.status}, isActive=${membershipData.isActive}`,
      );
