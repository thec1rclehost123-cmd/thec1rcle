...
> {
  ...
  logger.info(
    'payments/bankVerification',
    'Verification deferred until live provider credentials are added',
    {
  ...
  return {
    ...
    verificationMessage:
      'Verification provider configured. Activate the live verification call after secrets are added.',
