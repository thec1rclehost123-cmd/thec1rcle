      ...
      <View className="flex-1 bg-black/80 items-center justify-center px-6">
        <View className="bg-background-elevated w-full rounded-3xl p-6">
          ...
          <View className="items-center mb-6">
            ...
            <Text className="text-text-primary text-2xl font-bold text-center">Couple Entry</Text>
            {guestName && <Text className="text-text-secondary text-lg mt-1">{guestName}</Text>}
          </View>
