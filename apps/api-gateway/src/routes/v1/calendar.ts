      ...
      try {
        ...
        if (venueId) {
          try {
            ...
            return reply
              .status(403)
              .send({ error: 'Forbidden: Insufficient access to this venue' });
          }
        }
    ...
    async (request: any, reply) => {
      ...
      if (partnerId) {
        try {
          ...
          return reply
            .status(403)
            .send({ error: 'Forbidden: Insufficient access to this partner' });
        }
      }
      try {
