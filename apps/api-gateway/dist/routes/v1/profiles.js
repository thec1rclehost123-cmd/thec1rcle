...
export default async function profileRoutes(fastify) {
     ...
     */
    fastify.patch('/profiles', async (request, reply) => {
     ...
     */
    fastify.get('/profiles/:id/posts', async (request, reply) => {
        const { id } = request.params;
     ...
     */
    fastify.get('/profiles/:id/highlights', async (request, reply) => {
        const { id } = request.params;
     ...
     */
    fastify.post('/users/profile', async (request, reply) => {
