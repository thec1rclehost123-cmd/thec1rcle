...
export const guestApi = Object.freeze({
  auth: {
    ...
    changePassword: (body, options) => guestApiOperationJson("changeGuestPassword", { body, ...options }),
    passwordReset: (body, options) => guestApiOperationJson("requestGuestPasswordReset", { body, ...options }),
  ...
  profiles: {
    personal: (body, options) => guestApiOperationJson("updateGuestPersonalProfile", { body, ...options }),
    social: (body, options) => guestApiOperationJson("updateGuestSocialProfile", { body, ...options }),
    bio: (body, options) => guestApiOperationJson("updateGuestBioProfile", { body, ...options }),
    avatarUpdate: (body, options) => guestApiOperationJson("updateGuestAvatarProfile", { body, ...options }),
    create: (body, options) => guestApiOperationJson("createGuestProfile", { body, ...options }),
    get: (id, options) => guestApiOperationJson("getGuestPublicProfile", { params: { id }, ...options }),
    avatar: (body, options) => guestApiOperationJson("uploadGuestAvatar", { body, ...options }),
    lookup: (query = "", options) => guestApiOperationJson("lookupGuestProfile", { query, ...options }),
  },
  public: {
    events: (query = "", options) => guestApiOperationJson("listPublicEvents", { query, ...options }),
    event: (idOrSlug, options) => guestApiOperationJson("getPublicEvent", { params: { idOrSlug }, ...options }),
    hosts: (query = "", options) => guestApiOperationJson("listPublicHosts", { query, ...options }),
    venues: (query = "", options) => guestApiOperationJson("listPublicVenues", { query, ...options }),
    search: (query = "", options) => guestApiOperationJson("searchPublicDiscovery", { query, ...options }),
  },
  events: {
    view: (eventId, options) => guestApiOperationJson("recordEventView", { params: { eventId }, ...options }),
    track: (eventId, body, options) => guestApiOperationJson("trackEventInteraction", { params: { eventId }, body, ...options }),
    rsvp: (eventId, body, options) => guestApiOperationJson("setEventRsvp", { params: { eventId }, body, ...options }),
    queue: (eventId, query = "", options) => guestApiOperationJson("getEventQueue", { params: { eventId }, query, ...options }),
    joinQueue: (eventId, body, options) => guestApiOperationJson("joinEventQueue", { params: { eventId }, body, ...options }),
  },
  social: {
    followStatus: (targetId, options) => guestApiOperationJson("getFollowStatus", { query: { targetId }, ...options }),
    follow: (body, options) => guestApiOperationJson("followEntity", { body, ...options }),
    unfollow: (targetId, targetType, options) => guestApiOperationJson("unfollowEntity", { query: { targetId, targetType }, ...options }),
  },
  venues: {
    followStatus: (venueId, options) => guestApiOperationJson("getVenueFollowStatus", { params: { venueId }, ...options }),
    follow: (venueId, options) => guestApiOperationJson("followVenue", { params: { venueId }, ...options }),
    unfollow: (venueId, options) => guestApiOperationJson("unfollowVenue", { params: { venueId }, ...options }),
    reserve: (body, options) => guestApiOperationJson("createVenueReservation", { body, ...options }),
  },
  promoters: {
    trackClick: (body, options) => guestApiOperationJson("trackPromoterLinkClick", { body, ...options }),
  },
  checkout: {
    ...
    reserve: (body, options) => guestApiOperationJson("reserveCheckoutInventory", { body, ...options }),
  ...
  tickets: {
    ...
    get: (ticketId, options) => guestApiOperationJson("getGuestTicket", { params: { ticketId }, ...options }),
    share: (body, options) => guestApiOperationJson("createTicketShareBundle", { body, ...options }),
    shareBundle: (query = "", options) => guestApiOperationJson("getTicketShareBundle", { query, ...options }),
    claimShare: (body, options) => guestApiOperationJson("claimSharedTicket", { body, ...options }),
    claimPartnerSlot: (body, options) => guestApiOperationJson("claimPartnerSlot", { body, ...options }),
    assignPartner: (body, options) => guestApiOperationJson("assignPartnerTicket", { body, ...options }),
    partnerClaimLink: (body, options) => guestApiOperationJson("createPartnerClaimLink", { body, ...options }),
    transferCouple: (body, options) => guestApiOperationJson("transferCoupleTicket", { body, ...options }),
    initiateTransfer: (body, options) => guestApiOperationJson("initiateTicketTransfer", { body, ...options }),
    acceptTransfer: (body, options) => guestApiOperationJson("acceptTicketTransfer", { body, ...options }),
    cancelTransfer: (body, options) => guestApiOperationJson("cancelTicketTransfer", { body, ...options }),
    coverWallet: (query = "", options) => guestApiOperationJson("getTicketCoverWallet", { query, ...options }),
    coverChargeWallet: (walletId, options) => guestApiOperationJson("getCoverChargeWallet", { params: { walletId }, ...options }),
  },
  notifications: {
    list: (query = "", options) => guestApiOperationJson("listGuestNotifications", { query, ...options }),
    unreadCount: (options) => guestApiOperationJson("listGuestNotifications", { query: { countOnly: "true" }, ...options }),
    markAllRead: (options) => guestApiOperationJson("updateGuestNotifications", { body: { markAll: true }, ...options }),
    markRead: (id, options) => guestApiOperationJson("markGuestNotificationRead", { params: { id }, ...options }),
  },
  waitlist: {
