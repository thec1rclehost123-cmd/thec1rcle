...
const truthyBoolean = z.union([
  z.literal('1'),
  z.literal('true'),
  z.literal('yes'),
  z.literal('on'),
]);
const falsyBoolean = z.union([
  z.literal('0'),
  z.literal('false'),
  z.literal('no'),
  z.literal('off'),
...
export const guestBffErrorSchema = z
  .object({
...
export const guestBffMetaSchema = z
  .object({
    fetchedAt: z.string(),
    requestId: z.string(),
...
export const selectedTicketSchema = z
  .object({
    id: z.string().min(1),
...
export const homeOverviewQuerySchema = z
  .object({
    city: z.string().optional(),
  })
  .strict();

export const exploreFeedQuerySchema = z
  .object({
    city: z.string().optional(),
...
export const checkoutSummaryBodySchema = z
  .object({
...
export const checkoutReserveBodySchema = z
  .object({
...
export const checkoutInitiateBodySchema = z
  .object({
    linkId: z.string().nullable().optional(),
    promoCode: z.string().nullable().optional(),
    promoterCode: z.string().nullable().optional(),
...
export const checkoutVerifyBodySchema = z
  .object({
...
export const checkoutRecoverQuerySchema = z
  .object({
    orderId: z.string().min(1),
  })
  .strict();

export const eventDetailParamsSchema = z
  .object({
    eventId: z.string().min(1),
  })
  .strict();

export const profileDetailParamsSchema = z
  .object({
    userId: z.string().min(1),
  })
  .strict();

export const confirmationParamsSchema = z
  .object({
    orderId: z.string().min(1),
  })
  .strict();
...
const guestBffEventsBucketSchema = z
  .object({
...
export const exploreFeedDataSchema = z
  .object({
    errors: z.array(z.string()),
    events: z.array(z.any()),
    featuredEvents: z.array(z.any()),
...
export const notificationsSummaryDataSchema = z
  .object({
    items: z.array(z.any()),
    pagination: z
      .object({
...
export const ticketsOverviewDataSchema = z
  .object({
    actions: z
      .object({
        canCancel: z.boolean(),
...
export const eventDetailDataSchema = z
  .object({
...
export const checkoutSummaryDataSchema = z
  .object({
...
export const checkoutQuoteDataSchema = z
  .object({
    constraints: z.any().nullable(),
    pricing: z.any().nullable(),
    quote: z.any().nullable(),
...
export const checkoutRecoverDataSchema = z
  .object({
    event: z.any().nullable(),
...
export const profileOverviewDataSchema = z
  .object({
...
export const profileDetailDataSchema = z
  .object({
    badges: z.array(z.string()),
    events: guestBffEventsBucketSchema,
    isOwner: z.boolean(),
