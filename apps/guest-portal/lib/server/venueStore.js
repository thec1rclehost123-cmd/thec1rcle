...
const fallbackVenues = [
  {
    ...
    venueType: 'Pub',
    description:
      "Pune's legendary home for indie music and high energy nights. The venue features an open-air setting with fairy lights and a mix of contemporary and rustic decor.",
    specialty:
      'High Spirits Cafe in Koregaon Park, Pune, is a popular nightlife spot known for its lively ambiance, live music, and vibrant events like DJ sets and themed parties.',
    timings: {
    ...
    contact: {
      ...
      phone: '9765400484',
      address:
        '35A, 1, N Main Rd, next to The Westin, Koregaon Park Annexe, Pune, Maharashtra 411001',
