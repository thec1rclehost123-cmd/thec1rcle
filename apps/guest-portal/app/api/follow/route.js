...
import { followEntity, unfollowEntity, isFollowing } from "../../../lib/server/notificationStore";
...
export async function POST(request) {
  try {
    ...
    if (!["venue", "host"].includes(targetType)) {
      return NextResponse.json({ error: "targetType must be 'venue' or 'host'" }, { status: 400 });
    }
