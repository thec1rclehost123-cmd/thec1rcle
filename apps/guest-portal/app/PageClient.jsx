        ...
        <div className="mx-auto max-w-7xl px-4 pt-6 sm:px-6">
          <div className="mb-8 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <div className="flex items-center gap-4">
              <Link href="/explore" className="group flex items-center gap-2 rounded-full border border-black/10 bg-black/[0.04] px-6 py-3 text-[11px] font-black uppercase tracking-widest text-black transition-all duration-300 hover:bg-black hover:text-white dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white dark:hover:text-black">
                View All
