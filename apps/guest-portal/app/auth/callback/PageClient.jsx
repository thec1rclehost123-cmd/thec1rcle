...
function AuthCallbackContent() {
  ...
  const loginRedirect = useMemo(() => buildLoginUrl(returnUrl), [returnUrl]);
  ...
  useEffect(() => {
    ...
    if (syncStatus === 'signed_out') {
      setStatus('error');
      setErrorMessage(
        'Your authentication session expired before access could be restored. Please sign in again.',
      );
    }
  }, [
    user,
            ...
            >
              ...
              <div className="space-y-2">
                <h1 className="text-2xl font-black uppercase tracking-tight text-white">
                  Entering <span className="text-orange">THE C1RCLE.</span>
                </h1>
                <p className="text-xs font-medium text-white/40 uppercase tracking-[0.3em]">
                  {syncStatus === 'transient_error'
                    ? 'Retrying your secure session...'
