...
function AuthContent() {
  ...
  return (
    <PageShell title={mode === "login" ? "Login" : "Sign Up"} showLogo={true} backHref="/explore">
      <div className="max-w-md mx-auto pb-8">
        ...
        >
          ...
          <p className="text-sm font-medium text-black/40 dark:text-white/40 uppercase tracking-widest max-w-[280px] mx-auto">
            {mode === "login" ? "Log in to your account." : "Join THE C1RCLE community."}
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative py-2">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-black/[0.05] dark:border-white/5" />
            </div>
            <div className="relative flex justify-center text-[10px]">
              <span className="bg-white dark:bg-[#121212] px-4 font-black uppercase tracking-[0.3em] text-black/20 dark:text-white/20">
                or use email
              </span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <AnimatePresence mode="wait">
              {mode === "register" && (
                ...
                >
                  <label className="text-[10px] uppercase tracking-widest text-black/60 dark:text-white/60 ml-4 font-bold">
                    Display Name
                  </label>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-4">
                <label className="text-[10px] uppercase tracking-widest text-black/60 dark:text-white/60 font-bold">
                  Password
                </label>
                {mode === "login" && (
                  <Link
                    ...
                    core-link="true"
                    className="text-[10px] uppercase tracking-widest text-orange/60 hover:text-orange font-bold transition-colors"
                  >
                    Reset
                  </Link>
                )}
