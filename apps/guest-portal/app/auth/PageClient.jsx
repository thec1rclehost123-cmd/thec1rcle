            ...
            <div className="max-w-md mx-auto pb-8">
                ...
                >
                    ...
                    <div className="relative py-2">
                        ...
                        <div className="relative flex justify-center text-[10px]"><span className="bg-white dark:bg-[#121212] px-4 font-black uppercase tracking-[0.3em] text-black/20 dark:text-white/20">or use email</span></div>
                    </div>
