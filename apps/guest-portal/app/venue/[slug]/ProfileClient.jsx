        ...
        <div className="flex p-1 bg-[var(--surface-2)] rounded-2xl border border-[var(--border-secondary)]">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-2 py-2.5 px-6 rounded-xl text-[11px] font-bold uppercase tracking-widest transition-all ${
                activeTab === tab.id
                      ...
                      .map((event) => (
                        ...
                        >
                          ...
                          <div className="absolute bottom-8 left-10 right-10 flex items-end justify-between">
                            ...
                            <button className="px-6 py-3 bg-white text-black rounded-full text-[10px] font-black uppercase tracking-widest">
                              Book Now
                            </button>
                          </div>
                        </div>
