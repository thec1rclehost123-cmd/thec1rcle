  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center">
        ...
        >
          <h2 className="mb-4 text-2xl font-bold sm:text-3xl">Lost in the Night?</h2>
          <p className="mb-8 max-w-md text-white/60">
            The page you're looking for has either ended or never existed. Let's get you back to the
            party.
          </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <Link
              href="/"
              className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full bg-white px-8 py-3 text-sm font-bold text-black transition-all hover:scale-105 hover:bg-gray-200"
            >
            ...
            <Link
              href="/explore"
              className="group inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-8 py-3 text-sm font-bold text-white backdrop-blur-md transition-all hover:border-white/40 hover:bg-white/10"
            >
