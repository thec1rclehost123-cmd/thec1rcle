            ...
            <div className="mx-auto max-w-5xl px-4 sm:px-6 py-10 space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-2">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="h-8 w-24 rounded-full bg-black/5 dark:bg-white/5 animate-pulse" />
                        ))}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_360px] gap-8">
                    ...
                    <div className="space-y-3">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="h-4 rounded-full bg-black/5 dark:bg-white/5 animate-pulse" style={{ width: `${90 - i * 8}%` }} />
                        ))}
                    </div>
