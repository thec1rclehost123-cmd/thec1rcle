    ...
    return (
      <div className="relative flex min-h-screen flex-col items-center justify-center bg-[var(--bg-color)] px-4 py-20">
        ...
        <div className="relative z-10 w-full max-w-lg text-center">
          ...
          <div className="mt-12">
            <Link href="/explore" className="inline-flex items-center gap-3 rounded-full bg-orange px-10 py-5 text-[10px] font-black uppercase tracking-[0.3em] text-white shadow-lg shadow-orange/20 transition-transform hover:scale-105 dark:bg-white dark:text-black dark:shadow-none">
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="relative z-10 w-full max-w-lg text-center">
          ...
          {event.cancellationReason ? (
            <div className="mx-auto mt-8 max-w-md rounded-3xl border border-black/5 bg-black/3 p-6 dark:border-white/5 dark:bg-white/3">
              <p className="mb-2 text-[10px] font-black uppercase tracking-[0.2em] text-[var(--text-muted)]">Reason</p>
              <p className="text-sm font-medium text-[var(--text-primary)]">{event.cancellationReason}</p>
            </div>
          ) : null}
          <div className="mt-12 flex flex-col items-center gap-4">
            ...
            <Link href="/profile" className="text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--text-muted)] transition-colors hover:text-[var(--text-primary)]">
              View My Tickets →
            </Link>
          </div>
        </div>
