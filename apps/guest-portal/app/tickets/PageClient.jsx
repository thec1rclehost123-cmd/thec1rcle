...
function TicketsContent() {
    ...
    return (
        <div className="bg-[var(--bg-color)] text-[var(--text-primary)] transition-colors duration-500 selection:bg-orange/30 flex-1 flex flex-col">
            <AuroraBackground key="aurora-bg" />

            {user ? (
                <div key="auth-content" className="relative z-10 mx-auto max-w-7xl px-4 pt-32 pb-20 sm:px-6 lg:px-8">
                    <div className="mb-20 flex flex-col items-center text-center">
                        <div className="flex flex-col items-center gap-4 mb-6">
                            <div className="h-1 w-12 bg-orange rounded-full" />
                            <span className="text-[12px] font-black uppercase tracking-[0.6em] text-white/40">Your Collection</span>
                        </div>
                        <h1 className="text-7xl md:text-[160px] font-heading font-black uppercase tracking-[-0.04em] text-white leading-[0.8] mb-12">
                            TICKETS
                        </h1>
                ...
                <div key="guest-content" className="relative z-10 mx-auto max-w-5xl px-4 pt-32 pb-20 sm:px-6 lg:px-8 flex-1 flex flex-col">
