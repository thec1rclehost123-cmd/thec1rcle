...
const CancelOrderModal = dynamic(() => import("../../components/CancelOrderModal"), { ssr: false });
    ...
    <div className="relative group overflow-hidden bg-white dark:bg-zinc-900 border border-black/5 dark:border-white/5 rounded-[32px] p-6 mb-8 transition-all hover:shadow-2xl">
      <div className="flex gap-6 items-center">
        <div className="relative w-20 h-20 rounded-2xl overflow-hidden flex-shrink-0">
          <Image
            src={action.posterUrl || "/events/placeholder.svg"}
            fill
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <span className="px-2 py-0.5 rounded-full bg-iris/10 text-iris text-[8px] font-black uppercase tracking-widest">
              Incoming Transfer
            </span>
          ...
          {error ? (
            <div className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-red-500/10 border border-red-500/20 max-w-[200px]">
              ...
              <p className="text-[8px] font-black text-red-500 uppercase leading-tight">
                {isGenderMismatch ? "Gender Restriction" : error}
              </p>
              <button
...
const ShareModal = ({ ticket, onClose, onSuccess }) => {
  ...
  const handleVerifyAndCreate = async () => {
    ...
    try {
      ...
      const bundle = await verifyAndCreateShareBundle(
        orderId,
        eventId,
        tier.count,
        selectedTierId,
    ...
    >
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-[10px] text-black/40 dark:text-white/40 mb-8 uppercase tracking-[0.3em] font-bold">
            {eventTitle}
          </p>
          ...
          {shareUrl ? (
            <div className="space-y-8">
              <div className="relative group">
                ...
                <div className="relative p-6 rounded-2xl bg-white dark:bg-black/40 border border-black/5 dark:border-white/10 backdrop-blur-xl">
                  <p className="text-[10px] font-black text-orange uppercase tracking-[0.2em] mb-4">
                    Live Share Link
                  </p>
              ...
              <div className="flex flex-col items-center gap-4 px-4">
                <p className="text-center text-[10px] text-black/50 dark:text-white/40 uppercase tracking-[0.2em] font-medium leading-loose">
                  ...
                  <br />
                  <span className="text-orange font-bold font-heading uppercase text-[8px] tracking-[0.1em]">
                    Identity requested: Anyone who claims must have a C1RCLE account.
                  </span>
                </p>
              </div>
            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-[10px] text-black/40 dark:text-white/40 uppercase tracking-[0.2em] font-bold leading-relaxed px-4">
                  A security code has been dispatched to your email. Enter it to authorize this
                  share.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-black/40 dark:text-white/40 ml-1">
                  Select Ticket Type
                </p>
                  ...
                  {availableTiers.map((tier) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div
                          className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${selectedTierId === tier.id ? "border-orange bg-orange" : "border-black/10"}`}
                        >
                          {selectedTierId === tier.id && (
          ...
          {showVerification ? (
            <div className="space-y-6">
              <div className="text-center mt-4">
                ...
                <p className="text-[10px] text-black/40 dark:text-white/40 uppercase tracking-[0.2em] font-bold leading-relaxed px-4">
                  We've dispatched a security code to your email. Enter it to authorize the transfer
                  to <span className="text-iris">{email}</span>.
                </p>
              </div>
...
const TicketCard = ({ ticket, onShare, onClick, onPartner, onTransfer }) => {
  ...
  const remainingToClaim =
    ticket.tickets?.filter((t) => !t.isClaimedByOther && !t.isClaimed && t.slotIndex !== 0)
      .length || 0;
  ...
  return (
    <div className="relative group">
      ...
      <motion.div
        ...
        className={`relative z-10 flex flex-col cursor-pointer overflow-hidden rounded-[28px] border transition-all duration-500 h-full min-h-[240px] ${
          isPast
      ...
      >
        <div className="flex w-full p-5 gap-6 relative flex-1">
          ...
          <div className="relative aspect-[3/4] h-40 flex-shrink-0 overflow-hidden rounded-2xl border border-black/5 dark:border-white/10 shadow-lg bg-zinc-900 self-center">
            ...
            />
            {isPast && (
              <div className="absolute inset-0 bg-black/20 dark:bg-black/40 backdrop-grayscale" />
            )}
          </div>
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1.5 items-center">
                    ...
                    {maleCount > 0 && (
                      <span className="rounded-full bg-blue-500/10 text-blue-500 border border-blue-500/20 px-2 py-0.5 text-[8px] font-black uppercase tracking-widest">
                        {maleCount} Male
                      </span>
                    )}
                    {femaleCount > 0 && (
                      <span className="rounded-full bg-pink-500/10 text-pink-500 border border-pink-500/20 px-2 py-0.5 text-[8px] font-black uppercase tracking-widest">
                        {femaleCount} Female
                      </span>
                    )}
                    {coupleCount > 0 && (
                      <span className="rounded-full bg-orange/10 text-orange border border-orange/20 px-2 py-0.5 text-[8px] font-black uppercase tracking-widest">
                        {coupleCount} Couple
                      </span>
                    )}
                  </div>
              ...
              <div className="flex flex-col gap-3 mb-3">
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                  <div className="flex items-center gap-1.5">
                    <div
                      className={`w-1 h-1 rounded-full ${claimedCount === groupCount ? "bg-emerald-500" : "bg-orange animate-pulse"}`}
                    />
          ...
          <div className="relative w-full flex items-center justify-center py-4">
                ...
                <div className="relative w-full aspect-square max-w-[280px] md:max-w-[240px] flex flex-col justify-center items-center bg-white rounded-[40px] p-8 md:p-6 shadow-2xl border border-white/40">
                  ...
                  <div className="absolute top-6">
                    {currentTicket.isTransferPending ? (
                      <span className="px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-[8px] font-black uppercase tracking-widest text-amber-600">
                        Transfer Pending
                      </span>
                    ) : currentTicket.isClaimedByOther ? (
                      <span className="px-3 py-1 rounded-full bg-iris/10 border border-iris/20 text-[8px] font-black uppercase tracking-widest text-iris">
                        Assigned to Guest
                      </span>
                    ) : currentTicket.isClaimed ? (
                      <span className="px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[8px] font-black uppercase tracking-widest text-emerald-600">
                        Assigned to You
                      </span>
                    ) : (
                      <span className="px-3 py-1 rounded-full bg-black/5 border border-black/10 text-[8px] font-black uppercase tracking-widest text-black/40">
                        Unclaimed
                      </span>
                    )}
                  </div>
                  ...
                  {currentTicket.isTransferPending ? (
                    <div className="text-center space-y-4">
                      ...
                      <p className="text-[10px] text-black/40 uppercase tracking-widest font-bold leading-relaxed px-4">
                        QR disabled during transfer
                      </p>
                    </div>
                  ) : currentTicket.isClaimedByOther ? (
                      ...
                      <div className="relative">
                        <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-iris/30 bg-iris/5 flex items-center justify-center shadow-inner">
                          {currentTicket.assignment?.avatar ? (
                            <img
                              src={currentTicket.assignment.avatar}
                              className="w-full h-full object-cover"
                            />
                          ) : (
                            <span className="text-xl font-black text-iris">
                              {currentTicket.assignment?.userName?.charAt(0) ||
                                currentTicket.assignment?.redeemerId?.slice(0, 1).toUpperCase() ||
                                "G"}
                            </span>
                          )}
                        </div>
                    ...
                    <div className="text-center space-y-4">
                      ...
                      <p className="text-[10px] text-black/40 uppercase tracking-widest mt-2 font-bold leading-relaxed px-4">
                        {currentTicket.requiredGender} Only
                      </p>
                    </div>
                  ) : (
                    <>
                      <div
                        className={`relative ${isUsed || isCancelled ? "opacity-10 grayscale" : ""}`}
                      >
                        <IdentityQR
                          entitlementId={currentTicket.entitlementId}
                          slotTicketId={currentTicket.ticketId}
                        />
                      </div>
                      {isUsed && (
                        <div className="absolute inset-0 flex items-center justify-center">
                          <span className="border-[3px] border-black px-6 py-3 text-3xl font-black uppercase tracking-[0.2em] text-black bg-white shadow-2xl z-20 rotate-[-12deg]">
                            USED
                          </span>
                        </div>
                      )}
                  ...
                  {currentTicket.isCouple && (
                    <div className="flex items-center gap-3 mt-2">
                      <div className="flex flex-col items-center">
                        <div className="w-8 h-8 rounded-full bg-black dark:bg-white flex items-center justify-center text-white dark:text-black font-bold text-[10px]">
                          P1
                        </div>
                        <span className="text-[8px] font-black uppercase tracking-widest mt-1 opacity-40">
                          Buyer
                        </span>
                      </div>
                      ...
                      <div className="flex flex-col items-center">
                        <div
                          className={`w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-bold ${currentTicket.assignment ? "bg-orange text-white" : "bg-black/5 dark:bg-white/5 text-black/40 dark:text-white/40"}`}
                        >
            ...
            {tickets.length > 1 && (
              <>
                <button
                  onClick={handlePrev}
                  className="absolute left-[-20px] p-2 text-black/20 dark:text-white/20 hover:text-black dark:hover:text-white transition-colors"
                >
                  <ChevronLeft className="w-8 h-8" />
                </button>
                <button
                  onClick={handleNext}
                  className="absolute right-[-20px] p-2 text-black/20 dark:text-white/20 hover:text-black dark:hover:text-white transition-colors"
                >
...
function TicketsContent() {
  ...
  const TICKETS_DATA = [
    ...
    },
    {
      ...
      title: "VIP",
      price: "₹ 5,000",
      color: "from-orange-900/40 to-black border-orange-500/50",
      icon: Crown,
    },
    {
      id: 4,
          ...
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-black/30 dark:text-white/30">
                  Your Collection
                </span>
              </div>
              ...
              <div className="mt-12 flex gap-4 p-1 rounded-3xl bg-black/5 dark:bg-white/5 w-fit border border-black/5 dark:border-white/5 backdrop-blur-md overflow-x-auto no-scrollbar max-w-full">
                <div className="whitespace-nowrap px-6 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-300 bg-white dark:bg-zinc-800 text-black dark:text-white shadow-lg">
                  Current passes
                </div>
              </div>
            </div>
              ...
              >
                {loading ? (
                    ...
                    {tickets.actionNeeded.length > 0 && (
                      <div className="mb-8">
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <span className="text-[9px] font-black uppercase tracking-[0.3em] text-black/20 dark:text-white/20">
                            Pending Actions
                          </span>
                          <div className="h-[1px] flex-1 bg-black/5 dark:bg-white/5" />
                        </div>
                  ...
                  <div className="py-32 text-center rounded-[40px] border border-black/5 dark:border-white/5 bg-black/[0.02] dark:bg-white/[0.02]">
                    ...
                    <Link
                      href="/explore"
                      className="mt-8 inline-block rounded-full bg-black dark:bg-white px-8 py-4 text-xs font-bold uppercase tracking-widest text-white dark:text-black hover:scale-105 transition-transform shadow-md"
                    >
                      Explore events
                    </Link>
                  </div>
