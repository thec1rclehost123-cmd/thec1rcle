    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#E8913A] via-[#D97B1A] to-[#7A420C] flex flex-col items-center justify-center p-6 text-center">
        ...
        <div className="relative z-10">
          <div
            className={`w-20 h-20 rounded-full flex items-center justify-center mb-8 ${isGenderMismatch ? "bg-white/15" : "bg-white/15"}`}
          >
            {isGenderMismatch ? (
              <svg
          ...
          <p className="text-white/80 mb-10 max-w-xs text-base font-medium leading-relaxed">
            {error}
          </p>
          <Link
            href="/explore"
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#E8913A] via-[#D97B1A] to-[#7A420C] flex items-center justify-center p-4 overflow-hidden">
        ...
        >
          ...
          <h1 className="text-3xl font-black text-gray-900 mb-2">Tickets Secured!</h1>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-8 mb-8 inline-block shadow-lg">
            <QRCodeSVG value={claimResult.assignment.qrPayload} size={180} level="H" />
