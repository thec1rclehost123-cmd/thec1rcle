...
async function loadHomeData() {
  ...
  const [featuredResult, eventsResult, selectsResult, interviewsResult] = await Promise.all([
    ...
    guestServerJson(`/public/events?city=${encodeURIComponent(city)}&limit=30&sort=heat`, { forwardCookies: false, next: { revalidate: 60 } }),
    guestServerJson("/public/homepage/selects", { forwardCookies: false, next: { revalidate: 300 } }),
    guestServerJson("/public/homepage/interviews", { forwardCookies: false, next: { revalidate: 300 } }),
  ]);
