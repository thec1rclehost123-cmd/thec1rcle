        ...
        <div className="mx-auto max-w-7xl px-4 pt-6 sm:px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/explore"
                className="group flex items-center gap-2 px-6 py-3 rounded-full bg-white/5 border border-white/10 text-white text-[11px] font-black uppercase tracking-widest hover:bg-white hover:text-black transition-all duration-300"
              >
                View All
                <svg
