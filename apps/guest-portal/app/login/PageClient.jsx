...
function LoginForm() {
  ...
  const stepHeading = () => {
    if (step === 1)
      return (
        <>
          {isLoginMode ? 'Welcome' : 'Join the'} <br />
          <span className="text-orange">{isLoginMode ? 'Back.' : 'Circle.'}</span>
        </>
      );
    if (step === 3)
      return (
    ...
    if (step === 5)
      return (
        <>
          What's your <br />
          <span className="text-orange">Age?</span>
        </>
      );
    if (step === 6)
      return (
        <>
          How do you <br />
          <span className="text-orange">Identify?</span>
        </>
      );
    if (step === 7)
      return (
        <>
          Your <br />
          <span className="text-orange">City?</span>
        </>
      );
    if (step === 8)
      return (
    ...
    return (
      <>
        Final <br />
        <span className="text-orange">Step.</span>
      </>
    );
  };
    ...
    <div className="flex flex-col md:flex-row w-full h-full relative">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-3/5 h-[100dvh] relative overflow-hidden bg-[#FF4400] items-center justify-center p-12 flex-col">
        ...
        >
          ...
          <span className="text-[11px] font-black uppercase tracking-[0.5em] text-black whitespace-nowrap">
          ...
          <div className="md:hidden w-full flex flex-col items-center mb-4">
            <div className="bg-[#FF4400] w-full py-8 sm:py-12 px-4 flex flex-col items-center justify-center mb-8">
              ...
              >
                ...
                <span className="text-[9px] font-black uppercase tracking-[0.3em] text-black/80 whitespace-nowrap">
                  Discover Life Offline
                </span>
                <div className="h-px w-8 bg-black/40" />
              </motion.div>
                        ...
                        {step === 1 && (
                          <div className="space-y-6">
                            <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/70 block">
                                Email address
                              </label>
                              <input
                                type="email"
                        ...
                        {!isLoginMode && step === 3 && (
                          <div className="space-y-6 pt-4">
                            ...
                            <PhoneInput
                              ...
                              errorText={
                                status.type === 'error' && status.message.includes('phone')
                                  ? status.message
                                  : ''
                              }
                            />
                            ...
                            <div className="grid grid-cols-2 gap-3 rounded-[24px] border border-white/8 bg-white/[0.02] p-3">
                              {CITIES.map((city) => (
                                <button
                                  ...
                                  className={`flex h-16 items-center justify-center rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] transition-all border disabled:opacity-50 ${
                                    form.city === city
            ...
            >
              ...
              >
                {isLoginMode ? (
                  <>
                    New here?{' '}
                    <span className="text-orange underline underline-offset-4">Create account</span>
                  </>
                ) : (
                  <>
                    Already have an account?{' '}
                    <span className="text-orange underline underline-offset-4">Log in</span>
                  </>
                )}
              </button>
            </motion.div>
