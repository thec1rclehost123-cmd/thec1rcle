                        ...
                        {activeTab === "venues" ? (
                            <>
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all snap-center flex-shrink-0 border ${tablesOnly ? "bg-orange border-orange text-white" : "bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 text-black/50 dark:text-white/50 hover:bg-black/10 dark:hover:bg-white/10"
                                        }`}
                                >
                                    Tables Available
                                </button>
