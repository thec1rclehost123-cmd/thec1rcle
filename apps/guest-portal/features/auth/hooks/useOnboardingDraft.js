...
export function useOnboardingDraft({
  ...
  const [isNewUser, setIsNewUser] = useState(() => readSession(SESSION_KEYS.isNewUser, "false") === "true");
  const [isOnboarding, setIsOnboarding] = useState(() => forceOnboarding || readSession(SESSION_KEYS.isOnboarding, "false") === "true");
