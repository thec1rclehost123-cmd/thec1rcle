    ...
    <div className="relative w-full h-[600px] flex flex-col items-center justify-center perspective-2000">
      ...
      <div className="relative h-[480px] w-full flex justify-center items-center">
        <motion.div
          ...
          animate={{
            backgroundColor: tickets[activeIndex]?.type === "VIP" ? "rgba(255, 77, 34, 0.2)" : "rgba(255, 255, 255, 0.05)",
            scale: [1, 1.2],
            opacity: [0.1, 0.3],
          }}
          transition={{
            ...
            return (
              <motion.div
                ...
                className={clsx(
                  ...
                  isActive ? "border-white/20 z-50 ring-1 ring-white/10" : "border-white/5 opacity-40",
              ...
              >
                ...
                <div className="relative flex justify-between items-start">
                  ...
                  <div className="flex flex-col items-end">
                    <span className="text-[9px] font-black tracking-[0.4em] text-white/30 uppercase">The C1rcle</span>
                        ...
                        >
                            <div className="flex justify-between items-end">
                                <div className="flex flex-col">
                                    <span className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40 mb-1">Price</span>
