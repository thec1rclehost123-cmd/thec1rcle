...
const AuroraBackground = () => (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-black">
        {/* Cinematic dark gradients — reduced to keep background pure black as per screenshot */}
        <div className="absolute top-0 left-0 h-[100vh] w-full bg-gradient-to-b from-orange/10 via-transparent to-transparent opacity-40" />
    </div>
);
