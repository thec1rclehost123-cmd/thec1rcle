    ...
    return (
        <div className="relative group overflow-visible">
            ...
            <motion.div
                ...
                className={`relative z-10 flex flex-col cursor-pointer overflow-hidden rounded-[32px] border transition-all duration-500 h-full min-h-[200px] ${isPast
                                        ...
                                        <>
                                            {isDetailLoading ? (
                                                <div className="flex flex-col items-center justify-center gap-4 py-8">
                                                    ...
                                                    <p className="text-[8px] font-black text-black/20 uppercase tracking-widest">Verifying Identity...</p>
                                                </div>
                                            ) : (
                                                <>
                                                    <div className={`relative ${isUsed || isCancelled ? "opacity-10 grayscale" : ""}`}>
                                                        <IdentityQR entitlementId={currentTicket.qrPayload || currentTicket.entitlementId} slotTicketId={currentTicket.ticketId} />
                                                    </div>
                                                    {isUsed && (
