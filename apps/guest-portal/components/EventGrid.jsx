...
export default function EventGrid({ events = [] }) {
  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 sm:py-24 lg:px-8">
      <div className="grid grid-cols-1 gap-8 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:gap-8">
