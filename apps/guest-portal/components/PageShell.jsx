      ...
      <footer className="mt-auto py-12 border-t border-black/[0.03] dark:border-white/[0.05]">
        <div className="mx-auto max-w-7xl px-6 flex flex-col items-center gap-6">
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-3">
            <Link
              href="/about"
              className="text-[10px] font-bold uppercase tracking-[0.2em] text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white transition-colors"
            >
              About
            </Link>
            <Link
          ...
          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-black/20 dark:text-white/20">
            © <span suppressHydrationWarning>{new Date().getFullYear()}</span> THE C1RCLE. ALL
            RIGHTS RESERVED.
          </p>
        </div>
      </footer>
