          ...
          >
            <div className="mb-6 flex items-start justify-between">
              ...
              <button
                type="button"
                onClick={onClose}
                className="flex items-center justify-center p-2 -mr-2 text-white/40 hover:text-white transition-colors"
                id="close-ticket-modal"
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/5 border border-white/10 hover:bg-white/10">
            ...
            <div className="space-y-4">
              {tickets.map((ticket) => (
                ...
                >
                  ...
                  <div className="flex items-center rounded-full border border-white/10 bg-black/40 p-1.5 h-12">
                    <button
                      type="button"
                      onClick={() => {
