    ...
    return (
        <>
            <style jsx>{`
                ...
                .animate-scale-x-reveal { animation: scale-x-reveal 0.8s ease-out forwards; transform-origin: center; transform: scaleX(0); }
                    ...
                    <div className="relative">
                        <h1
                            ...
                            style={{
                                ...
                                animation: 'gradient-shift 15s ease-in-out infinite, scale-in 0.8s ease-out 0.2s forwards',
