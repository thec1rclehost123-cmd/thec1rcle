...
export default function CheckoutContainer({ event, initialTickets = [] }) {
  ...
  const canProceedStep1 =
    totalSelectedQuantity >= minTickets && totalSelectedQuantity <= maxTickets;
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                <div className="space-y-4">
                  ...
                  <h1 className="text-4xl font-black uppercase tracking-tight text-white leading-[0.9]">
                    Select your <br />
                    Tickets
                  </h1>
                </div>
                <div className="space-y-3 overflow-y-auto pr-2 custom-scrollbar flex-1 py-1">
                  {event.tickets?.map((ticket) => {
                    ...
                    return (
                      <div
                        key={ticket.id}
                        className={`p-5 rounded-[28px] border transition-all duration-500 ${qty > 0 ? "border-orange/40 bg-orange/5" : "border-white/5 bg-white/[0.02]"}`}
                      >
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <div className="flex items-center gap-4 bg-white/5 p-1 rounded-full border border-white/5">
                            <button
                              ...
                              disabled={qty === 0}
                              className="h-10 w-10 flex items-center justify-center rounded-full hover:bg-white/10 disabled:opacity-20"
                            >
                              -
                            </button>
                ...
                <div className="space-y-6 flex-1 flex flex-col justify-center">
                  <div className="space-y-2 group">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border-b border-white/10 p-4 text-sm font-bold tracking-widest text-white placeholder:text-white/10 focus:outline-none focus:border-orange transition-all duration-500"
                    />
                  </div>
                  <div className="space-y-2 group">
                    <label className="text-[10px] font-black uppercase tracking-[0.3em] text-orange ml-1">
            ...
            {step === 3 && (
              <motion.div
                ...
                animate="visible"
                exit="exit"
                className="space-y-6 h-full flex flex-col justify-center text-white"
              >
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <button
                  ...
                  <div className="space-y-8 flex-1 flex flex-col justify-center">
                    ...
                    <div className="p-5 rounded-3xl bg-white/[0.03] border border-white/5 space-y-3">
                      ...
                      <p className="text-[9px] leading-relaxed text-white/30 uppercase tracking-widest">
                        By proceeding, you authorize THE C1RCLE to process payment and issue
                        tickets. No refunds allowed.
                      </p>
                    </div>
                  </div>
                )}
        ...
        <div className="hidden md:flex flex-col h-full bg-white/[0.03] rounded-[48px] border border-white/10 backdrop-blur-3xl overflow-hidden shadow-2xl">
          <div className="relative h-40 shrink-0">
            ...
            <div className="absolute bottom-6 left-8 right-8">
              ...
              <h3 className="text-lg font-black uppercase text-white leading-tight truncate">
                {event.title}
              </h3>
            </div>
          </div>
          ...
          <div className="p-8 flex flex-col flex-1">
            <div className="flex-1 space-y-4 overflow-y-auto custom-scrollbar pr-2">
              {selectedTickets.length > 0 ? (
                selectedTickets.map((t) => (
                  <div key={t.id} className="flex justify-between items-start group py-1">
                    <div className="min-w-0 pr-4">
                      ...
                      <p className="text-[8px] font-bold text-white/30 uppercase tracking-[0.2em] mt-0.5">
                        X{t.quantity}
                      </p>
                    </div>
                ...
                <p className="text-[9px] font-black uppercase tracking-[0.4em] text-white/10 text-center py-10 italic">
                  Empty Order
                </p>
              )}
            </div>
      ...
      <AnimatePresence>
        {(isProcessing || isSuccess) && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-2xl flex flex-col items-center justify-center text-white text-center p-8"
          >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                {isSuccess ? (
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="h-20 w-20 bg-orange rounded-full flex items-center justify-center shadow-[0_0_60px_rgba(255,165,0,0.5)]"
                  >
            ...
            <motion.p
              ...
              className="text-[10px] uppercase font-black tracking-[0.4em] text-white/40 mt-6 max-w-[280px]"
            >
              {isSuccess
                ? "Your booking is confirmed. Your identity pass is being generated."
