            ...
            <div className="max-w-2xl mx-auto space-y-5">
                ...
                {price && (
                    <div className="flex items-center gap-2">
                        <span className="text-xs font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500">Price Range</span>
                    ...
                    >
                        ...
                        {bookingConfig.capacity > 0 && (
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                Capacity: up to <span className="font-semibold text-black dark:text-white">{bookingConfig.capacity}</span> guests
                            </p>
                        )}
