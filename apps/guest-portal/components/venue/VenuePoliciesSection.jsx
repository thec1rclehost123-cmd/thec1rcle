          ...
          <div className="flex-1 space-y-16">
            <div>
              ...
              <p className="text-black/50 dark:text-white/50 text-sm max-w-lg mb-12">
                Please adhere to the following guidelines to ensure a seamless experience for all
                guests. The management reserves the right of admission.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {rules.length === 0 && (
                  <p className="text-black/30 dark:text-white/30 text-xs italic italic">
            ...
            {Object.keys(timings).length > 0 && (
              <div className="pt-8">
                <h3 className="text-sm font-black uppercase tracking-[0.3em] text-black/40 dark:text-white/40 mb-8">
                  Hours of Operation
                </h3>
          ...
          <div className="w-full md:w-80 space-y-4">
            ...
            <div className="p-8 bg-black dark:bg-[#111] rounded-[2.5rem] border border-white/5 relative overflow-hidden group">
              ...
              <div className="relative">
                <div className="p-3 bg-white/5 rounded-2xl w-fit mb-6">{agePolicyIcon}</div>
            ...
            {capacity?.total && (
              <div className="p-6 bg-black/[0.02] dark:bg-white/[0.02] rounded-3xl border border-black/5 dark:border-white/5">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-[9px] font-black uppercase tracking-[0.2em] text-black/40 dark:text-white/40 mb-1">
                      Total Capacity
                    </h4>
                    <p className="text-xl font-black text-black dark:text-white">
                      {capacity.total} Guests
                    </p>
                  </div>
            ...
            <div className="p-6 bg-amber-500/5 rounded-3xl border border-amber-500/10">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-[10px] font-black uppercase tracking-widest text-amber-600 mb-1">
                    Pro Tip
                  </h4>
                  <p className="text-[10px] font-medium text-amber-700/70 leading-relaxed">
                    Arrive early for better seating options and to avoid long entry queues during
                    peak hours.
                  </p>
                </div>
              </div>
