          ...
          <AnimatePresence mode="wait">
            ...
            {step === 2 && (
              ...
              >
                ...
                <button
                  onClick={() => setStep(1)}
                  className="w-full text-center text-white/30 text-[10px] font-bold uppercase tracking-widest hover:text-white transition-colors"
                >
                  Go Back
                </button>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-white/40 text-sm max-w-[280px] mx-auto leading-relaxed">
                    Your request has been sent to the partner. You'll receive an email once it's
                    approved.
                  </p>
                </div>
                <button
