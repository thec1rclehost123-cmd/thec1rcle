    ...
    <section className="py-32 bg-white dark:bg-[#0A0A0A] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-24 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
          <div>
            <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#F44A22] mb-4 block">
              Community
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 relative">
            <div className="sticky top-32 p-6 sm:p-8 md:p-12 rounded-[2rem] sm:rounded-[3rem] bg-gradient-to-br from-[#F44A22] to-[#CC3311] overflow-hidden shadow-2xl shadow-[#F44A22]/20">
              {/* Decorative */}
              ...
              <div className="relative z-10 space-y-10">
                ...
                <div className="flex items-center gap-6">
                  <div className="flex -space-x-4">
                    {displayRegulars.slice(0, 4).map((user, idx) => (
                      <div
                        key={user.id}
                        className="w-14 h-14 rounded-full border-4 border-[#F44A22] overflow-hidden"
                      >
                        <Image
                          src={user.avatar}
                          width={56}
                ...
                <button
                  ...
                  className={`w-full py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.3em] transition-all duration-500 ${
                    isFollowing
            ...
            <div className="p-10 rounded-[2.5rem] bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-sm font-black uppercase tracking-[0.2em] text-black/60 dark:text-white/60">
                    Regulars
                  </h3>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-8 rounded-[2rem] bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5 space-y-4">
                ...
                <p className="text-sm text-black/40 dark:text-white/40 font-medium">
                  Be first to know about events & exclusive drops
                </p>
              </div>
              <div className="p-8 rounded-[2rem] bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5 space-y-4">
                ...
                <p className="text-sm text-black/40 dark:text-white/40 font-medium">
                  Priority reservations & special perks
                </p>
              </div>
            </div>
            ...
            {similarVenues.length > 0 && (
              <div className="p-10 rounded-[2.5rem] bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <Link
                    href="/hosts"
                    className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[#F44A22] hover:underline"
                  >
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {similarVenues.slice(0, 3).map((v) => (
                    ...
                    >
                      <Image
                        src={v.coverURL || v.image || '/events/neon-nights.jpg'}
                        fill
