        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-heading font-black uppercase tracking-tighter leading-none text-black dark:text-white">
              Past
              <br />
              <span className="italic text-transparent bg-clip-text bg-gradient-to-r from-black/40 dark:from-white/40 to-black/20 dark:to-white/20">
                Memories.
              </span>
            </h2>
          </div>
        ...
        >
                ...
                <div className="absolute top-6 left-6">
                  <div className="px-4 py-2 bg-white/10 backdrop-blur-xl rounded-full border border-white/10">
                    <span className="text-[10px] font-black uppercase tracking-widest text-white/60">
                      {new Date(event.startDate || event.startAt).toLocaleDateString('en-IN', {
                        month: 'short',
                        year: 'numeric',
                      })}
                    </span>
          ...
          <div className="flex-shrink-0 w-[280px] aspect-[3/4] rounded-[2.5rem] border-2 border-dashed border-black/10 dark:border-white/10 flex flex-col items-center justify-center gap-6 cursor-pointer hover:border-[#F44A22]/50 transition-colors group">
            ...
            <div className="text-center">
              <p className="text-sm font-black uppercase tracking-[0.2em] text-black/40 dark:text-white/40 group-hover:text-[#F44A22] transition-colors">
                View All
              </p>
              <p className="text-xs text-black/20 dark:text-white/20 font-medium mt-1">
