            ...
            <div className="relative aspect-[3/4] sm:aspect-[4/5] md:aspect-[16/10] lg:aspect-[21/9] w-full overflow-hidden">
                ...
                <div className="absolute top-0 left-0 right-0 z-40">
                    ...
                    <div className="flex items-center justify-between px-4 sm:px-6 py-4">
                        ...
                        <button
                            onClick={onFollow}
                            className={`flex items-center gap-2 px-5 py-2.5 rounded-full backdrop-blur-xl border transition-all duration-300 ${isFollowing
                        ...
                        >
                            ...
                            {followersCount > 0 && (
                                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${isFollowing ? 'bg-white/20' : 'bg-white/10'
                                    }`}>
