...
export default function ReservationCalendarModal({
    ...
    const stepTitle = {
        ...
        [STEPS.CHOOSE_TYPE]: selectedDate?.toLocaleDateString("en-IN", { weekday: "short", month: "short", day: "numeric" }),
                            ...
                            >
                                                ...
                                                {hasEvents && (
                                                    <div className="flex items-center gap-0.5">
                                                        {dayEvents.slice(0, 3).map((_, i) => (
                                                            <div
                                                                key={i}
                                                                className={`w-1 h-1 rounded-full ${selected ? "bg-white" : "bg-[#F44A22]"
                                                                    }`}
                                                            />
                                                        ))}
                                                    </div>
                                ...
                                <div className="flex items-center justify-center gap-6 mt-6 pt-4 border-t border-white/5">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[9px] font-bold text-white/40 uppercase tracking-widest">Event Night</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                        ...
                        {step === STEPS.TABLE_SELECT && selectedEvent && (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/[0.03] border border-white/5">
                                    ...
                                    <div>
                                        <p className="text-xs font-black text-white uppercase tracking-tight">{selectedEvent.title || selectedEvent.name}</p>
                                        <p className="text-[10px] text-white/30 font-bold">{selectedEvent.time || selectedEvent.startTime}</p>
                                    </div>
                                </div>
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <div className="flex items-center gap-2 mt-0.5">
                                                                ...
                                                                <span className="text-[10px] text-white/40 font-bold">Up to {table.capacity} guests</span>
                                                            </div>
                                                        ...
                                                        <div className="text-right">
                                                            ...
                                                            {table.minimumSpend > 0 && (
                                                                <p className="text-[9px] text-white/30 font-bold">Min spend {formatCurrency(table.minimumSpend)}</p>
                                                            )}
                                                        </div>
                                                    </div>
                                                </button>
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        {tier.description && (
                                                            <p className="text-[10px] text-white/30 font-medium mt-0.5">{tier.description}</p>
                                                        )}
                                    ...
                                    <div className="flex items-center gap-2 p-1.5 bg-white/5 rounded-2xl border border-white/10">
                                        {[1, 2, 4, 6, 8, 10].map(n => (
                                            <button
                                                key={n}
                                                onClick={() => setGuests(n)}
                                                className={`flex-1 py-3 rounded-xl text-sm font-black transition-all ${guests === n
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                        {["12:00", "13:00", "14:00", "18:00", "19:00", "20:00", "21:00", "22:00"].map(t => (
                                            <button
                                                ...
                                                className={`py-3 rounded-xl border text-xs font-bold transition-all ${selectedTime === t
                        ...
                        {step === STEPS.SUMMARY && (
                            ...
                            >
                                ...
                                <div className="p-5 rounded-2xl bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/10 space-y-4">
                                    <div className="flex items-center gap-3">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${bookingType === "event" ? "bg-[#F44A22]/10" : "bg-emerald-500/10"}`}>
                                            {bookingType === "event" ? (
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <p className="text-[9px] font-bold text-white/20 uppercase tracking-widest">Guests</p>
                                            <p className="text-sm font-bold text-white mt-0.5">{guests}</p>
                                        </div>
                                        {bookingType === "event" && selectedEvent && (
                                            <div>
                                                <p className="text-[9px] font-bold text-white/20 uppercase tracking-widest">Event</p>
                                                <p className="text-sm font-bold text-white mt-0.5 truncate">{selectedEvent.title || selectedEvent.name}</p>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    {selectedTable && (
                                        <>
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-[9px] font-bold text-white/20 uppercase tracking-widest">Table</p>
                                    ...
                                    {selectedTier && !selectedTable && (
                                        <>
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-[9px] font-bold text-white/20 uppercase tracking-widest">Entry / Cover</p>
                                                    <p className="text-sm font-bold text-white">{selectedTier.name} × {guests}</p>
                                                </div>
                                                <p className="text-lg font-black text-white">{formatCurrency(selectedTier.price * guests)}</p>
                                            </div>
                                        </>
                                    )}
                                </div>
                                ...
                                {totalPrice > 0 && (
                                    <div className="flex items-center justify-between p-4 rounded-2xl bg-[#F44A22]/5 border border-[#F44A22]/10">
                                        <p className="text-[10px] font-black text-[#F44A22] uppercase tracking-widest">Total</p>
                                ...
                                <button
                                    ...
                                    className={`w-full py-5 rounded-2xl font-black uppercase tracking-widest text-xs flex items-center justify-center gap-2 transition-all disabled:opacity-30 shadow-lg ${bookingType === "event"
