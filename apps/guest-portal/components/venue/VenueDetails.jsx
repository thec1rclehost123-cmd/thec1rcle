          ...
          {days.map((day) => {
            ...
            return (
              <div key={day} className="flex justify-between">
                <span className="text-xs font-bold uppercase text-black/40 dark:text-white/40 capitalize">
                  {day.slice(0, 3)}
                </span>
              ...
              <div className="p-5 rounded-2xl bg-white dark:bg-white/5 border border-black/5 dark:border-white/5">
                ...
                <div className="flex flex-wrap gap-2">
                  {genres.map((genre, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1 bg-black/5 dark:bg-white/5 rounded-full text-[10px] font-bold text-black/60 dark:text-white/60"
                    >
                      {genre}
                    </span>
                  ))}
