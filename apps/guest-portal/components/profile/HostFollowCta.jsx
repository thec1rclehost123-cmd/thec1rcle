 ...
 */
export default function HostFollowCta({ hostProfile, initialFollowersCount = 0, upcomingCount = 0, totalCount = 0 }) {
    const { user } = useAuth() || {};
        ...
        <div className="flex flex-col lg:flex-row lg:items-end gap-8 lg:gap-12 w-full">
            ...
            <div className="flex gap-10 pt-4">
                <div className="text-center">
                    <p className="text-3xl md:text-4xl font-black">{followersCount.toLocaleString("en-IN")}</p>
