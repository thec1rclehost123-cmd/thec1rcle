  ...
  return (
    <>
      ...
      <div className="page-shell relative flex min-h-screen flex-col bg-white dark:bg-black text-black dark:text-white transition-colors duration-300">
        ...
        <div
          className="pointer-events-none fixed inset-0 -z-10 opacity-0 dark:opacity-90 transition-opacity duration-300"
          style={{ contain: 'strict' }}
        >
          <div
            className="absolute inset-x-0 top-0 h-[60vh] bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.08),transparent_55%)] blur-[120px]"
          ...
          <div
            className="absolute inset-x-0 bottom-0 h-[50vh] bg-[radial-gradient(circle_at_bottom,_rgba(255,181,167,0.2),transparent_50%)] blur-[140px]"
            style={{ willChange: 'filter', transform: 'translateZ(0)' }}
          />
        </div>
        {navbar}
