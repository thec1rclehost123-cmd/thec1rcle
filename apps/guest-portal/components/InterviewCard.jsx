...
export default function InterviewCard({ item, index }) {
    ...
    return (
        ...
        >
            <div
                className={`relative aspect-[4/3] flex-1 overflow-hidden rounded-[32px] bg-black/5 dark:bg-surface lg:aspect-[16/10] border transition-all duration-700 ${isInView
