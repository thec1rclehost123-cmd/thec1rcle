...
export default function Toast({ id, type = 'info', message, duration = 4000, onRemove }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/5 ring-1 ${type === 'error' ? 'ring-orange/30 shadow-[0_0_15px_rgba(244,74,34,0.2)]' : 'ring-white/10'}`}
      >
        {icons[type]}
      </div>
