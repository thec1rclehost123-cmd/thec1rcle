                ...
                >
                    ...
                    <div className="relative px-6 pt-6 pb-4">
                        <div className="flex items-start justify-between">
                            ...
                            >
                                <svg className="w-4 h-4 text-black/60 dark:text-white/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div className="rounded-2xl bg-emerald-500/5 border border-emerald-500/10 p-4 space-y-3">
                                        ...
                                        <div className="flex items-end justify-between">
                                            <div>
                                                <p className="text-xs text-black/50 dark:text-white/50">
                                                    {eligibility.refundPercentage === 100 ? "Full refund" :
                                                        eligibility.refundPercentage > 0 ? `${eligibility.refundPercentage}% refund` :
                                                            "No refund"}
                                                </p>
                                        ...
                                        {eligibility.refundPercentage === 0 && (
                                            <p className="text-[10px] text-red-500 font-medium">
                                                This event has a no-refund policy. Your order will be cancelled but no refund will be issued.
                                            </p>
                                        )}
                                    </div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {REASONS.map((r) => (
                                                <button
                                                    key={r}
                                                    onClick={() => setReason(r)}
                                                    className={`px-3.5 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all border ${reason === r
