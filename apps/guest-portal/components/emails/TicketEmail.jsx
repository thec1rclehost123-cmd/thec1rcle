                            ...
                            >
                                ...
                                <tr>
                                    <td style={styles.section}>
                                        ...
                                        {/* Venue & Location */}
                                        {eventVenue && (
                                            <p style={styles.valueBold}>{eventVenue}</p>
                                        )}
                                ...
                                <tr>
                                    <td style={styles.orderSection}>
                                        ...
                                        <p style={styles.orderMeta}>
                                            Order {orderId} — {orderDate || new Date().toLocaleDateString('en-IN', {
                                                month: 'short',
                                                day: 'numeric',
                                                year: 'numeric',
                                                hour: 'numeric',
                                    ...
                                    <td style={styles.qrSection}>
                                        <div style={styles.qrBox}>
                                            <p style={styles.qrHint}>
                                                This QR is for the entire order. Individual QR codes
                                                for each ticket are located in the attached PDF.
                                            </p>
                                            <img
                                                src={qrImageUrl}
                                                alt="Order QR Code"
