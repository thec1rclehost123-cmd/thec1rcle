    ...
    <div className="space-y-6 w-full max-w-[500px]">
      ...
      {(localError || error) && (
        ...
        >
          ...
          <p className="text-[10px] font-bold text-orange uppercase tracking-widest">
            {localError || error}
          </p>
        </motion.div>
      )}
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-white tracking-widest truncate max-w-[180px] sm:max-w-xs">
              {identifier}
            </p>
          </div>
        </div>
      ...
      <div className="space-y-6">
        ...
        />
        {!verified && <ResendTimer initialSeconds={60} onResend={onResend} disabled={loading} />}
      </div>
    </motion.div>
  );
}
