                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
                          ...
                          <div className="flex-1 w-full space-y-4 text-center sm:text-left">
                            ...
                            <div className="flex items-center justify-center sm:justify-start gap-4">
                              <span className="text-[10px] font-bold text-black/20 dark:text-white/20 uppercase tracking-widest whitespace-nowrap">
                                High Res Preferred
                              </span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                          <div className="space-y-1.5">
                            ...
                            <div className="relative group/input">
                              <span className="absolute left-6 top-1/2 -translate-y-1/2 text-black/20 dark:text-white/20 font-bold group-focus-within/input:text-orange transition-colors">
                                @
                              </span>
                              <input
                                type="text"
                      ...
                      {!isGoogleUser ? (
                        <div className="rounded-[24px] border border-black/[0.04] dark:border-white/5 bg-black/[0.02] dark:bg-white/[0.03] p-6 space-y-6">
                          <div className="flex items-center gap-2.5">
                            ...
                            <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-orange">
                              Security Strategy
                            </h3>
                          </div>
                        ...
                        <div className="rounded-[24px] border border-black/[0.04] dark:border-white/5 bg-black/[0.02] dark:bg-white/[0.03] p-5">
                          <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                              <p className="text-[9px] font-black uppercase tracking-[0.1em] text-black/70 dark:text-white/70">
                                Account Security
                              </p>
                              <p className="text-[8px] font-medium text-black/30 dark:text-white/30 uppercase tracking-widest">
