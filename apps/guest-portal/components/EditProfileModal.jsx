                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                          <div className="space-y-1.5">
                            ...
                            <div className="relative group/input">
                              <span className="absolute left-6 top-1/2 -translate-y-1/2 text-white/20 font-bold group-focus-within/input:text-orange transition-colors">
                                @
                              </span>
                              <input
                                type="text"
                      ...
                      {!isGoogleUser ? (
                        ...
                        <div className="rounded-[24px] border border-white/5 bg-white/[0.03] p-5">
                          <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                              <p className="text-[9px] font-black uppercase tracking-[0.1em] text-white/70">
                                Account Security
                              </p>
