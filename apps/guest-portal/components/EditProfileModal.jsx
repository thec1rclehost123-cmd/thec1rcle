                    ...
                    {!cropperOpen && (
                        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center p-0 sm:p-4 pointer-events-none">
                            <motion.div
                                ...
                                className="relative w-full max-w-none sm:max-w-md pointer-events-auto"
                            >
                                <div className="relative overflow-hidden rounded-t-[40px] sm:rounded-[32px] border-t sm:border border-white/10 bg-gradient-to-br from-[#0A0A0A] to-black p-8 shadow-2xl max-h-[90vh] overflow-y-auto">
