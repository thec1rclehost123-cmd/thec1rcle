      ...
      <div className="w-full max-w-[800px] flex flex-col items-center gap-10">
          ...
          <div className="relative glass-panel bg-white/[0.03] border border-white/10 backdrop-blur-2xl rounded-[40px] p-8 md:p-10 shadow-3xl overflow-hidden text-center">
            <div className="space-y-8">
              <div className="space-y-2">
                <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-orange">
                  Event Details
                </h3>
              ...
              <div className="pt-8 border-t border-white/5 grid grid-cols-2 gap-4">
                <div className="text-left">
                  ...
                  <p className="text-[10px] font-mono font-black text-white/40 truncate mt-1">
        ...
        >
          <div className="flex flex-col gap-2 mb-2">
            ...
            <p className="text-[8px] font-black uppercase tracking-[0.5em] text-white/20 text-center mt-2">
              No need to print. show digital QR at the door.
            </p>
          </div>
