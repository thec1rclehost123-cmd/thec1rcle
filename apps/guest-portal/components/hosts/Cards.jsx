        ...
        >
            <Link href={`/venue/${venue.slug || venue.id}`} className="block relative">
                ...
                <div className="flex items-center justify-between p-4 bg-black/[0.02] dark:bg-white/[0.02]">
                    <div>
                        <p className="text-sm font-black text-black dark:text-white">{(venue.followers || 0).toLocaleString('en-IN')}</p>
                        <p className="text-[9px] uppercase font-bold tracking-widest text-black/40 dark:text-white/40">Followers</p>
                    </div>
                    <button
                        onClick={(e) => { e.preventDefault(); onFollow && onFollow(venue.id); }}
                ...
                <div className="p-4 flex items-center justify-between border-t border-black/5 dark:border-white/[0.06] bg-black/[0.02] dark:bg-white/[0.02]">
                    <div className="flex gap-5">
                        <div>
                            ...
                            <p className="text-[9px] font-bold text-black/40 dark:text-white/40 uppercase tracking-widest">Followers</p>
                        </div>
                        <div>
                            <p className="text-sm font-black text-black dark:text-white">{host.upcomingEventsCount || 0}</p>
                            <p className="text-[9px] font-bold text-black/40 dark:text-white/40 uppercase tracking-widest">Events</p>
                        </div>
                    </div>
                    <button
